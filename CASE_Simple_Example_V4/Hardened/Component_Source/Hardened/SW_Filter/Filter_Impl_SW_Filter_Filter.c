...
Unit HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_initialise_(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "Filter_Impl_SW_Filter_Filter.c", "", "HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_initialise_", 0);
...
Unit HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_finalise_(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "Filter_Impl_SW_Filter_Filter.c", "", "HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_finalise_", 0);
}

Unit HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_timeTriggered_(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "Filter_Impl_SW_Filter_Filter.c", "", "HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_timeTriggered_", 0);

  // examples of api getter usage

  uint8_t t0[numBytes_HAMR_Simple_V4_Data_Types_RF_Msg_Impl];
  size_t t0_numBits;
  if(api_get_Input__HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter(SF &t0_numBits, t0)) {
    // sanity check
    ...
    byte_array_string(SF (String) &Input_str, t0, numBytes_HAMR_Simple_V4_Data_Types_RF_Msg_Impl);
    api_logInfo__HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter(SF (String) &Input_str);
  }
}
