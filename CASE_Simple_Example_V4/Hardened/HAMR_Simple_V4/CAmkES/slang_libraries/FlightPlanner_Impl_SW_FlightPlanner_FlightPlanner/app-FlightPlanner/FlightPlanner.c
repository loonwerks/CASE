...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "FlightPlanner.scala", "HAMR_Simple_V4.FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner.FlightPlanner", "<App>", 0);
  ...
  return (int) HAMR_Simple_V4_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_FlightPlanner_main(SF &t_args);
}