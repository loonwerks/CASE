...
typedef enum {
  ...
  THAMR_Simple_V4_SW_Filter_Impl_Initialization_Api = (int) 0x2C7A5B12, // HAMR_Simple_V4.SW.Filter_Impl_Initialization_Api
  THAMR_Simple_V4_SW_Filter_Impl_Operational_Api = (int) 0xFDFA7119, // HAMR_Simple_V4.SW.Filter_Impl_Operational_Api
  THAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge = (int) 0xBFA3D20B, // HAMR_Simple_V4.SW.Filter_Impl_SW_Filter_Filter_Bridge
  THAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints = (int) 0x55F03BF2, // HAMR_Simple_V4.SW.Filter_Impl_SW_Filter_Filter_Bridge.EntryPoints
  ...
  TNone_39F351 = (int) 0x39F3510E, // None[HAMR_Simple_V4.SW.Filter_Impl_Initialization_Api]
  TNone_968C19 = (int) 0x968C19B5, // None[HAMR_Simple_V4.SW.Filter_Impl_Operational_Api]
  ...
  TSome_F9E3B8 = (int) 0xF9E3B8D8, // Some[HAMR_Simple_V4.SW.Filter_Impl_Initialization_Api]
  TSome_FDA5C5 = (int) 0xFDA5C544, // Some[HAMR_Simple_V4.SW.Filter_Impl_Operational_Api]
