...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case THAMR_Simple_V4_SW_Filter_Impl_Initialization_Api: return sizeof(struct HAMR_Simple_V4_SW_Filter_Impl_Initialization_Api); // HAMR_Simple_V4.SW.Filter_Impl_Initialization_Api
    case THAMR_Simple_V4_SW_Filter_Impl_Operational_Api: return sizeof(struct HAMR_Simple_V4_SW_Filter_Impl_Operational_Api); // HAMR_Simple_V4.SW.Filter_Impl_Operational_Api
    case THAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge: return sizeof(struct HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge); // HAMR_Simple_V4.SW.Filter_Impl_SW_Filter_Filter_Bridge
    case THAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints: return sizeof(struct HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge_EntryPoints); // HAMR_Simple_V4.SW.Filter_Impl_SW_Filter_Filter_Bridge.EntryPoints
    ...
    case TNone_39F351: return sizeof(struct None_39F351); // None[HAMR_Simple_V4.SW.Filter_Impl_Initialization_Api]
    case TNone_968C19: return sizeof(struct None_968C19); // None[HAMR_Simple_V4.SW.Filter_Impl_Operational_Api]
    ...
    case TSome_F9E3B8: return sizeof(struct Some_F9E3B8); // Some[HAMR_Simple_V4.SW.Filter_Impl_Initialization_Api]
    case TSome_FDA5C5: return sizeof(struct Some_FDA5C5); // Some[HAMR_Simple_V4.SW.Filter_Impl_Operational_Api]
