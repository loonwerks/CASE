#ifndef SIREUM_TYPE_H_HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge
#define SIREUM_TYPE_H_HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge
...
typedef struct HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge *HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge;
struct HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge {
  TYPE type;
...
#define DeclNewHAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge(x) struct HAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge x = { .type = THAMR_Simple_V4_SW_Filter_Impl_SW_Filter_Filter_Bridge }
