...
typedef enum {
  ...
  THAMR_Simple_V4_SW_AttestationManager_Impl_Initialization_Api = (int) 0x8306F6FF, // HAMR_Simple_V4.SW.AttestationManager_Impl_Initialization_Api
  THAMR_Simple_V4_SW_AttestationManager_Impl_Operational_Api = (int) 0xDFC94F22, // HAMR_Simple_V4.SW.AttestationManager_Impl_Operational_Api
  THAMR_Simple_V4_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge = (int) 0xD6EA14B5, // HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge
  THAMR_Simple_V4_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints = (int) 0x75F03C1F, // HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.EntryPoints
  ...
  TNone_B594B8 = (int) 0xB594B84C, // None[HAMR_Simple_V4.SW.AttestationManager_Impl_Initialization_Api]
  TNone_BCB2D2 = (int) 0xBCB2D227, // None[HAMR_Simple_V4.SW.AttestationManager_Impl_Operational_Api]
  ...
  TSome_9DE0EF = (int) 0x9DE0EFA7, // Some[HAMR_Simple_V4.SW.AttestationManager_Impl_Initialization_Api]
  TSome_B273EC = (int) 0xB273ECF4, // Some[HAMR_Simple_V4.SW.AttestationManager_Impl_Operational_Api]
