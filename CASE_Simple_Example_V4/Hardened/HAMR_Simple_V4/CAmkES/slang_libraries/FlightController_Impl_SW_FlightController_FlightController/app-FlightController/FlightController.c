...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "FlightController.scala", "HAMR_Simple_V4.FlightController_Impl_SW_FlightController_FlightController.FlightController", "<App>", 0);
  ...
  return (int) HAMR_Simple_V4_FlightController_Impl_SW_FlightController_FlightController_FlightController_main(SF &t_args);
}