...
typedef enum {
  ...
  THAMR_Simple_V4_SW_AttestationTester_Impl_Initialization_Api = (int) 0x61F173B7, // HAMR_Simple_V4.SW.AttestationTester_Impl_Initialization_Api
  THAMR_Simple_V4_SW_AttestationTester_Impl_Operational_Api = (int) 0xB76724E2, // HAMR_Simple_V4.SW.AttestationTester_Impl_Operational_Api
  THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge = (int) 0x5DD4490D, // HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge
  THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge_EntryPoints = (int) 0xAB4BF5D2, // HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge.EntryPoints
  ...
  TNone_600AAD = (int) 0x600AAD19, // None[HAMR_Simple_V4.SW.AttestationTester_Impl_Initialization_Api]
  TNone_6557E1 = (int) 0x6557E13E, // None[HAMR_Simple_V4.SW.AttestationTester_Impl_Operational_Api]
  ...
  TSome_CFA8D1 = (int) 0xCFA8D160, // Some[HAMR_Simple_V4.SW.AttestationTester_Impl_Initialization_Api]
  TSome_3A7E15 = (int) 0x3A7E1501, // Some[HAMR_Simple_V4.SW.AttestationTester_Impl_Operational_Api]
