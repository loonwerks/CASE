...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "SlangTypeLibrary.scala", "HAMR_Simple_V4.SlangTypeLibrary.SlangTypeLibrary", "<App>", 0);
  ...
  return (int) HAMR_Simple_V4_SlangTypeLibrary_SlangTypeLibrary_main(SF &t_args);
}