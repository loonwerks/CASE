...
typedef enum {
  ...
  THAMR_Simple_V4_SW_RadioDriver_Attestation_Impl_Initialization_Api = (int) 0x60FCE69E, // HAMR_Simple_V4.SW.RadioDriver_Attestation_Impl_Initialization_Api
  THAMR_Simple_V4_SW_RadioDriver_Attestation_Impl_Operational_Api = (int) 0xF96F3C59, // HAMR_Simple_V4.SW.RadioDriver_Attestation_Impl_Operational_Api
  THAMR_Simple_V4_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Bridge = (int) 0x9EC26770, // HAMR_Simple_V4.SW.RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Bridge
  THAMR_Simple_V4_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Bridge_EntryPoints = (int) 0x3FB79312, // HAMR_Simple_V4.SW.RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Bridge.EntryPoints
  ...
  TNone_830D4E = (int) 0x830D4E46, // None[HAMR_Simple_V4.SW.RadioDriver_Attestation_Impl_Initialization_Api]
  TNone_29B833 = (int) 0x29B8330F, // None[HAMR_Simple_V4.SW.RadioDriver_Attestation_Impl_Operational_Api]
  ...
  TSome_3030EA = (int) 0x3030EA64, // Some[HAMR_Simple_V4.SW.RadioDriver_Attestation_Impl_Initialization_Api]
  TSome_E10DBF = (int) 0xE10DBF94, // Some[HAMR_Simple_V4.SW.RadioDriver_Attestation_Impl_Operational_Api]
