...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case THAMR_Simple_V4_SW_AttestationGate_Impl_Initialization_Api: return sizeof(struct HAMR_Simple_V4_SW_AttestationGate_Impl_Initialization_Api); // HAMR_Simple_V4.SW.AttestationGate_Impl_Initialization_Api
    case THAMR_Simple_V4_SW_AttestationGate_Impl_Operational_Api: return sizeof(struct HAMR_Simple_V4_SW_AttestationGate_Impl_Operational_Api); // HAMR_Simple_V4.SW.AttestationGate_Impl_Operational_Api
    case THAMR_Simple_V4_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge: return sizeof(struct HAMR_Simple_V4_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge); // HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge
    case THAMR_Simple_V4_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_EntryPoints: return sizeof(struct HAMR_Simple_V4_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_EntryPoints); // HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.EntryPoints
    ...
    case TNone_02D0B8: return sizeof(struct None_02D0B8); // None[HAMR_Simple_V4.SW.AttestationGate_Impl_Initialization_Api]
    case TNone_3F8D24: return sizeof(struct None_3F8D24); // None[HAMR_Simple_V4.SW.AttestationGate_Impl_Operational_Api]
    ...
    case TSome_262A95: return sizeof(struct Some_262A95); // Some[HAMR_Simple_V4.SW.AttestationGate_Impl_Initialization_Api]
    case TSome_06F7FC: return sizeof(struct Some_06F7FC); // Some[HAMR_Simple_V4.SW.AttestationGate_Impl_Operational_Api]
