...
typedef enum {
  ...
  THAMR_Simple_V4_SW_AttestationGate_Impl_Initialization_Api = (int) 0x15C292AC, // HAMR_Simple_V4.SW.AttestationGate_Impl_Initialization_Api
  THAMR_Simple_V4_SW_AttestationGate_Impl_Operational_Api = (int) 0xA79653F6, // HAMR_Simple_V4.SW.AttestationGate_Impl_Operational_Api
  THAMR_Simple_V4_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge = (int) 0x82D3A9C5, // HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge
  THAMR_Simple_V4_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_EntryPoints = (int) 0x50E72086, // HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.EntryPoints
  ...
  TNone_02D0B8 = (int) 0x02D0B8DC, // None[HAMR_Simple_V4.SW.AttestationGate_Impl_Initialization_Api]
  TNone_3F8D24 = (int) 0x3F8D2420, // None[HAMR_Simple_V4.SW.AttestationGate_Impl_Operational_Api]
  ...
  TSome_262A95 = (int) 0x262A9583, // Some[HAMR_Simple_V4.SW.AttestationGate_Impl_Initialization_Api]
  TSome_06F7FC = (int) 0x06F7FC1E, // Some[HAMR_Simple_V4.SW.AttestationGate_Impl_Operational_Api]
