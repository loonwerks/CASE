...
typedef enum {
  ...
  THAMR_Simple_V4_SW_Monitor_Impl_Initialization_Api = (int) 0x97E22B17, // HAMR_Simple_V4.SW.Monitor_Impl_Initialization_Api
  THAMR_Simple_V4_SW_Monitor_Impl_Operational_Api = (int) 0x462B40D1, // HAMR_Simple_V4.SW.Monitor_Impl_Operational_Api
  THAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge = (int) 0x09F8AD3B, // HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge
  THAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_EntryPoints = (int) 0x3569CF87, // HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.EntryPoints
  ...
  TNone_556BC5 = (int) 0x556BC5A6, // None[HAMR_Simple_V4.SW.Monitor_Impl_Initialization_Api]
  TNone_D81833 = (int) 0xD8183372, // None[HAMR_Simple_V4.SW.Monitor_Impl_Operational_Api]
  ...
  TSome_CF7B75 = (int) 0xCF7B75DA, // Some[HAMR_Simple_V4.SW.Monitor_Impl_Initialization_Api]
  TSome_E0238A = (int) 0xE0238A12, // Some[HAMR_Simple_V4.SW.Monitor_Impl_Operational_Api]
