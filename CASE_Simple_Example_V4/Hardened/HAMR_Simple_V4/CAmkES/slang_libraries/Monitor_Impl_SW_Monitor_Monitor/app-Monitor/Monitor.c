...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "Monitor.scala", "HAMR_Simple_V4.Monitor_Impl_SW_Monitor_Monitor.Monitor", "<App>", 0);
  ...
  return (int) HAMR_Simple_V4_Monitor_Impl_SW_Monitor_Monitor_Monitor_main(SF &t_args);
}