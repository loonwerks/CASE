...
package HAMR_Simple_V4.AttestationGate_Impl_SW_AttestationGate_AttestationGate
...
import HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_seL4Nix

object AttestationGate extends App {

  val AttestationGateBridge : HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge = {
  ...
  def touch(): Unit = {
    if(F) {
      ...
      HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.c_initialization_api.get.logInfo("")
      HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.c_initialization_api.get.logDebug("")
      HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.c_initialization_api.get.logError("")
      HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.c_operational_api.get.logInfo("")
      HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.c_operational_api.get.logDebug("")
      HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.c_operational_api.get.logError("")
      val apiUsage_MissionCommand_in: Option[Base_Types.Bits] = HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.c_operational_api.get.get_MissionCommand_in()
      HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.c_initialization_api.get.put_MissionCommand_out(Base_Types.Bits_example())
      HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.c_operational_api.get.put_MissionCommand_out(Base_Types.Bits_example())
      val apiUsage_TrustedIds: Option[Base_Types.Bits] = HAMR_Simple_V4.SW.AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge.c_operational_api.get.get_TrustedIds()
    }
  }
