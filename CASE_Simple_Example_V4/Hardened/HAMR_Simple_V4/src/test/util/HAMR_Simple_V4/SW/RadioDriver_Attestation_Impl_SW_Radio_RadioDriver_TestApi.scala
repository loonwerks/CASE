...
abstract class RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_TestApi extends BridgeTestSuite[RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Bridge](Arch.MissionComputer_Impl_Instance_SW_Radio_RadioDriver) {
  ...
  /** helper function to check RadioDriver_Attestation_Impl_SW_Radio_RadioDriver's
