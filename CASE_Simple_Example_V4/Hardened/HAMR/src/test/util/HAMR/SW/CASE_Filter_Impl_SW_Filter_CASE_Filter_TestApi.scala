...
abstract class CASE_Filter_Impl_SW_Filter_CASE_Filter_TestApi extends BridgeTestSuite[CASE_Filter_Impl_SW_Filter_CASE_Filter_Bridge](Arch.MissionComputer_Impl_Instance_SW_Filter_CASE_Filter) {
  ...
  /** helper function to check CASE_Filter_Impl_SW_Filter_CASE_Filter's
