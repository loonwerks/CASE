...
/*
  ...
  uint8_t t1[numBytes_HAMR_SW_AllowList_Impl];
  byte_array_default(SF t1, numBits_HAMR_SW_AllowList_Impl, numBytes_HAMR_SW_AllowList_Impl);
  api_put_TrustedIds__HAMR_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager(SF numBits_HAMR_SW_AllowList_Impl, t1);
