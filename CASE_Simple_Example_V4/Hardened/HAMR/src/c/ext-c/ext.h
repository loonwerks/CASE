...
#define numBits_HAMR_SW_AttestationRequestMsg_Impl 128
...
#define numBits_HAMR_SW_AttestationResponseMsg_Impl 16384
...
#define numBits_HAMR_SW_RF_Msg_Impl 256
#define numBytes_HAMR_SW_RF_Msg_Impl ((numBits_HAMR_SW_RF_Msg_Impl - 1) / 8 + 1)

// bit-codec size for HAMR_SW_Mission
#define numBits_HAMR_SW_Mission 288
#define numBytes_HAMR_SW_Mission ((numBits_HAMR_SW_Mission - 1) / 8 + 1)

// bit-codec size for HAMR_SW_AllowList_Impl
#define numBits_HAMR_SW_AllowList_Impl 128
#define numBytes_HAMR_SW_AllowList_Impl ((numBits_HAMR_SW_AllowList_Impl - 1) / 8 + 1)
#endif