...
Unit HAMR_SW_FlightController_Impl_SW_FlightController_FlightController_handle_Alert_(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "FlightController_Impl_SW_FlightController_FlightController.c", "", "HAMR_SW_FlightController_Impl_SW_FlightController_FlightController_handle_Alert_", 0);

  DeclNewString(AlertString);
  String__append(SF (String) &AlertString, string("HAMR_SW_FlightController_Impl_SW_FlightController_FlightController_handle_Alert called"));
  api_logInfo__HAMR_SW_FlightController_Impl_SW_FlightController_FlightController (SF (String) &AlertString);

  String str = string("Received event on Alert");
  api_logInfo__HAMR_SW_FlightController_Impl_SW_FlightController_FlightController(SF str);
