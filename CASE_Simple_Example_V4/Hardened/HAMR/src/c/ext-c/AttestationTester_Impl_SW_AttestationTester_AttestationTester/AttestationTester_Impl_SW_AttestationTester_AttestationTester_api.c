...
bool api_get_AttestationRequest__HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester(
  ...
  Option_B221FE_get_(SF (HAMR_SW_AttestationTester_Impl_Operational_Api) &api, HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge_c_operational_api(SF_LAST));
...
void api_put_AttestationResponse__HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester(
  ...
  Option_432E9F_get_(SF (HAMR_SW_AttestationTester_Impl_Initialization_Api) &api, HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge_c_initialization_api(SF_LAST));
...
Unit HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_handle_AttestationRequest(
  STACK_FRAME
  HAMR_SW_AttestationTester_Impl_Operational_Api api,
  IS_C4F575 value) {
  DeclNewStackFrame(caller, "AttestationTester_Impl_SW_AttestationTester_AttestationTester_api.c", "", "HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_handle_AttestationRequest", 0);

  HAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_handle_AttestationRequest_(SF value);
}
