...
package HAMR.Monitor_Impl_Monitor_Monitor
...
import HAMR._
import HAMR.SW.Monitor_Impl_Monitor_Monitor_seL4Nix

object Monitor extends App {

  val MonitorBridge : HAMR.SW.Monitor_Impl_Monitor_Monitor_Bridge = {
    val FlightPlan_in = Port[SW.Mission] (id = 0, name = "SW_seL4_Impl_Instance_Monitor_Monitor_FlightPlan_in", mode = EventIn)
    val FlightPlan_out = Port[SW.Mission] (id = 1, name = "SW_seL4_Impl_Instance_Monitor_Monitor_FlightPlan_out", mode = EventOut)
    val Alert = Port[art.Empty] (id = 2, name = "SW_seL4_Impl_Instance_Monitor_Monitor_Alert", mode = EventOut)
  ...
  def dispatchStatus(bridgeId: Art.BridgeId): DispatchStatus = {
    ...
    if(!Monitor_Impl_Monitor_Monitor_seL4Nix.FlightPlan_in_IsEmpty()) {
  ...
  def receiveInput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    FlightPlan_in_port = Monitor_Impl_Monitor_Monitor_seL4Nix.FlightPlan_in_Receive()
  }
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(FlightPlan_out_port.nonEmpty) {
      Monitor_Impl_Monitor_Monitor_seL4Nix.FlightPlan_out_Send(FlightPlan_out_port.get)
      FlightPlan_out_port = noData
    }

    if(Alert_port.nonEmpty) {
      Monitor_Impl_Monitor_Monitor_seL4Nix.Alert_Send(Alert_port.get)
      Alert_port = noData
    }
  }
  ...
  def touch(): Unit = {
    if(F) {
      ...
      HAMR.SW.Monitor_Impl_Monitor_Monitor_Bridge.c_initialization_api.get.logInfo("")
      HAMR.SW.Monitor_Impl_Monitor_Monitor_Bridge.c_initialization_api.get.logDebug("")
      HAMR.SW.Monitor_Impl_Monitor_Monitor_Bridge.c_initialization_api.get.logError("")
      HAMR.SW.Monitor_Impl_Monitor_Monitor_Bridge.c_operational_api.get.logInfo("")
      HAMR.SW.Monitor_Impl_Monitor_Monitor_Bridge.c_operational_api.get.logDebug("")
      HAMR.SW.Monitor_Impl_Monitor_Monitor_Bridge.c_operational_api.get.logError("")
      val apiUsage_FlightPlan_in: Option[SW.Mission] = HAMR.SW.Monitor_Impl_Monitor_Monitor_Bridge.c_operational_api.get.get_FlightPlan_in()
      HAMR.SW.Monitor_Impl_Monitor_Monitor_Bridge.c_initialization_api.get.put_FlightPlan_out(SW.Mission.example())
      HAMR.SW.Monitor_Impl_Monitor_Monitor_Bridge.c_operational_api.get.put_FlightPlan_out(SW.Mission.example())
      HAMR.SW.Monitor_Impl_Monitor_Monitor_Bridge.c_initialization_api.get.put_Alert()
      HAMR.SW.Monitor_Impl_Monitor_Monitor_Bridge.c_operational_api.get.put_Alert()
    }
  }
