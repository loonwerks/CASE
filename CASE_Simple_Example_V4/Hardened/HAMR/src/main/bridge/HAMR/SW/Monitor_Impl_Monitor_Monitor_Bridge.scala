...
import art._
import HAMR._
import HAMR.SW.{Monitor_Impl_Monitor_Monitor => component}

// This file was auto-generated.  Do not edit

@datatype class Monitor_Impl_Monitor_Monitor_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : Monitor_Impl_Initialization_Api = {
    ...
    Monitor_Impl_Monitor_Monitor_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : Monitor_Impl_Operational_Api = {
    ...
    Monitor_Impl_Monitor_Monitor_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    Monitor_Impl_Monitor_Monitor_Bridge.EntryPoints(
      id,
...
object Monitor_Impl_Monitor_Monitor_Bridge {
  ...
  @datatype class EntryPoints(
    Monitor_Impl_Monitor_Monitor_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(Monitor_Impl_Monitor_Monitor_BridgeId)
      ...
      for(portId <- dispatchableEventPorts) {
        if(portId == FlightPlan_in_Id){
          ...
          // implement the following in 'component':  def handle_FlightPlan_in(api: Monitor_Impl_Operational_Api, value: SW.Mission): Unit = {}
