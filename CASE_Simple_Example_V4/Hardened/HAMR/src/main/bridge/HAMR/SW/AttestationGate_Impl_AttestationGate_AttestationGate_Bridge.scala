...
import art._
import HAMR._
import HAMR.SW.{AttestationGate_Impl_AttestationGate_AttestationGate => component}

// This file was auto-generated.  Do not edit

@datatype class AttestationGate_Impl_AttestationGate_AttestationGate_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  TrustedIds: Port[SW.AllowList_Impl]
  ) extends Bridge {
  ...
  val initialization_api : AttestationGate_Impl_Initialization_Api = {
    ...
    AttestationGate_Impl_AttestationGate_AttestationGate_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : AttestationGate_Impl_Operational_Api = {
    ...
    AttestationGate_Impl_AttestationGate_AttestationGate_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    AttestationGate_Impl_AttestationGate_AttestationGate_Bridge.EntryPoints(
      id,
...
object AttestationGate_Impl_AttestationGate_AttestationGate_Bridge {
  ...
  @datatype class EntryPoints(
    AttestationGate_Impl_AttestationGate_AttestationGate_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(AttestationGate_Impl_AttestationGate_AttestationGate_BridgeId)
      ...
      for(portId <- dispatchableEventPorts) {
        if(portId == MissionCommand_in_Id){
          ...
          // implement the following in 'component':  def handle_MissionCommand_in(api: AttestationGate_Impl_Operational_Api, value: SW.RF_Msg_Impl): Unit = {}
          component.handle_MissionCommand_in(operational_api, value)
        }
        else if(portId == TrustedIds_Id){
          val Some(SW.AllowList_Impl_Payload(value)) = Art.getValue(TrustedIds_Id)

          // implement the following in 'component':  def handle_TrustedIds(api: AttestationGate_Impl_Operational_Api, value: SW.AllowList_Impl): Unit = {}
