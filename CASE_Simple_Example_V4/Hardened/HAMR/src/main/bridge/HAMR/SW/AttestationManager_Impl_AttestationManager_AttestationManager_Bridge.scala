...
import art._
import HAMR._
import HAMR.SW.{AttestationManager_Impl_AttestationManager_AttestationManager => component}

// This file was auto-generated.  Do not edit

@datatype class AttestationManager_Impl_AttestationManager_AttestationManager_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : AttestationManager_Impl_Initialization_Api = {
    ...
    AttestationManager_Impl_AttestationManager_AttestationManager_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : AttestationManager_Impl_Operational_Api = {
    ...
    AttestationManager_Impl_AttestationManager_AttestationManager_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    AttestationManager_Impl_AttestationManager_AttestationManager_Bridge.EntryPoints(
      id,
...
object AttestationManager_Impl_AttestationManager_AttestationManager_Bridge {
  ...
  @datatype class EntryPoints(
    AttestationManager_Impl_AttestationManager_AttestationManager_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(AttestationManager_Impl_AttestationManager_AttestationManager_BridgeId)
      ...
      for(portId <- dispatchableEventPorts) {
        if(portId == AttestationResponse_Id){
          val Some(SW.AttestationResponseMsg_Impl_Payload(value)) = Art.getValue(AttestationResponse_Id)

          // implement the following in 'component':  def handle_AttestationResponse(api: AttestationManager_Impl_Operational_Api, value: SW.AttestationResponseMsg_Impl): Unit = {}
