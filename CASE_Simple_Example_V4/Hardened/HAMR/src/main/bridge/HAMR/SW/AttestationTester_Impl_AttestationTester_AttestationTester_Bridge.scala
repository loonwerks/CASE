...
import art._
import HAMR._
import HAMR.SW.{AttestationTester_Impl_AttestationTester_AttestationTester => component}

// This file was auto-generated.  Do not edit

@datatype class AttestationTester_Impl_AttestationTester_AttestationTester_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : AttestationTester_Impl_Initialization_Api = {
    ...
    AttestationTester_Impl_AttestationTester_AttestationTester_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : AttestationTester_Impl_Operational_Api = {
    ...
    AttestationTester_Impl_AttestationTester_AttestationTester_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    AttestationTester_Impl_AttestationTester_AttestationTester_Bridge.EntryPoints(
      id,
...
object AttestationTester_Impl_AttestationTester_AttestationTester_Bridge {
  ...
  @datatype class EntryPoints(
    AttestationTester_Impl_AttestationTester_AttestationTester_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(AttestationTester_Impl_AttestationTester_AttestationTester_BridgeId)
      ...
      for(portId <- dispatchableEventPorts) {
        if(portId == AttestationRequest_Id){
          ...
          // implement the following in 'component':  def handle_AttestationRequest(api: AttestationTester_Impl_Operational_Api, value: SW.AttestationRequestMsg_Impl): Unit = {}
