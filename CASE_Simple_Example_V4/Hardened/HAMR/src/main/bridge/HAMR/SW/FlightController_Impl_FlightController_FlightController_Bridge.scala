...
import art._
import HAMR._
import HAMR.SW.{FlightController_Impl_FlightController_FlightController => component}

// This file was auto-generated.  Do not edit

@datatype class FlightController_Impl_FlightController_FlightController_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : FlightController_Impl_Initialization_Api = {
    ...
    FlightController_Impl_FlightController_FlightController_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : FlightController_Impl_Operational_Api = {
    ...
    FlightController_Impl_FlightController_FlightController_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    FlightController_Impl_FlightController_FlightController_Bridge.EntryPoints(
      id,
...
object FlightController_Impl_FlightController_FlightController_Bridge {
  ...
  @datatype class EntryPoints(
    FlightController_Impl_FlightController_FlightController_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(FlightController_Impl_FlightController_FlightController_BridgeId)
      ...
      for(portId <- dispatchableEventPorts) {
        if(portId == FlightPlan_Id){
          ...
          // implement the following in 'component':  def handle_FlightPlan(api: FlightController_Impl_Operational_Api, value: SW.Mission): Unit = {}
