...
import art._
import HAMR._
import HAMR.SW.{Filter_Impl_Filter_Filter => component}

// This file was auto-generated.  Do not edit

@datatype class Filter_Impl_Filter_Filter_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : Filter_Impl_Initialization_Api = {
    ...
    Filter_Impl_Filter_Filter_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : Filter_Impl_Operational_Api = {
    ...
    Filter_Impl_Filter_Filter_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    Filter_Impl_Filter_Filter_Bridge.EntryPoints(
      id,
...
object Filter_Impl_Filter_Filter_Bridge {
  ...
  @datatype class EntryPoints(
    Filter_Impl_Filter_Filter_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(Filter_Impl_Filter_Filter_BridgeId)
      ...
      for(portId <- dispatchableEventPorts) {
        if(portId == Input_Id){
          ...
          // implement the following in 'component':  def handle_Input(api: Filter_Impl_Operational_Api, value: SW.RF_Msg_Impl): Unit = {}
