...
import art._
import HAMR._
import HAMR.SW.{FlightPlanner_Impl_FlightPlanner_FlightPlanner => component}

// This file was auto-generated.  Do not edit

@datatype class FlightPlanner_Impl_FlightPlanner_FlightPlanner_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : FlightPlanner_Impl_Initialization_Api = {
    ...
    FlightPlanner_Impl_FlightPlanner_FlightPlanner_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : FlightPlanner_Impl_Operational_Api = {
    ...
    FlightPlanner_Impl_FlightPlanner_FlightPlanner_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    FlightPlanner_Impl_FlightPlanner_FlightPlanner_Bridge.EntryPoints(
      id,
...
object FlightPlanner_Impl_FlightPlanner_FlightPlanner_Bridge {
  ...
  @datatype class EntryPoints(
    FlightPlanner_Impl_FlightPlanner_FlightPlanner_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(FlightPlanner_Impl_FlightPlanner_FlightPlanner_BridgeId)
