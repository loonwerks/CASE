...
object AttestationManager_Impl_AttestationManager_AttestationManager {

  def initialise(api: AttestationManager_Impl_Initialization_Api): Unit = { }

  def handle_AttestationResponse(api: AttestationManager_Impl_Operational_Api, value : SW.AttestationResponseMsg_Impl): Unit = { }
