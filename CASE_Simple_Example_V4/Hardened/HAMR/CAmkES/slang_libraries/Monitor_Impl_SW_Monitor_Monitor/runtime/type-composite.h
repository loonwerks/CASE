...
typedef enum {
  ...
  THAMR_SW_Monitor_Impl_Initialization_Api = 0x05F67F32, // HAMR.SW.Monitor_Impl_Initialization_Api
  THAMR_SW_Monitor_Impl_Operational_Api = 0x31CB01CC, // HAMR.SW.Monitor_Impl_Operational_Api
  THAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge = 0xD922E5E6, // HAMR.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge
  THAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_EntryPoints = 0x1BC95613, // HAMR.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.EntryPoints
  ...
  TNone_2A8B4A = 0x2A8B4A55, // None[HAMR.SW.Monitor_Impl_Initialization_Api]
  TNone_BE5310 = 0xBE53106D, // None[HAMR.SW.Monitor_Impl_Operational_Api]
  ...
  TSome_6EC2CA = 0x6EC2CABE, // Some[HAMR.SW.Monitor_Impl_Initialization_Api]
  TSome_3E502C = 0x3E502CA6, // Some[HAMR.SW.Monitor_Impl_Operational_Api]
