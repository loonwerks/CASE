...
void HAMR_SW_Monitor_Impl_Operational_Api_apply(STACK_FRAME HAMR_SW_Monitor_Impl_Operational_Api this, Z id, Z FlightPlan_in_Id, Z FlightPlan_out_Id, Z Alert_Id) {
...
static inline B HAMR_SW_Monitor_Impl_Operational_Api_get_FlightPlan_in_extract_50_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, HAMR_SW_Monitor_Impl_Operational_Api this, IS_C4F575 *_v_50_41) {
...
static inline B HAMR_SW_Monitor_Impl_Operational_Api_get_FlightPlan_in_extract_51_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, HAMR_SW_Monitor_Impl_Operational_Api this, art_DataContent *_v_51_17) {
  if (!Some_D29615__is(SF t_0)) return F;
  *_v_51_17 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_0));
  return T;
}

static inline B HAMR_SW_Monitor_Impl_Operational_Api_get_FlightPlan_in_extract_54_12_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, HAMR_SW_Monitor_Impl_Operational_Api this) {
  return T;
}

void HAMR_SW_Monitor_Impl_Operational_Api_get_FlightPlan_in_(STACK_FRAME Option_30119F result, HAMR_SW_Monitor_Impl_Operational_Api this) {
  DeclNewStackFrame(caller, "Monitor_Impl_Api.scala", "HAMR.SW.Monitor_Impl_Operational_Api", "get_FlightPlan_in", 0);

  sfUpdateLoc(49);
  Option_30119F value;
  DeclNewOption_8E9F45(t_1);
  art_Art_getValue(SF (Option_8E9F45) &t_1, HAMR_SW_Monitor_Impl_Operational_Api_FlightPlan_in_Id_(this));
  Option_8E9F45 t_0 = ((Option_8E9F45) &t_1);
  B match_49_47 = F;
  if (!match_49_47) {
    IS_C4F575 v_50_41;
    match_49_47 = HAMR_SW_Monitor_Impl_Operational_Api_get_FlightPlan_in_extract_50_12_8E9F45(SF t_0, this, &v_50_41);
    if (match_49_47) {
  ...
  if (!match_49_47) {
    ...
    match_49_47 = HAMR_SW_Monitor_Impl_Operational_Api_get_FlightPlan_in_extract_51_12_8E9F45(SF t_0, this, &v_51_17);
    if (match_49_47) {
  ...
  if (!match_49_47) {
    match_49_47 = HAMR_SW_Monitor_Impl_Operational_Api_get_FlightPlan_in_extract_54_12_8E9F45(SF t_0, this);
    if (match_49_47) {
