...
void HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_apply(STACK_FRAME HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge this, Z id, String name, art_DispatchPropertyProtocol dispatchProtocol, Option_9AF35E dispatchTriggers, art_Port_45E54D FlightPlan_in, art_Port_45E54D FlightPlan_out, art_Port_9CBF18 Alert) {
  ...
  Type_assign(&this->Alert, Alert, sizeof(struct art_Port_9CBF18));
  {
    ...
    t_1.size = (int8_t) 3;
    IS_820232_up(&t_1, 0, (art_UPort) HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_FlightPlan_in_(this));
    IS_820232_up(&t_1, 1, (art_UPort) HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_FlightPlan_out_(this));
    ...
    t_4.size = (int8_t) 1;
    IS_820232_up(&t_4, 0, (art_UPort) HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_FlightPlan_in_(this));
    STATIC_ASSERT(2 <= MaxIS_820232, "Insufficient maximum for IS[Z, art.UPort] elements.");
    DeclNewIS_820232(t_5);
    t_5.size = (int8_t) 2;
    IS_820232_up(&t_5, 0, (art_UPort) HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_FlightPlan_out_(this));
  ...
  }
  {
    sfUpdateLoc(38);
    {
      ...
      HAMR_SW_Monitor_Impl_Initialization_Api_apply(SF &t_6, HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_id_(this), art_Port_45E54D_id_(HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_FlightPlan_in_(this)), art_Port_45E54D_id_(HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_FlightPlan_out_(this)), art_Port_9CBF18_id_(HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_Alert_(this)));
  ...
  }
  {
    sfUpdateLoc(49);
    {
      ...
      HAMR_SW_Monitor_Impl_Operational_Api_apply(SF &t_8, HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_id_(this), art_Port_45E54D_id_(HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_FlightPlan_in_(this)), art_Port_45E54D_id_(HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_FlightPlan_out_(this)), art_Port_9CBF18_id_(HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_Alert_(this)));
