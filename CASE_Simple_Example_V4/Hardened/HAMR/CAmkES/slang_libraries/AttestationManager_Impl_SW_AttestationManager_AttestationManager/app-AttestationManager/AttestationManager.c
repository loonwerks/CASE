...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "AttestationManager.scala", "HAMR.AttestationManager_Impl_SW_AttestationManager_AttestationManager.AttestationManager", "<App>", 0);
  ...
  return (int) HAMR_AttestationManager_Impl_SW_AttestationManager_AttestationManager_AttestationManager_main(SF &t_args);
}