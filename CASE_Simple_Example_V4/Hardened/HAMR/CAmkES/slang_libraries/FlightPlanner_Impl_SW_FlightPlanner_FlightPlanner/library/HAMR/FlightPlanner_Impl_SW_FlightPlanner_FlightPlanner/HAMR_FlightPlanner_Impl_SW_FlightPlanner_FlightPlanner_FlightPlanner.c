...
Unit HAMR_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_FlightPlanner_initialiseArchitecture(STACK_FRAME_ONLY) {
  ...
  t_1.size = (int8_t) 1;
  IS_7E8796_up(&t_1, 0, (art_Bridge) HAMR_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_FlightPlanner_FlightPlannerBridge(SF_LAST));
...
Unit HAMR_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_FlightPlanner_touch(STACK_FRAME_ONLY) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(111);
    {
      ...
      HAMR_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_FlightPlanner_touch_printDataContent(SF (art_DataContent) (&t_1));
    }
    ...
    sfUpdateLoc(112);
    {
      ...
      HAMR_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_FlightPlanner_touch_printDataContent(SF (art_DataContent) (&t_3));
    }

    sfUpdateLoc(114);
    {
      DeclNewHAMR_SW_FlightPlanner_Impl_Initialization_Api(t_4);
      Option_A0CA6B_get_(SF (HAMR_SW_FlightPlanner_Impl_Initialization_Api) &t_4, HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_c_initialization_api(SF_LAST));
      HAMR_SW_FlightPlanner_Impl_Initialization_Api_logInfo_(SF ((HAMR_SW_FlightPlanner_Impl_Initialization_Api) &t_4), (String) string(""));
    }

    sfUpdateLoc(115);
    {
      DeclNewHAMR_SW_FlightPlanner_Impl_Initialization_Api(t_5);
      Option_A0CA6B_get_(SF (HAMR_SW_FlightPlanner_Impl_Initialization_Api) &t_5, HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_c_initialization_api(SF_LAST));
      HAMR_SW_FlightPlanner_Impl_Initialization_Api_logDebug_(SF ((HAMR_SW_FlightPlanner_Impl_Initialization_Api) &t_5), (String) string(""));
    }

    sfUpdateLoc(116);
    {
      DeclNewHAMR_SW_FlightPlanner_Impl_Initialization_Api(t_6);
      Option_A0CA6B_get_(SF (HAMR_SW_FlightPlanner_Impl_Initialization_Api) &t_6, HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_c_initialization_api(SF_LAST));
      HAMR_SW_FlightPlanner_Impl_Initialization_Api_logError_(SF ((HAMR_SW_FlightPlanner_Impl_Initialization_Api) &t_6), (String) string(""));
    }

    sfUpdateLoc(117);
    {
      DeclNewHAMR_SW_FlightPlanner_Impl_Operational_Api(t_7);
      Option_6475FA_get_(SF (HAMR_SW_FlightPlanner_Impl_Operational_Api) &t_7, HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_c_operational_api(SF_LAST));
      HAMR_SW_FlightPlanner_Impl_Operational_Api_logInfo_(SF ((HAMR_SW_FlightPlanner_Impl_Operational_Api) &t_7), (String) string(""));
    }

    sfUpdateLoc(118);
    {
      DeclNewHAMR_SW_FlightPlanner_Impl_Operational_Api(t_8);
      Option_6475FA_get_(SF (HAMR_SW_FlightPlanner_Impl_Operational_Api) &t_8, HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_c_operational_api(SF_LAST));
      HAMR_SW_FlightPlanner_Impl_Operational_Api_logDebug_(SF ((HAMR_SW_FlightPlanner_Impl_Operational_Api) &t_8), (String) string(""));
    }

    sfUpdateLoc(119);
    {
      DeclNewHAMR_SW_FlightPlanner_Impl_Operational_Api(t_9);
      Option_6475FA_get_(SF (HAMR_SW_FlightPlanner_Impl_Operational_Api) &t_9, HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_c_operational_api(SF_LAST));
      HAMR_SW_FlightPlanner_Impl_Operational_Api_logError_(SF ((HAMR_SW_FlightPlanner_Impl_Operational_Api) &t_9), (String) string(""));
    }

    sfUpdateLoc(120);
    Option_30119F apiUsage_MissionCommand;
    DeclNewHAMR_SW_FlightPlanner_Impl_Operational_Api(t_10);
    Option_6475FA_get_(SF (HAMR_SW_FlightPlanner_Impl_Operational_Api) &t_10, HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_c_operational_api(SF_LAST));
    DeclNewOption_30119F(t_11);
    HAMR_SW_FlightPlanner_Impl_Operational_Api_get_MissionCommand_(SF (Option_30119F) &t_11, ((HAMR_SW_FlightPlanner_Impl_Operational_Api) &t_10));
    apiUsage_MissionCommand = (Option_30119F) ((Option_30119F) &t_11);

    sfUpdateLoc(121);
    {
      DeclNewHAMR_SW_FlightPlanner_Impl_Initialization_Api(t_12);
      Option_A0CA6B_get_(SF (HAMR_SW_FlightPlanner_Impl_Initialization_Api) &t_12, HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_c_initialization_api(SF_LAST));
      DeclNewIS_C4F575(t_13);
      HAMR_Base_Types_Bits_example(SF (IS_C4F575) &t_13);
      HAMR_SW_FlightPlanner_Impl_Initialization_Api_put_FlightPlan_(SF ((HAMR_SW_FlightPlanner_Impl_Initialization_Api) &t_12), (IS_C4F575) ((IS_C4F575) &t_13));
    }
    ...
    sfUpdateLoc(122);
    {
      ...
      HAMR_SW_FlightPlanner_Impl_Operational_Api_put_FlightPlan_(SF ((HAMR_SW_FlightPlanner_Impl_Operational_Api) &t_14), (IS_C4F575) ((IS_C4F575) &t_15));
    }
  }
}

Unit HAMR_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_FlightPlanner_run(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "FlightPlanner.scala", "HAMR.FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner.FlightPlanner", "run", 0);
}
