...
Z art_Bridge_id_(STACK_FRAME art_Bridge this) {
  switch (this->type) {
    case THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge: return HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_id_((HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge) this);
...
void art_Bridge_dispatchProtocol_(STACK_FRAME art_DispatchPropertyProtocol result, art_Bridge this) {
  switch (this->type) {
    case THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge: Type_assign(result, HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_dispatchProtocol_((HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge) this), sizeof(union art_DispatchPropertyProtocol)); return;
    default: fprintf(stderr, "Infeasible TYPE: %s.\n", TYPE_string_(this)); exit(1);
  }
}
...
void art_Bridge_ports_(STACK_FRAME art_Bridge_Ports result, art_Bridge this) {
  switch (this->type) {
    case THAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge: Type_assign(result, HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge_ports_((HAMR_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_Bridge) this), sizeof(struct art_Bridge_Ports)); return;
    default: fprintf(stderr, "Infeasible TYPE: %s.\n", TYPE_string_(this)); exit(1);
  }
}