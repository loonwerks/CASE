...
Unit HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_initialiseArchitecture(STACK_FRAME_ONLY) {
  ...
  t_1.size = (int8_t) 1;
  IS_7E8796_up(&t_1, 0, (art_Bridge) HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_FlightControllerBridge(SF_LAST));
...
Unit HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_touch(STACK_FRAME_ONLY) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(108);
    {
      ...
      HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_touch_printDataContent(SF (art_DataContent) (&t_1));
    }
    ...
    sfUpdateLoc(109);
    {
      ...
      HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_touch_printDataContent(SF (art_DataContent) (&t_3));
    }

    sfUpdateLoc(111);
    {
      DeclNewHAMR_SW_FlightController_Impl_Initialization_Api(t_4);
      Option_7A3D33_get_(SF (HAMR_SW_FlightController_Impl_Initialization_Api) &t_4, HAMR_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge_c_initialization_api(SF_LAST));
      HAMR_SW_FlightController_Impl_Initialization_Api_logInfo_(SF ((HAMR_SW_FlightController_Impl_Initialization_Api) &t_4), (String) string(""));
    }

    sfUpdateLoc(112);
    {
      DeclNewHAMR_SW_FlightController_Impl_Initialization_Api(t_5);
      Option_7A3D33_get_(SF (HAMR_SW_FlightController_Impl_Initialization_Api) &t_5, HAMR_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge_c_initialization_api(SF_LAST));
      HAMR_SW_FlightController_Impl_Initialization_Api_logDebug_(SF ((HAMR_SW_FlightController_Impl_Initialization_Api) &t_5), (String) string(""));
    }

    sfUpdateLoc(113);
    {
      DeclNewHAMR_SW_FlightController_Impl_Initialization_Api(t_6);
      Option_7A3D33_get_(SF (HAMR_SW_FlightController_Impl_Initialization_Api) &t_6, HAMR_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge_c_initialization_api(SF_LAST));
      HAMR_SW_FlightController_Impl_Initialization_Api_logError_(SF ((HAMR_SW_FlightController_Impl_Initialization_Api) &t_6), (String) string(""));
    }

    sfUpdateLoc(114);
    {
      DeclNewHAMR_SW_FlightController_Impl_Operational_Api(t_7);
      Option_642C2E_get_(SF (HAMR_SW_FlightController_Impl_Operational_Api) &t_7, HAMR_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge_c_operational_api(SF_LAST));
      HAMR_SW_FlightController_Impl_Operational_Api_logInfo_(SF ((HAMR_SW_FlightController_Impl_Operational_Api) &t_7), (String) string(""));
    }

    sfUpdateLoc(115);
    {
      DeclNewHAMR_SW_FlightController_Impl_Operational_Api(t_8);
      Option_642C2E_get_(SF (HAMR_SW_FlightController_Impl_Operational_Api) &t_8, HAMR_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge_c_operational_api(SF_LAST));
      HAMR_SW_FlightController_Impl_Operational_Api_logDebug_(SF ((HAMR_SW_FlightController_Impl_Operational_Api) &t_8), (String) string(""));
    }

    sfUpdateLoc(116);
    {
      DeclNewHAMR_SW_FlightController_Impl_Operational_Api(t_9);
      Option_642C2E_get_(SF (HAMR_SW_FlightController_Impl_Operational_Api) &t_9, HAMR_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge_c_operational_api(SF_LAST));
      HAMR_SW_FlightController_Impl_Operational_Api_logError_(SF ((HAMR_SW_FlightController_Impl_Operational_Api) &t_9), (String) string(""));
    }

    sfUpdateLoc(117);
    Option_30119F apiUsage_FlightPlan;
    DeclNewHAMR_SW_FlightController_Impl_Operational_Api(t_10);
    Option_642C2E_get_(SF (HAMR_SW_FlightController_Impl_Operational_Api) &t_10, HAMR_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge_c_operational_api(SF_LAST));
    DeclNewOption_30119F(t_11);
    HAMR_SW_FlightController_Impl_Operational_Api_get_FlightPlan_(SF (Option_30119F) &t_11, ((HAMR_SW_FlightController_Impl_Operational_Api) &t_10));
    ...
    HAMR_SW_FlightController_Impl_Operational_Api_get_Alert_(SF (Option_C622DB) &t_13, ((HAMR_SW_FlightController_Impl_Operational_Api) &t_12));
    apiUsage_Alert = (Option_C622DB) ((Option_C622DB) &t_13);
  }
}

Unit HAMR_FlightController_Impl_SW_FlightController_FlightController_FlightController_run(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "FlightController.scala", "HAMR.FlightController_Impl_SW_FlightController_FlightController.FlightController", "run", 0);
}
