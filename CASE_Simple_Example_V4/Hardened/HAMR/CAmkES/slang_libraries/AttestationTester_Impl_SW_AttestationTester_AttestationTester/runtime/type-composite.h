...
typedef enum {
  ...
  THAMR_SW_AttestationTester_Impl_Initialization_Api = 0x4B8FBE8A, // HAMR.SW.AttestationTester_Impl_Initialization_Api
  THAMR_SW_AttestationTester_Impl_Operational_Api = 0xCEDDF5C8, // HAMR.SW.AttestationTester_Impl_Operational_Api
  THAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge = 0x0945F54B, // HAMR.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge
  THAMR_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge_EntryPoints = 0xEEF86AA8, // HAMR.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge.EntryPoints
  ...
  TNone_570D44 = 0x570D44F6, // None[HAMR.SW.AttestationTester_Impl_Initialization_Api]
  TNone_3A9994 = 0x3A9994B7, // None[HAMR.SW.AttestationTester_Impl_Operational_Api]
  ...
  TSome_4F9B23 = 0x4F9B23FA, // Some[HAMR.SW.AttestationTester_Impl_Initialization_Api]
  TSome_E55508 = 0xE55508C9, // Some[HAMR.SW.AttestationTester_Impl_Operational_Api]
