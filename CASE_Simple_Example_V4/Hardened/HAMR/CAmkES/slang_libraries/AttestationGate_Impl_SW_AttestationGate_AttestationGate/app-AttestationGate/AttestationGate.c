...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "AttestationGate.scala", "HAMR.AttestationGate_Impl_SW_AttestationGate_AttestationGate.AttestationGate", "<App>", 0);
  ...
  return (int) HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_main(SF &t_args);
}