...
Unit art_Art_run(STACK_FRAME art_ArchitectureDescription system) {
  ...
  sfUpdateLoc(99);
  {
    HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_run(SF_LAST);
  }
}
  ...
  if (!match_34_12) {
    ...
    if (match_34_12) {
      ...
      sfUpdateLoc(36);
      {
        ...
        HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_logInfo(SF (String) art_Art_logTitle(SF_LAST), (String) ((String) &t_4));
      }
    }
  }
  if (!match_34_12) {
    ...
    if (match_34_12) {
      ...
      sfUpdateLoc(38);
      {
        ...
        HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_logInfo(SF (String) art_Art_logTitle(SF_LAST), (String) ((String) &t_6));
      }
    }
  }
      ...
      if (!match_42_12) {
        ...
        if (match_42_12) {
          ...
          sfUpdateLoc(43);
          {
            ...
            HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_logInfo(SF (String) art_Art_logTitle(SF_LAST), (String) ((String) &t_12));
          }
        }
      }
      if (!match_42_12) {
        ...
        if (match_42_12) {
          ...
          sfUpdateLoc(44);
          {
            ...
            HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_logInfo(SF (String) art_Art_logTitle(SF_LAST), (String) ((String) &t_14));
          }
        }
      }
      if (!match_42_12) {
        ...
        if (match_42_12) {
          ...
          sfUpdateLoc(45);
          {
            ...
            HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_logInfo(SF (String) art_Art_logTitle(SF_LAST), (String) ((String) &t_16));
          }
        }
      }
      if (!match_42_12) {
        ...
        if (match_42_12) {
          ...
          sfUpdateLoc(46);
          {
            ...
            HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_logInfo(SF (String) art_Art_logTitle(SF_LAST), (String) ((String) &t_18));
          }
        }
      }
...
Unit art_Art_logInfo(STACK_FRAME Z bridgeId, String msg) {
  ...
  sfUpdateLoc(73);
  {
    ...
    HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_logInfo(SF (String) ((String) &t_1), (String) msg);
  }
}
...
Unit art_Art_logDebug(STACK_FRAME Z bridgeId, String msg) {
  ...
  sfUpdateLoc(81);
  {
    ...
    DeclNewString(t_1);
    art_Bridge_name_(SF (String) &t_1, ((art_Bridge) &t_0));
    HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_logDebug(SF (String) ((String) &t_1), (String) msg);
  }
}
...
Unit art_Art_logError(STACK_FRAME Z bridgeId, String msg) {
  ...
  sfUpdateLoc(77);
  {
    ...
    DeclNewString(t_1);
    art_Bridge_name_(SF (String) &t_1, ((art_Bridge) &t_0));
    HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_logError(SF (String) ((String) &t_1), (String) msg);
  }
}
