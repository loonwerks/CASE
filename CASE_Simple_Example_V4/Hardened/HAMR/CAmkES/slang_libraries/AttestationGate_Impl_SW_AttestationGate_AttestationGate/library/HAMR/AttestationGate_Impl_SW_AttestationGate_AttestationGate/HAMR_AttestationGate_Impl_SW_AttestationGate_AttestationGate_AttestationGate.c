...
Unit HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_initialiseArchitecture(STACK_FRAME_ONLY) {
  ...
  t_1.size = (int8_t) 1;
  IS_7E8796_up(&t_1, 0, (art_Bridge) HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_AttestationGateBridge(SF_LAST));
...
Unit HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_touch(STACK_FRAME_ONLY) {
  ...
  if (t_0) {
    ...
    sfUpdateLoc(121);
    {
      ...
      HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_touch_printDataContent(SF (art_DataContent) (&t_1));
    }
    ...
    sfUpdateLoc(122);
    {
      ...
      HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_touch_printDataContent(SF (art_DataContent) (&t_3));
    }

    sfUpdateLoc(124);
    {
      DeclNewHAMR_SW_AttestationGate_Impl_Initialization_Api(t_4);
      Option_207473_get_(SF (HAMR_SW_AttestationGate_Impl_Initialization_Api) &t_4, HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_c_initialization_api(SF_LAST));
      HAMR_SW_AttestationGate_Impl_Initialization_Api_logInfo_(SF ((HAMR_SW_AttestationGate_Impl_Initialization_Api) &t_4), (String) string(""));
    }

    sfUpdateLoc(125);
    {
      DeclNewHAMR_SW_AttestationGate_Impl_Initialization_Api(t_5);
      Option_207473_get_(SF (HAMR_SW_AttestationGate_Impl_Initialization_Api) &t_5, HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_c_initialization_api(SF_LAST));
      HAMR_SW_AttestationGate_Impl_Initialization_Api_logDebug_(SF ((HAMR_SW_AttestationGate_Impl_Initialization_Api) &t_5), (String) string(""));
    }

    sfUpdateLoc(126);
    {
      DeclNewHAMR_SW_AttestationGate_Impl_Initialization_Api(t_6);
      Option_207473_get_(SF (HAMR_SW_AttestationGate_Impl_Initialization_Api) &t_6, HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_c_initialization_api(SF_LAST));
      HAMR_SW_AttestationGate_Impl_Initialization_Api_logError_(SF ((HAMR_SW_AttestationGate_Impl_Initialization_Api) &t_6), (String) string(""));
    }

    sfUpdateLoc(127);
    {
      DeclNewHAMR_SW_AttestationGate_Impl_Operational_Api(t_7);
      Option_921595_get_(SF (HAMR_SW_AttestationGate_Impl_Operational_Api) &t_7, HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_c_operational_api(SF_LAST));
      HAMR_SW_AttestationGate_Impl_Operational_Api_logInfo_(SF ((HAMR_SW_AttestationGate_Impl_Operational_Api) &t_7), (String) string(""));
    }

    sfUpdateLoc(128);
    {
      DeclNewHAMR_SW_AttestationGate_Impl_Operational_Api(t_8);
      Option_921595_get_(SF (HAMR_SW_AttestationGate_Impl_Operational_Api) &t_8, HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_c_operational_api(SF_LAST));
      HAMR_SW_AttestationGate_Impl_Operational_Api_logDebug_(SF ((HAMR_SW_AttestationGate_Impl_Operational_Api) &t_8), (String) string(""));
    }

    sfUpdateLoc(129);
    {
      DeclNewHAMR_SW_AttestationGate_Impl_Operational_Api(t_9);
      Option_921595_get_(SF (HAMR_SW_AttestationGate_Impl_Operational_Api) &t_9, HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_c_operational_api(SF_LAST));
      HAMR_SW_AttestationGate_Impl_Operational_Api_logError_(SF ((HAMR_SW_AttestationGate_Impl_Operational_Api) &t_9), (String) string(""));
    }

    sfUpdateLoc(130);
    Option_30119F apiUsage_MissionCommand_in;
    DeclNewHAMR_SW_AttestationGate_Impl_Operational_Api(t_10);
    Option_921595_get_(SF (HAMR_SW_AttestationGate_Impl_Operational_Api) &t_10, HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_c_operational_api(SF_LAST));
    DeclNewOption_30119F(t_11);
    HAMR_SW_AttestationGate_Impl_Operational_Api_get_MissionCommand_in_(SF (Option_30119F) &t_11, ((HAMR_SW_AttestationGate_Impl_Operational_Api) &t_10));
    apiUsage_MissionCommand_in = (Option_30119F) ((Option_30119F) &t_11);

    sfUpdateLoc(131);
    {
      DeclNewHAMR_SW_AttestationGate_Impl_Initialization_Api(t_12);
      Option_207473_get_(SF (HAMR_SW_AttestationGate_Impl_Initialization_Api) &t_12, HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_c_initialization_api(SF_LAST));
      DeclNewIS_C4F575(t_13);
      HAMR_Base_Types_Bits_example(SF (IS_C4F575) &t_13);
      HAMR_SW_AttestationGate_Impl_Initialization_Api_put_MissionCommand_out_(SF ((HAMR_SW_AttestationGate_Impl_Initialization_Api) &t_12), (IS_C4F575) ((IS_C4F575) &t_13));
    }
    ...
    sfUpdateLoc(132);
    {
      ...
      HAMR_SW_AttestationGate_Impl_Operational_Api_put_MissionCommand_out_(SF ((HAMR_SW_AttestationGate_Impl_Operational_Api) &t_14), (IS_C4F575) ((IS_C4F575) &t_15));
    }

    sfUpdateLoc(133);
    Option_30119F apiUsage_TrustedIds;
    DeclNewHAMR_SW_AttestationGate_Impl_Operational_Api(t_16);
    Option_921595_get_(SF (HAMR_SW_AttestationGate_Impl_Operational_Api) &t_16, HAMR_SW_AttestationGate_Impl_SW_AttestationGate_AttestationGate_Bridge_c_operational_api(SF_LAST));
    DeclNewOption_30119F(t_17);
    HAMR_SW_AttestationGate_Impl_Operational_Api_get_TrustedIds_(SF (Option_30119F) &t_17, ((HAMR_SW_AttestationGate_Impl_Operational_Api) &t_16));
    apiUsage_TrustedIds = (Option_30119F) ((Option_30119F) &t_17);
  }
}

Unit HAMR_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_run(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "AttestationGate.scala", "HAMR.AttestationGate_Impl_SW_AttestationGate_AttestationGate.AttestationGate", "run", 0);
}
