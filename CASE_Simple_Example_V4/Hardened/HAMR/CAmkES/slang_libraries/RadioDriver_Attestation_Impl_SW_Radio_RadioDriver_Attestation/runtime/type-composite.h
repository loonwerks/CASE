...
typedef enum {
  ...
  THAMR_SW_RadioDriver_Attestation_Impl_Initialization_Api = 0x36E79E27, // HAMR.SW.RadioDriver_Attestation_Impl_Initialization_Api
  THAMR_SW_RadioDriver_Attestation_Impl_Operational_Api = 0x02ECC818, // HAMR.SW.RadioDriver_Attestation_Impl_Operational_Api
  THAMR_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation_Bridge = 0xD62B3ACE, // HAMR.SW.RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation_Bridge
  THAMR_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation_Bridge_EntryPoints = 0x5BE8DEB9, // HAMR.SW.RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation_Bridge.EntryPoints
  ...
  TNone_C931A3 = 0xC931A334, // None[HAMR.SW.RadioDriver_Attestation_Impl_Initialization_Api]
  TNone_FF6291 = 0xFF62912B, // None[HAMR.SW.RadioDriver_Attestation_Impl_Operational_Api]
  ...
  TSome_51939A = 0x51939A68, // Some[HAMR.SW.RadioDriver_Attestation_Impl_Initialization_Api]
  TSome_6B4FE0 = 0x6B4FE029, // Some[HAMR.SW.RadioDriver_Attestation_Impl_Operational_Api]
