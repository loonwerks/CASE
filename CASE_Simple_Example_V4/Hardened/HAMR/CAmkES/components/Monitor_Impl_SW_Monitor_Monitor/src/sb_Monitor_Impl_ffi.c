...
void ffiapi_get_FlightPlan_in(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  size_t numBits = 0;
  output[0] = api_get_FlightPlan_in__HAMR_SW_Monitor_Impl_SW_Monitor_Monitor(SF &numBits, (U8 *)(output + 1));
...
void ffiapi_send_FlightPlan_out(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  api_put_FlightPlan_out__HAMR_SW_Monitor_Impl_SW_Monitor_Monitor(SF parameterSizeBytes*8, (U8 *)parameter);
}
