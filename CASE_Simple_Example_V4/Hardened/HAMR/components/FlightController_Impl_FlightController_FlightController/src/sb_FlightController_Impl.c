...
B HAMR_SW_FlightController_Impl_FlightController_FlightController_seL4Nix_FlightPlan_IsEmpty(STACK_FRAME_ONLY) {
  return sb_FlightPlan_is_empty();
}

// receive FlightPlan: In EventDataPort union_art_DataContent
Unit HAMR_SW_FlightController_Impl_FlightController_FlightController_seL4Nix_FlightPlan_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_FlightController_Impl.c", "", "HAMR_SW_FlightController_Impl_FlightController_FlightController_seL4Nix_FlightPlan_Receive", 0);
...
B HAMR_SW_FlightController_Impl_FlightController_FlightController_seL4Nix_Alert_IsEmpty(STACK_FRAME_ONLY) {
  return sb_Alert_is_empty();
}

// receive Alert: In EventPort
Unit HAMR_SW_FlightController_Impl_FlightController_FlightController_seL4Nix_Alert_Receive(STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_FlightController_Impl.c", "", "HAMR_SW_FlightController_Impl_FlightController_FlightController_seL4Nix_Alert_Receive", 0);
...
void pre_init(void) {
  ...
  printf("Entering pre-init of FlightController_Impl_FlightController_FlightController\n");
  ...
  HAMR_SW_FlightController_Impl_FlightController_FlightController_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  HAMR_SW_FlightController_Impl_FlightController_FlightController_adapter_initialiseEntryPoint(SF_LAST);

  printf("Leaving pre-init of FlightController_Impl_FlightController_FlightController\n");
}
...
int run(void) {
  ...
  for(;;) {
    ...
    HAMR_SW_FlightController_Impl_FlightController_FlightController_adapter_computeEntryPoint(SF_LAST);
  }
  return 0;
}
