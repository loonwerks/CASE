...
Unit HAMR_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation_seL4Nix_AttestationTesterRequest_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_Impl.c", "", "HAMR_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation_seL4Nix_AttestationTesterRequest_Send", 0);
...
B HAMR_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation_seL4Nix_AttestationTesterResponse_IsEmpty(STACK_FRAME_ONLY) {
  return sb_AttestationTesterResponse_is_empty();
}

// receive AttestationTesterResponse: In EventDataPort union_art_DataContent
Unit HAMR_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation_seL4Nix_AttestationTesterResponse_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_RadioDriver_Attestation_Impl.c", "", "HAMR_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation_seL4Nix_AttestationTesterResponse_Receive", 0);
