...
Unit HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_FlightPlan_out_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Monitor_Impl.c", "", "HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_FlightPlan_out_Send", 0);
...
B HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_FlightPlan_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_FlightPlan_in_is_empty();
}

// receive FlightPlan_in: In EventDataPort union_art_DataContent
Unit HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_FlightPlan_in_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Monitor_Impl.c", "", "HAMR_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_FlightPlan_in_Receive", 0);
