...
package HAMR_Simple_V4.Monitor_Impl_SW_Monitor_Monitor
...
import HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_seL4Nix

object Monitor extends App {

  val MonitorBridge : HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge = {
  ...
  def touch(): Unit = {
    if(F) {
      ...
      HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.c_initialization_api.get.logInfo("")
      HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.c_initialization_api.get.logDebug("")
      HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.c_initialization_api.get.logError("")
      HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.c_operational_api.get.logInfo("")
      HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.c_operational_api.get.logDebug("")
      HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.c_operational_api.get.logError("")
      val apiUsage_FlightPlan_in: Option[Base_Types.Bits] = HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.c_operational_api.get.get_FlightPlan_in()
      HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.c_initialization_api.get.put_FlightPlan_out(Base_Types.Bits_example())
      HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.c_operational_api.get.put_FlightPlan_out(Base_Types.Bits_example())
      HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.c_initialization_api.get.put_Alert()
      HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.c_operational_api.get.put_Alert()
    }
  }
