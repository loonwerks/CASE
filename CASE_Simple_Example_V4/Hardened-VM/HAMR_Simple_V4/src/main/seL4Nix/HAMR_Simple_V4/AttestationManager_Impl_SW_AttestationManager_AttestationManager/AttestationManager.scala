...
package HAMR_Simple_V4.AttestationManager_Impl_SW_AttestationManager_AttestationManager
...
import HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_seL4Nix

object AttestationManager extends App {

  val AttestationManagerBridge : HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge = {
  ...
  def touch(): Unit = {
    if(F) {
      ...
      HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.c_initialization_api.get.logInfo("")
      HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.c_initialization_api.get.logDebug("")
      HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.c_initialization_api.get.logError("")
      HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.c_operational_api.get.logInfo("")
      HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.c_operational_api.get.logDebug("")
      HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.c_operational_api.get.logError("")
      HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.c_initialization_api.get.put_AttestationRequest(Base_Types.Bits_example())
      HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.c_operational_api.get.put_AttestationRequest(Base_Types.Bits_example())
      val apiUsage_AttestationResponse: Option[Base_Types.Bits] = HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.c_operational_api.get.get_AttestationResponse()
      HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.c_initialization_api.get.put_TrustedIds(Base_Types.Bits_example())
      HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.c_operational_api.get.put_TrustedIds(Base_Types.Bits_example())
    }
  }
