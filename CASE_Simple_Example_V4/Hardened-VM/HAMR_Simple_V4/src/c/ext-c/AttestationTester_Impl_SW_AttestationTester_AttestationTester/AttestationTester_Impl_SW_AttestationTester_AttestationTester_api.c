...
Unit HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_timeTriggered(
  STACK_FRAME
  HAMR_Simple_V4_SW_AttestationTester_Impl_Operational_Api api) {
  DeclNewStackFrame(caller, "AttestationTester_Impl_SW_AttestationTester_AttestationTester_api.c", "", "HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_timeTriggered", 0);

  HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_AttestationTester_timeTriggered_(SF_LAST);
}
