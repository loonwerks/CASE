...
Unit HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_timeTriggered(
  STACK_FRAME
  HAMR_Simple_V4_SW_FlightController_Impl_Operational_Api api) {
  DeclNewStackFrame(caller, "FlightController_Impl_SW_FlightController_FlightController_api.c", "", "HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_timeTriggered", 0);

  HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_timeTriggered_(SF_LAST);
}
