...
// send FlightPlan_out: Out EventDataPort Data_Types__Mission
Unit HAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_FlightPlan_out_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Monitor_Impl.c", "", "HAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_FlightPlan_out_Send", 0);

  sb_FlightPlan_out_enqueue(d);
}

// send Alert: Out EventPort
Unit HAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_Alert_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_Monitor_Impl.c", "", "HAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_Alert_Send", 0);
...
B HAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_FlightPlan_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_FlightPlan_in_is_empty();
}

// receive FlightPlan_in: In EventDataPort union_art_DataContent
Unit HAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_FlightPlan_in_Receive(
  STACK_FRAME
  Option_8E9F45 result) {
  DeclNewStackFrame(caller, "sb_Monitor_Impl.c", "", "HAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_seL4Nix_FlightPlan_in_Receive", 0);
...
void pre_init(void) {
  ...
  *sb_Alert_counter = 0;
  ...
  HAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  HAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_adapter_initialiseEntryPoint(SF_LAST);
...
int run(void) {
  ...
  for(;;) {
    ...
    HAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_adapter_computeEntryPoint(SF_LAST);
  }
  return 0;
}
#endif
