...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "RadioDriver.scala", "HAMR_Simple_V4.RadioDriver_Attestation_Impl_SW_Radio_RadioDriver.RadioDriver", "<App>", 0);
  ...
  return (int) HAMR_Simple_V4_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_RadioDriver_main(SF &t_args);
}