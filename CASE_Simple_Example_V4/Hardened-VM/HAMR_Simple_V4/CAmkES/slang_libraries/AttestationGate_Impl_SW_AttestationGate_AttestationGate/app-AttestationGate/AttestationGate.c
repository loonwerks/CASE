...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "AttestationGate.scala", "HAMR_Simple_V4.AttestationGate_Impl_SW_AttestationGate_AttestationGate.AttestationGate", "<App>", 0);
  ...
  return (int) HAMR_Simple_V4_AttestationGate_Impl_SW_AttestationGate_AttestationGate_AttestationGate_main(SF &t_args);
}