...
B art_Port_45E54D__ne(art_Port_45E54D this, art_Port_45E54D other);
...
B art_Port_45E54D__is(STACK_FRAME void* this);
art_Port_45E54D art_Port_45E54D__as(STACK_FRAME void *this);

void art_Port_45E54D_apply(STACK_FRAME art_Port_45E54D this, Z id, String name, art_PortMode_Type mode) {
  DeclNewStackFrame(caller, "ArchitectureDescription.scala", "art.art_Port_45E54D", "apply", 0);
  this->id = id;
