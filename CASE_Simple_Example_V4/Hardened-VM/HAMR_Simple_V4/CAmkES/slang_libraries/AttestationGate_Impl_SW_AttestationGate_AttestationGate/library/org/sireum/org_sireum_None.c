...
void None_02D0B8_get_(STACK_FRAME HAMR_Simple_V4_SW_AttestationGate_Impl_Initialization_Api result, None_02D0B8 this) {
...
void None_3F8D24_get_(STACK_FRAME HAMR_Simple_V4_SW_AttestationGate_Impl_Operational_Api result, None_3F8D24 this) {
  DeclNewStackFrame(caller, "Option.scala", "org.sireum.None", "get", 0);
