...
void None_556BC5_get_(STACK_FRAME HAMR_Simple_V4_SW_Monitor_Impl_Initialization_Api result, None_556BC5 this) {
...
void None_D81833_get_(STACK_FRAME HAMR_Simple_V4_SW_Monitor_Impl_Operational_Api result, None_D81833 this) {
  DeclNewStackFrame(caller, "Option.scala", "org.sireum.None", "get", 0);
