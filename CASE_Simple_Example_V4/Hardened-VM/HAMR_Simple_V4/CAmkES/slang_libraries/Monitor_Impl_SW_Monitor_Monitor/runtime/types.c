...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case THAMR_Simple_V4_SW_Monitor_Impl_Initialization_Api: return sizeof(struct HAMR_Simple_V4_SW_Monitor_Impl_Initialization_Api); // HAMR_Simple_V4.SW.Monitor_Impl_Initialization_Api
    case THAMR_Simple_V4_SW_Monitor_Impl_Operational_Api: return sizeof(struct HAMR_Simple_V4_SW_Monitor_Impl_Operational_Api); // HAMR_Simple_V4.SW.Monitor_Impl_Operational_Api
    case THAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge: return sizeof(struct HAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge); // HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge
    case THAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_EntryPoints: return sizeof(struct HAMR_Simple_V4_SW_Monitor_Impl_SW_Monitor_Monitor_Bridge_EntryPoints); // HAMR_Simple_V4.SW.Monitor_Impl_SW_Monitor_Monitor_Bridge.EntryPoints
    ...
    case TNone_556BC5: return sizeof(struct None_556BC5); // None[HAMR_Simple_V4.SW.Monitor_Impl_Initialization_Api]
    case TNone_D81833: return sizeof(struct None_D81833); // None[HAMR_Simple_V4.SW.Monitor_Impl_Operational_Api]
    ...
    case TSome_CF7B75: return sizeof(struct Some_CF7B75); // Some[HAMR_Simple_V4.SW.Monitor_Impl_Initialization_Api]
    case TSome_E0238A: return sizeof(struct Some_E0238A); // Some[HAMR_Simple_V4.SW.Monitor_Impl_Operational_Api]
