...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case THAMR_Simple_V4_SW_AttestationManager_Impl_Initialization_Api: return sizeof(struct HAMR_Simple_V4_SW_AttestationManager_Impl_Initialization_Api); // HAMR_Simple_V4.SW.AttestationManager_Impl_Initialization_Api
    case THAMR_Simple_V4_SW_AttestationManager_Impl_Operational_Api: return sizeof(struct HAMR_Simple_V4_SW_AttestationManager_Impl_Operational_Api); // HAMR_Simple_V4.SW.AttestationManager_Impl_Operational_Api
    case THAMR_Simple_V4_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge: return sizeof(struct HAMR_Simple_V4_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge); // HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge
    case THAMR_Simple_V4_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints: return sizeof(struct HAMR_Simple_V4_SW_AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge_EntryPoints); // HAMR_Simple_V4.SW.AttestationManager_Impl_SW_AttestationManager_AttestationManager_Bridge.EntryPoints
    ...
    case TNone_B594B8: return sizeof(struct None_B594B8); // None[HAMR_Simple_V4.SW.AttestationManager_Impl_Initialization_Api]
    case TNone_BCB2D2: return sizeof(struct None_BCB2D2); // None[HAMR_Simple_V4.SW.AttestationManager_Impl_Operational_Api]
    ...
    case TSome_9DE0EF: return sizeof(struct Some_9DE0EF); // Some[HAMR_Simple_V4.SW.AttestationManager_Impl_Initialization_Api]
    case TSome_B273EC: return sizeof(struct Some_B273EC); // Some[HAMR_Simple_V4.SW.AttestationManager_Impl_Operational_Api]
