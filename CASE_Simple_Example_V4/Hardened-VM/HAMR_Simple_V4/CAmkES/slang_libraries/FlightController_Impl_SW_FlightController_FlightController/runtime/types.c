...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case THAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge: return sizeof(struct HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge); // HAMR_Simple_V4.SW.FlightController_Impl_SW_FlightController_FlightController_Bridge
    case THAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge_EntryPoints: return sizeof(struct HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge_EntryPoints); // HAMR_Simple_V4.SW.FlightController_Impl_SW_FlightController_FlightController_Bridge.EntryPoints
