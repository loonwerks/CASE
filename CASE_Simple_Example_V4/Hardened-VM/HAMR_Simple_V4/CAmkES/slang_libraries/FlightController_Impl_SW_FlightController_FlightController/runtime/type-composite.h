...
typedef enum {
  ...
  THAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge = 0xB3A26EAF, // HAMR_Simple_V4.SW.FlightController_Impl_SW_FlightController_FlightController_Bridge
  THAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_Bridge_EntryPoints = 0xFABF0FA2, // HAMR_Simple_V4.SW.FlightController_Impl_SW_FlightController_FlightController_Bridge.EntryPoints
