...
import HAMR_Simple_V4.SW.{FlightController_Impl_SW_FlightController => component}

// This file was auto-generated.  Do not edit

@datatype class FlightController_Impl_SW_FlightController_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : FlightController_Impl_Initialization_Api = {
    ...
    FlightController_Impl_SW_FlightController_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : FlightController_Impl_Operational_Api = {
    ...
    FlightController_Impl_SW_FlightController_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    FlightController_Impl_SW_FlightController_Bridge.EntryPoints(
      id,
...
object FlightController_Impl_SW_FlightController_Bridge {
  ...
  @datatype class EntryPoints(
    FlightController_Impl_SW_FlightController_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(FlightController_Impl_SW_FlightController_BridgeId)
