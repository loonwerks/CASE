...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "FlightController_Impl_SW_FlightController_App.scala", "HAMR_Simple_V4.FlightController_Impl_SW_FlightController_App", "<App>", 0);
  ...
  return (int) HAMR_Simple_V4_FlightController_Impl_SW_FlightController_App_main(SF &t_args);
}