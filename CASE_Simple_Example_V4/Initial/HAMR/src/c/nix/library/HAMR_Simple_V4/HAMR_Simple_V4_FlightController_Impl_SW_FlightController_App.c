...
static inline B HAMR_Simple_V4_FlightController_Impl_SW_FlightController_App_compute_extract_36_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_1, HAMR_Simple_V4_Base_Types_Bits_Payload *_v_36_19) {
...
static inline B HAMR_Simple_V4_FlightController_Impl_SW_FlightController_App_compute_extract_37_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_1, art_DataContent *_v_37_19) {
  if (!Some_D29615__is(SF t_1)) return F;
  *_v_37_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_1));
  return T;
}

static inline B HAMR_Simple_V4_FlightController_Impl_SW_FlightController_App_compute_extract_38_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_1) {
...
Unit HAMR_Simple_V4_FlightController_Impl_SW_FlightController_App_compute(STACK_FRAME_ONLY) {
  ...
  }
  {
    ...
    if (!match_35_11) {
      ...
      match_35_11 = HAMR_Simple_V4_FlightController_Impl_SW_FlightController_App_compute_extract_36_14_8E9F45(SF t_1, &v_36_19);
      if (match_35_11) {

        sfUpdateLoc(36);
        {
          HAMR_Simple_V4_ArtNix_updateData(SF HAMR_Simple_V4_FlightController_Impl_SW_FlightController_App_FlightPlanPortId(SF_LAST), (art_DataContent) v_36_19);
        }
    ...
    if (!match_35_11) {
      ...
      match_35_11 = HAMR_Simple_V4_FlightController_Impl_SW_FlightController_App_compute_extract_37_14_8E9F45(SF t_1, &v_37_19);
      if (match_35_11) {
    ...
    if (!match_35_11) {
      match_35_11 = HAMR_Simple_V4_FlightController_Impl_SW_FlightController_App_compute_extract_38_14_8E9F45(SF t_1);
      if (match_35_11) {
      }
    }
