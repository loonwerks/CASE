...
static inline B HAMR_Simple_V4_ArtNix_sendOutput_extract_78_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0, art_DataContent *_d_78_19) {
  if (!Some_D29615__is(SF t_0)) return F;
  *_d_78_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_0));
  return T;
}

static inline B HAMR_Simple_V4_ArtNix_sendOutput_extract_83_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_0) {
  return T;
}

static inline B HAMR_Simple_V4_ArtNix_sendOutput_extract_89_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_8, art_DataContent *_d_89_19) {
  if (!Some_D29615__is(SF t_8)) return F;
  *_d_89_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_8));
  return T;
}

static inline B HAMR_Simple_V4_ArtNix_sendOutput_extract_94_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_8) {
  return T;
}
  ...
  sfUpdateLoc(76);
  {
    ...
    for (int8_t t_7 = 0; t_7 < t_6; t_7++) {
      ...
      if (!match_77_7) {
        ...
        match_77_7 = HAMR_Simple_V4_ArtNix_sendOutput_extract_78_14_8E9F45(SF ((Option_8E9F45) &t_0), &d_78_19);
        if (match_77_7) {
          ...
          sfUpdateLoc(80);
          {
            ...
            for (int8_t t_4 = 0; t_4 < t_3; t_4++) {
              ...
              sfUpdateLoc(81);
              {
                B t_1 = HAMR_Simple_V4_PlatformNix_sendAsync(SF Tuple2_EC3B57_1(e), Tuple2_EC3B57_2(e), (art_DataContent) d_78_19);
              }
            }
          }
        }
      ...
      if (!match_77_7) {
        match_77_7 = HAMR_Simple_V4_ArtNix_sendOutput_extract_83_14_8E9F45(SF ((Option_8E9F45) &t_0));
        if (match_77_7) {
        }
      }
  ...
  sfUpdateLoc(87);
  {
    ...
    for (int8_t t_15 = 0; t_15 < t_14; t_15++) {
      ...
      if (!match_88_7) {
        ...
        match_88_7 = HAMR_Simple_V4_ArtNix_sendOutput_extract_89_14_8E9F45(SF ((Option_8E9F45) &t_8), &d_89_19);
        if (match_88_7) {
          ...
          sfUpdateLoc(91);
          {
            ...
            for (int8_t t_12 = 0; t_12 < t_11; t_12++) {
              ...
              sfUpdateLoc(92);
              {
                B t_9 = HAMR_Simple_V4_PlatformNix_sendAsync(SF Tuple2_EC3B57_1(e), Tuple2_EC3B57_2(e), (art_DataContent) d_89_19);
              }
            }
          }
        }
      ...
      if (!match_88_7) {
        match_88_7 = HAMR_Simple_V4_ArtNix_sendOutput_extract_94_14_8E9F45(SF ((Option_8E9F45) &t_8));
        if (match_88_7) {
        }
      }
...
void HAMR_Simple_V4_ArtNix_init_connection(STACK_FRAME_ONLY) {
  ...
  sfUpdateLoc(16);
  {
    ...
    sfUpdateLoc(19);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_6, HAMR_Simple_V4_IPCPorts_FlightPlanner_Impl_SW_FlightPlanner_App(SF_LAST), art_Port_45E54D_id_(HAMR_Simple_V4_SW_FlightPlanner_Impl_SW_FlightPlanner_Bridge_MissionCommand_(HAMR_Simple_V4_Arch_MissionComputer_Impl_Instance_SW_FlightPlanner(SF_LAST))));
      IS_AA0F82_up(&t_5, 0, (Tuple2_EC3B57) (&t_6));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_MissionCommand_(HAMR_Simple_V4_Arch_MissionComputer_Impl_Instance_SW_Radio(SF_LAST))), (IS_AA0F82) (&t_5));
    }
    ...
    sfUpdateLoc(22);
    {
      ...
      Tuple2_EC3B57_apply(SF &t_8, HAMR_Simple_V4_IPCPorts_FlightController_Impl_SW_FlightController_App(SF_LAST), art_Port_45E54D_id_(HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_FlightPlan_(HAMR_Simple_V4_Arch_MissionComputer_Impl_Instance_SW_FlightController(SF_LAST))));
      IS_AA0F82_up(&t_7, 0, (Tuple2_EC3B57) (&t_8));
      MS_B5E3E6_up(r, art_Port_45E54D_id_(HAMR_Simple_V4_SW_FlightPlanner_Impl_SW_FlightPlanner_Bridge_FlightPlan_(HAMR_Simple_V4_Arch_MissionComputer_Impl_Instance_SW_FlightPlanner(SF_LAST))), (IS_AA0F82) (&t_7));
    }
...
void HAMR_Simple_V4_ArtNix_init_eventInPorts(STACK_FRAME_ONLY) {
  ...
  DeclNewMS_30A5B4(t_9);
  t_9.size = (int8_t) 2;
  MS_30A5B4_up(&t_9, 0, (Z) art_Port_45E54D_id_(HAMR_Simple_V4_SW_FlightPlanner_Impl_SW_FlightPlanner_Bridge_MissionCommand_(HAMR_Simple_V4_Arch_MissionComputer_Impl_Instance_SW_FlightPlanner(SF_LAST))));
  MS_30A5B4_up(&t_9, 1, (Z) art_Port_45E54D_id_(HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_FlightPlan_(HAMR_Simple_V4_Arch_MissionComputer_Impl_Instance_SW_FlightController(SF_LAST))));
  Type_assign(&_HAMR_Simple_V4_ArtNix_eventInPorts, (&t_9), sizeof(struct MS_30A5B4));
};
...
void HAMR_Simple_V4_ArtNix_init_frozen(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(32);
  DeclNewMS_2590FE(t_10);
  MS_2590FE_create(SF (MS_2590FE) &t_10, HAMR_Simple_V4_ArtNix_maxPortIds(SF_LAST), (Option_8E9F45) HAMR_Simple_V4_ArtNix_noData(SF_LAST));
  Type_assign(&_HAMR_Simple_V4_ArtNix_frozen, ((MS_2590FE) &t_10), sizeof(struct MS_2590FE));
};
...
void HAMR_Simple_V4_ArtNix_init_outgoing(STACK_FRAME_ONLY) {
  ...
  MS_2590FE_create(SF (MS_2590FE) &t_11, HAMR_Simple_V4_ArtNix_maxPortIds(SF_LAST), (Option_8E9F45) HAMR_Simple_V4_ArtNix_noData(SF_LAST));
  Type_assign(&_HAMR_Simple_V4_ArtNix_outgoing, ((MS_2590FE) &t_11), sizeof(struct MS_2590FE));
};
