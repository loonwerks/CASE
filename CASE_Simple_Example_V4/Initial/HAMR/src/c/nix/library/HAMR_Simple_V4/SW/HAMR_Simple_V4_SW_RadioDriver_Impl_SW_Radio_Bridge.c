...
void HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_apply(STACK_FRAME HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge this, Z id, String name, art_DispatchPropertyProtocol dispatchProtocol, Option_9AF35E dispatchTriggers, art_Port_45E54D MissionCommand) {
  ...
  Type_assign(&this->MissionCommand, MissionCommand, sizeof(struct art_Port_45E54D));
  {
    ...
    t_1.size = (int8_t) 1;
    IS_820232_up(&t_1, 0, (art_UPort) HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_MissionCommand_(this));
    ...
    t_5.size = (int8_t) 1;
    IS_820232_up(&t_5, 0, (art_UPort) HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_MissionCommand_(this));
  ...
  }
  {
    sfUpdateLoc(33);
    {
      ...
      HAMR_Simple_V4_SW_RadioDriver_Impl_Initialization_Api_apply(SF &t_6, HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_id_(this), art_Port_45E54D_id_(HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_MissionCommand_(this)));
  ...
  }
  {
    sfUpdateLoc(42);
    {
      ...
      HAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api_apply(SF &t_8, HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_id_(this), art_Port_45E54D_id_(HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_MissionCommand_(this)));
