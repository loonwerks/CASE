...
//     Right click src/main/architecture/CASE_MONITOR_2_TEST/Demo.scala and choose "Run 'Demo'"
//
...
lazy val CASE_MONITOR_TEST_impl_1_Instance = slangEmbeddedProject("CASE_MONITOR_TEST_impl_1_Instance", ".")
...
val slangEmbeddedSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("CASE_MONITOR_2_TEST.Demo"),

  mainClass in assembly := Some("CASE_MONITOR_2_TEST.Demo"),
  assemblyJarName in assembly := "CASE_MONITOR_TEST_impl_1_Instance.jar",
...
val slangEmbeddedInspectorSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("CASE_MONITOR_2_TEST.InspectorDemo"),
)
