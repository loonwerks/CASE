...
B CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Operational_Api__ne(CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Operational_Api this, CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Operational_Api other);
...
void CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Operational_Api_string_(STACK_FRAME String result, CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Operational_Api this) {
  DeclNewStackFrame(caller, "Input_impl_Api.scala", "CASE_MONITOR_2_TEST.VPM_TEST.Input_impl_Operational_Api", "string", 0);
...
B CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Operational_Api__is(STACK_FRAME void* this);
CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Operational_Api CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Operational_Api__as(STACK_FRAME void *this);
...
void CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Operational_Api_apply(STACK_FRAME CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Operational_Api this, Z id, Z Observed_Id) {
  DeclNewStackFrame(caller, "Input_impl_Api.scala", "CASE_MONITOR_2_TEST.VPM_TEST.Input_impl_Operational_Api", "apply", 0);
  this->id = id;
