...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Initialization_Api: return sizeof(struct CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Initialization_Api); // CASE_MONITOR_2_TEST.VPM_TEST.Input_impl_Initialization_Api
    case TCASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Input_Input_Bridge: return sizeof(struct CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Input_Input_Bridge); // CASE_MONITOR_2_TEST.VPM_TEST.Input_impl_Input_Input_Bridge
    case TCASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints: return sizeof(struct CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints); // CASE_MONITOR_2_TEST.VPM_TEST.Input_impl_Input_Input_Bridge.EntryPoints
    case TCASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Operational_Api: return sizeof(struct CASE_MONITOR_2_TEST_VPM_TEST_Input_impl_Operational_Api); // CASE_MONITOR_2_TEST.VPM_TEST.Input_impl_Operational_Api
    ...
    case TNone_9BC69E: return sizeof(struct None_9BC69E); // None[CASE_MONITOR_2_TEST.VPM_TEST.Input_impl_Initialization_Api]
    case TNone_05FEAD: return sizeof(struct None_05FEAD); // None[CASE_MONITOR_2_TEST.VPM_TEST.Input_impl_Operational_Api]
    ...
    case TSome_C9A1C9: return sizeof(struct Some_C9A1C9); // Some[CASE_MONITOR_2_TEST.VPM_TEST.Input_impl_Initialization_Api]
    case TSome_2EBF4C: return sizeof(struct Some_2EBF4C); // Some[CASE_MONITOR_2_TEST.VPM_TEST.Input_impl_Operational_Api]
