...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api: return sizeof(struct CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api); // CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Initialization_Api
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api: return sizeof(struct CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api); // CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Operational_Api
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge: return sizeof(struct CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge); // CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Output_Output_Bridge
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints: return sizeof(struct CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints); // CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Output_Output_Bridge.EntryPoints
    ...
    case TNone_599856: return sizeof(struct None_599856); // None[CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Initialization_Api]
    case TNone_32B473: return sizeof(struct None_32B473); // None[CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Operational_Api]
    ...
    case TSome_BD30E2: return sizeof(struct Some_BD30E2); // Some[CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Initialization_Api]
    case TSome_459F82: return sizeof(struct Some_459F82); // Some[CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Operational_Api]
