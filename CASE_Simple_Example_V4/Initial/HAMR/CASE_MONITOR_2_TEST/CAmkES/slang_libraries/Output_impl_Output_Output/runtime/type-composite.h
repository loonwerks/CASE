...
typedef enum {
  ...
  TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api = 0x7FD61DAE, // CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Initialization_Api
  TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api = 0x11B9830A, // CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Operational_Api
  TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge = 0x3359B4DB, // CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Output_Output_Bridge
  TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints = 0x94A691F6, // CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Output_Output_Bridge.EntryPoints
  ...
  TNone_599856 = 0x5998567C, // None[CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Initialization_Api]
  TNone_32B473 = 0x32B47398, // None[CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Operational_Api]
  ...
  TSome_BD30E2 = 0xBD30E24C, // Some[CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Initialization_Api]
  TSome_459F82 = 0x459F8227, // Some[CASE_MONITOR_2_TEST.VPM_TEST.Output_impl_Operational_Api]
