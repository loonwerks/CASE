...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api: return CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api__eq((CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api) t1, (CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api) t2);
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api: return CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api__eq((CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api) t1, (CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api) t2);
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge: return CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge__eq((CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge) t1, (CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge) t2);
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints: return CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints__eq((CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints) t1, (CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints) t2);
    ...
    case TNone_599856: return None_599856__eq((None_599856) t1, (None_599856) t2);
    case TNone_32B473: return None_32B473__eq((None_32B473) t1, (None_32B473) t2);
    ...
    case TSome_BD30E2: return Some_BD30E2__eq((Some_BD30E2) t1, (Some_BD30E2) t2);
    case TSome_459F82: return Some_459F82__eq((Some_459F82) t1, (Some_459F82) t2);
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api: CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api_cprint((CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api) this, isOut); return;
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api: CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api_cprint((CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api) this, isOut); return;
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge: CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_cprint((CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge) this, isOut); return;
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints: CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints_cprint((CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints) this, isOut); return;
    ...
    case TNone_599856: None_599856_cprint((None_599856) this, isOut); return;
    case TNone_32B473: None_32B473_cprint((None_32B473) this, isOut); return;
    ...
    case TSome_BD30E2: Some_BD30E2_cprint((Some_BD30E2) this, isOut); return;
    case TSome_459F82: Some_459F82_cprint((Some_459F82) this, isOut); return;
...
void Type_string_(STACK_FRAME String result, void *this) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api: CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api_string_(CALLER result, (CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Initialization_Api) this); return;
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api: CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api_string_(CALLER result, (CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Operational_Api) this); return;
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge: CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_string_(CALLER result, (CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge) this); return;
    case TCASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints: CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints_string_(CALLER result, (CASE_MONITOR_2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints) this); return;
    ...
    case TNone_599856: None_599856_string_(CALLER result, (None_599856) this); return;
    case TNone_32B473: None_32B473_string_(CALLER result, (None_32B473) this); return;
    ...
    case TSome_BD30E2: Some_BD30E2_string_(CALLER result, (Some_BD30E2) this); return;
    case TSome_459F82: Some_459F82_string_(CALLER result, (Some_459F82) this); return;
