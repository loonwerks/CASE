...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge: return CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge__eq((CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge) t1, (CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge) t2);
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints: return CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints__eq((CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints) t1, (CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints) t2);
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api: return CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api__eq((CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api) t1, (CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api) t2);
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api: return CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api__eq((CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api) t1, (CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api) t2);
    ...
    case TNone_8805C8: return None_8805C8__eq((None_8805C8) t1, (None_8805C8) t2);
    case TNone_67F530: return None_67F530__eq((None_67F530) t1, (None_67F530) t2);
    ...
    case TSome_2E1D55: return Some_2E1D55__eq((Some_2E1D55) t1, (Some_2E1D55) t2);
    case TSome_A8BCDF: return Some_A8BCDF__eq((Some_A8BCDF) t1, (Some_A8BCDF) t2);
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge: CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_cprint((CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge) this, isOut); return;
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints: CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints_cprint((CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints) this, isOut); return;
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api: CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api_cprint((CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api) this, isOut); return;
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api: CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api_cprint((CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api) this, isOut); return;
    ...
    case TNone_8805C8: None_8805C8_cprint((None_8805C8) this, isOut); return;
    case TNone_67F530: None_67F530_cprint((None_67F530) this, isOut); return;
    ...
    case TSome_2E1D55: Some_2E1D55_cprint((Some_2E1D55) this, isOut); return;
    case TSome_A8BCDF: Some_A8BCDF_cprint((Some_A8BCDF) this, isOut); return;
...
void Type_string_(STACK_FRAME String result, void *this) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge: CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_string_(CALLER result, (CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge) this); return;
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints: CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints_string_(CALLER result, (CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints) this); return;
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api: CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api_string_(CALLER result, (CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api) this); return;
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api: CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api_string_(CALLER result, (CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api) this); return;
    ...
    case TNone_8805C8: None_8805C8_string_(CALLER result, (None_8805C8) this); return;
    case TNone_67F530: None_67F530_string_(CALLER result, (None_67F530) this); return;
    ...
    case TSome_2E1D55: Some_2E1D55_string_(CALLER result, (Some_2E1D55) this); return;
    case TSome_A8BCDF: Some_A8BCDF_string_(CALLER result, (Some_A8BCDF) this); return;
