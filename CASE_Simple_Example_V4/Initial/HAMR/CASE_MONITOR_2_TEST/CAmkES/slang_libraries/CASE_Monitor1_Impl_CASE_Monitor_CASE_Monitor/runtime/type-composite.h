...
typedef enum {
  ...
  TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge = 0xA4BF7AEB, // CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge
  TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints = 0x09CE50DA, // CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge.EntryPoints
  TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api = 0x9898184F, // CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_Initialization_Api
  TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api = 0x03AE34A1, // CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_Operational_Api
  ...
  TNone_8805C8 = 0x8805C83B, // None[CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_Initialization_Api]
  TNone_67F530 = 0x67F530DB, // None[CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_Operational_Api]
  ...
  TSome_2E1D55 = 0x2E1D550D, // Some[CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_Initialization_Api]
  TSome_A8BCDF = 0xA8BCDFB2, // Some[CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_Operational_Api]
