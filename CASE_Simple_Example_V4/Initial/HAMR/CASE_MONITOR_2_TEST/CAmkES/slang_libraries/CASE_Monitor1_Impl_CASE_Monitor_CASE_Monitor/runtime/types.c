...
size_t sizeOf(Type t) {
  TYPE type = t->type;
  switch (type) {
    case TCASE_MONITOR_2_TEST_Base_Types_Bits_Payload: return sizeof(struct CASE_MONITOR_2_TEST_Base_Types_Bits_Payload); // CASE_MONITOR_2_TEST.Base_Types.Bits_Payload
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge: return sizeof(struct CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge); // CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints: return sizeof(struct CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints); // CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge.EntryPoints
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api: return sizeof(struct CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api); // CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_Initialization_Api
    case TCASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api: return sizeof(struct CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_Operational_Api); // CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_Operational_Api
    ...
    case TNone_8805C8: return sizeof(struct None_8805C8); // None[CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_Initialization_Api]
    case TNone_67F530: return sizeof(struct None_67F530); // None[CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_Operational_Api]
    ...
    case TSome_2E1D55: return sizeof(struct Some_2E1D55); // Some[CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_Initialization_Api]
    case TSome_A8BCDF: return sizeof(struct Some_A8BCDF); // Some[CASE_MONITOR_2_TEST.VPM.CASE_Monitor1_Impl_Operational_Api]
...
char *TYPE_string_(void *type) {
  static char *strings[] = {
    "CASE_MONITOR_2_TEST.Base_Types.Bits_Payload",
