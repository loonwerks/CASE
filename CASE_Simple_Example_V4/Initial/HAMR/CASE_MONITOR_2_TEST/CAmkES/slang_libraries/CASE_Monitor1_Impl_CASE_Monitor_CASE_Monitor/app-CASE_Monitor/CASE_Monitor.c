...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "CASE_Monitor.scala", "CASE_MONITOR_2_TEST.CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor.CASE_Monitor", "<App>", 0);
  ...
  return (int) CASE_MONITOR_2_TEST_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_CASE_Monitor_main(SF &t_args);
}