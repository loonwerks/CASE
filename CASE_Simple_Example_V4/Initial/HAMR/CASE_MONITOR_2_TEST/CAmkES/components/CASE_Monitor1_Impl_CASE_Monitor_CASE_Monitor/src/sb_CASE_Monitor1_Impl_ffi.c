...
CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints entryPoints;
...
void init(STACK_FRAME_ONLY) {
  if(!initialized) {
    ...
    entryPoints = (CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints) CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_adapter_entryPoints(SF_LAST);
    event_in_port_ids = (IS_82ABD8) CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints_eventInPortIds_(entryPoints);
    data_in_port_ids = (IS_82ABD8) CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints_dataInPortIds_(entryPoints);
    event_out_port_ids = (IS_82ABD8) CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints_eventOutPortIds_(entryPoints);
    data_out_port_ids = (IS_82ABD8) CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints_dataOutPortIds_(entryPoints);
    initialized = true;
  }
}
...
void checkAndReportBufferOverrun(STACK_FRAME long bytesWritten, long bufferSizeBytes) {
  ...
  if (bytesWritten > bufferSizeBytes) {
    ...
    api_logInfo__CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor(SF str);
  }
  #endif
}
...
void ffiapi_logDebug(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  ...
  api_logDebug__CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor(SF str);
} 
...
void ffiapi_logError(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  ...
  api_logError__CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor(SF str);
} 
...
void ffiapi_get_Observed(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  size_t numBits = 0;
  output[0] = api_get_Observed__CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor(SF &numBits, (U8 *)(output + 1));
...
void ffiapi_send_Suspect_Traffic_Out(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  api_put_Suspect_Traffic_Out__CASE_MONITOR_2_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor(SF parameterSizeBytes*8, (U8 *)parameter);
}
