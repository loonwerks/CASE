...
abstract class Input_impl_Input_Input_TestApi extends BridgeTestSuite[Input_impl_Input_Input_Bridge](Arch.CASE_MONITOR_TEST_impl_1_Instance_Input_Input) {
