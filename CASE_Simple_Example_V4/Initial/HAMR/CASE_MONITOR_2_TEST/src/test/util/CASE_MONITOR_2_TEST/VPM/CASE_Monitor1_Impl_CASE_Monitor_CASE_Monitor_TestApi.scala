package CASE_MONITOR_2_TEST.VPM
...
abstract class CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_TestApi extends BridgeTestSuite[CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge](Arch.CASE_MONITOR_TEST_impl_1_Instance_CASE_Monitor_CASE_Monitor) {
  ...
  /** helper function to check CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor's
