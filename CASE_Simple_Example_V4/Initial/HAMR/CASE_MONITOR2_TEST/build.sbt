...
//     Right click src/main/architecture/CASE_MONITOR2_TEST/Demo.scala and choose "Run 'Demo'"
//
...
lazy val CASE_MONITOR2_TEST_impl_Instance = slangEmbeddedProject("CASE_MONITOR2_TEST_impl_Instance", ".")
...
val slangEmbeddedSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("CASE_MONITOR2_TEST.Demo"),

  mainClass in assembly := Some("CASE_MONITOR2_TEST.Demo"),
  assemblyJarName in assembly := "CASE_MONITOR2_TEST_impl_Instance.jar",
...
val slangEmbeddedInspectorSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("CASE_MONITOR2_TEST.InspectorDemo"),
)
