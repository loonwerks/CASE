...
//   $SIREUM_HOME/bin/mill CASE_MONITOR2_TEST.run
//
// To run the example unit tests:
//   $SIREUM_HOME/bin/mill CASE_MONITOR2_TEST.tests
//
// Sireum IVE:
//   First cd to the directory containing this file and execute the following:
//
//     $SIREUM_HOME/bin/sireum tools ivegen -f -m mill -n CASE_MONITOR2_TEST ../
//
...
//
//     $SIREUM_HOME/bin/mill -w CASE_MONITOR2_TEST.tests.compile
//
// Visual Studio Code:
...
object `CASE_MONITOR2_TEST` extends slangEmbeddedProject
...
trait SlangEmbeddedModule extends ScalaModule {
  ...
  override def mainClass = T { Some("CASE_MONITOR2_TEST.Demo") }
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("CASE_MONITOR2_TEST.InspectorDemo") }
