...
typedef enum {
  ...
  TCASE_MONITOR2_TEST_VPM_CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge = 0x2E07ED93, // CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge
  TCASE_MONITOR2_TEST_VPM_CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge_EntryPoints = 0x428DC763, // CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge.EntryPoints
  TCASE_MONITOR2_TEST_VPM_CASE_Monitor2_Impl_Initialization_Api = 0x72D305CD, // CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_Initialization_Api
  TCASE_MONITOR2_TEST_VPM_CASE_Monitor2_Impl_Operational_Api = 0x93275384, // CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_Operational_Api
  ...
  TNone_EC3D0D = 0xEC3D0DAD, // None[CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_Initialization_Api]
  TNone_3D0813 = 0x3D08134F, // None[CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_Operational_Api]
  ...
  TSome_2D0976 = 0x2D097615, // Some[CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_Initialization_Api]
  TSome_C4344F = 0xC4344FB1, // Some[CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_Operational_Api]
