...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR2_TEST_VPM_CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge: return sizeof(struct CASE_MONITOR2_TEST_VPM_CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge); // CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge
    case TCASE_MONITOR2_TEST_VPM_CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge_EntryPoints: return sizeof(struct CASE_MONITOR2_TEST_VPM_CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge_EntryPoints); // CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge.EntryPoints
    case TCASE_MONITOR2_TEST_VPM_CASE_Monitor2_Impl_Initialization_Api: return sizeof(struct CASE_MONITOR2_TEST_VPM_CASE_Monitor2_Impl_Initialization_Api); // CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_Initialization_Api
    case TCASE_MONITOR2_TEST_VPM_CASE_Monitor2_Impl_Operational_Api: return sizeof(struct CASE_MONITOR2_TEST_VPM_CASE_Monitor2_Impl_Operational_Api); // CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_Operational_Api
    ...
    case TNone_EC3D0D: return sizeof(struct None_EC3D0D); // None[CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_Initialization_Api]
    case TNone_3D0813: return sizeof(struct None_3D0813); // None[CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_Operational_Api]
    ...
    case TSome_2D0976: return sizeof(struct Some_2D0976); // Some[CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_Initialization_Api]
    case TSome_C4344F: return sizeof(struct Some_C4344F); // Some[CASE_MONITOR2_TEST.VPM.CASE_Monitor2_Impl_Operational_Api]
