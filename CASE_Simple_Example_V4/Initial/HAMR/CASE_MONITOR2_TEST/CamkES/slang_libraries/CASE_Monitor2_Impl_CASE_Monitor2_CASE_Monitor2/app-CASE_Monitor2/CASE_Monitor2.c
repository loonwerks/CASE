...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "CASE_Monitor2.scala", "CASE_MONITOR2_TEST.CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2.CASE_Monitor2", "<App>", 0);
  ...
  return (int) CASE_MONITOR2_TEST_CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_CASE_Monitor2_main(SF &t_args);
}