...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR2_TEST_VPM_TEST_Input_impl_Initialization_Api: return sizeof(struct CASE_MONITOR2_TEST_VPM_TEST_Input_impl_Initialization_Api); // CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Initialization_Api
    case TCASE_MONITOR2_TEST_VPM_TEST_Input_impl_Input_Input_Bridge: return sizeof(struct CASE_MONITOR2_TEST_VPM_TEST_Input_impl_Input_Input_Bridge); // CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Input_Input_Bridge
    case TCASE_MONITOR2_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints: return sizeof(struct CASE_MONITOR2_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints); // CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Input_Input_Bridge.EntryPoints
    case TCASE_MONITOR2_TEST_VPM_TEST_Input_impl_Operational_Api: return sizeof(struct CASE_MONITOR2_TEST_VPM_TEST_Input_impl_Operational_Api); // CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Operational_Api
    ...
    case TNone_9A887C: return sizeof(struct None_9A887C); // None[CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Initialization_Api]
    case TNone_B2E40A: return sizeof(struct None_B2E40A); // None[CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Operational_Api]
    ...
    case TSome_CBF40F: return sizeof(struct Some_CBF40F); // Some[CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Initialization_Api]
    case TSome_EA751B: return sizeof(struct Some_EA751B); // Some[CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Operational_Api]
