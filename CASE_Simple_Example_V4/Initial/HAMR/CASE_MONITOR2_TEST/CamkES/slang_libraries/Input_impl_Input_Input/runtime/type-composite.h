...
typedef enum {
  ...
  TCASE_MONITOR2_TEST_VPM_TEST_Input_impl_Initialization_Api = 0x053A7B44, // CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Initialization_Api
  TCASE_MONITOR2_TEST_VPM_TEST_Input_impl_Input_Input_Bridge = 0x52F3B665, // CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Input_Input_Bridge
  TCASE_MONITOR2_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints = 0x50808354, // CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Input_Input_Bridge.EntryPoints
  TCASE_MONITOR2_TEST_VPM_TEST_Input_impl_Operational_Api = 0x6F8255A7, // CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Operational_Api
  ...
  TNone_9A887C = 0x9A887C3C, // None[CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Initialization_Api]
  TNone_B2E40A = 0xB2E40A53, // None[CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Operational_Api]
  ...
  TSome_CBF40F = 0xCBF40FC9, // Some[CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Initialization_Api]
  TSome_EA751B = 0xEA751B91, // Some[CASE_MONITOR2_TEST.VPM_TEST.Input_impl_Operational_Api]
