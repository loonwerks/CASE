...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "Input.scala", "CASE_MONITOR2_TEST.Input_impl_Input_Input.Input", "<App>", 0);
  ...
  return (int) CASE_MONITOR2_TEST_Input_impl_Input_Input_Input_main(SF &t_args);
}