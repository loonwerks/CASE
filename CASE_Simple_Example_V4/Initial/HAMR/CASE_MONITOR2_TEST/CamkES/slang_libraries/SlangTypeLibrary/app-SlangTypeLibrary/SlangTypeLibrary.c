...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "SlangTypeLibrary.scala", "CASE_MONITOR2_TEST.SlangTypeLibrary.SlangTypeLibrary", "<App>", 0);
  ...
  return (int) CASE_MONITOR2_TEST_SlangTypeLibrary_SlangTypeLibrary_main(SF &t_args);
}