...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "Output.scala", "CASE_MONITOR2_TEST.Output_impl_Output_Output.Output", "<App>", 0);
  ...
  return (int) CASE_MONITOR2_TEST_Output_impl_Output_Output_Output_main(SF &t_args);
}