...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR2_TEST_VPM_TEST_Output_impl_Initialization_Api: return CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Initialization_Api__eq((CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Initialization_Api) t1, (CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Initialization_Api) t2);
    case TCASE_MONITOR2_TEST_VPM_TEST_Output_impl_Operational_Api: return CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Operational_Api__eq((CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Operational_Api) t1, (CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Operational_Api) t2);
    case TCASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge: return CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge__eq((CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge) t1, (CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge) t2);
    case TCASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints: return CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints__eq((CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints) t1, (CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints) t2);
    ...
    case TNone_3790E6: return None_3790E6__eq((None_3790E6) t1, (None_3790E6) t2);
    case TNone_A19CD9: return None_A19CD9__eq((None_A19CD9) t1, (None_A19CD9) t2);
    ...
    case TSome_2C70A4: return Some_2C70A4__eq((Some_2C70A4) t1, (Some_2C70A4) t2);
    case TSome_9A9753: return Some_9A9753__eq((Some_9A9753) t1, (Some_9A9753) t2);
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR2_TEST_VPM_TEST_Output_impl_Initialization_Api: CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Initialization_Api_cprint((CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Initialization_Api) this, isOut); return;
    case TCASE_MONITOR2_TEST_VPM_TEST_Output_impl_Operational_Api: CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Operational_Api_cprint((CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Operational_Api) this, isOut); return;
    case TCASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge: CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_cprint((CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge) this, isOut); return;
    case TCASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints: CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints_cprint((CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints) this, isOut); return;
    ...
    case TNone_3790E6: None_3790E6_cprint((None_3790E6) this, isOut); return;
    case TNone_A19CD9: None_A19CD9_cprint((None_A19CD9) this, isOut); return;
    ...
    case TSome_2C70A4: Some_2C70A4_cprint((Some_2C70A4) this, isOut); return;
    case TSome_9A9753: Some_9A9753_cprint((Some_9A9753) this, isOut); return;
...
void Type_string_(STACK_FRAME String result, void *this) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR2_TEST_VPM_TEST_Output_impl_Initialization_Api: CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Initialization_Api_string_(CALLER result, (CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Initialization_Api) this); return;
    case TCASE_MONITOR2_TEST_VPM_TEST_Output_impl_Operational_Api: CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Operational_Api_string_(CALLER result, (CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Operational_Api) this); return;
    case TCASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge: CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_string_(CALLER result, (CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge) this); return;
    case TCASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints: CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints_string_(CALLER result, (CASE_MONITOR2_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints) this); return;
    ...
    case TNone_3790E6: None_3790E6_string_(CALLER result, (None_3790E6) this); return;
    case TNone_A19CD9: None_A19CD9_string_(CALLER result, (None_A19CD9) this); return;
    ...
    case TSome_2C70A4: Some_2C70A4_string_(CALLER result, (Some_2C70A4) this); return;
    case TSome_9A9753: Some_9A9753_string_(CALLER result, (Some_9A9753) this); return;
