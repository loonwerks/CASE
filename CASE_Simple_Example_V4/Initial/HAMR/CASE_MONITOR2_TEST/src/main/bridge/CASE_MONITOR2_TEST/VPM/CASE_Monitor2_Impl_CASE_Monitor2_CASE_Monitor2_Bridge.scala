...
import CASE_MONITOR2_TEST.VPM.{CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2 => component}

// This file was auto-generated.  Do not edit

@datatype class CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : CASE_Monitor2_Impl_Initialization_Api = {
    ...
    CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : CASE_Monitor2_Impl_Operational_Api = {
    ...
    CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge.EntryPoints(
      id,
...
object CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_Bridge {
  ...
  @datatype class EntryPoints(
    CASE_Monitor2_Impl_CASE_Monitor2_CASE_Monitor2_BridgeId : Art.BridgeId,
