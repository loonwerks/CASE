...
abstract class Output_impl_Output_Output_TestApi extends BridgeTestSuite[Output_impl_Output_Output_Bridge](Arch.CASE_MONITOR2_TEST_impl_Instance_Output_Output) {
