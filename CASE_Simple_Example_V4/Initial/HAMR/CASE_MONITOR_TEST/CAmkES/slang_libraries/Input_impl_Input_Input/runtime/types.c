...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Initialization_Api: return sizeof(struct CASE_MONITOR_TEST_VPM_TEST_Input_impl_Initialization_Api); // CASE_MONITOR_TEST.VPM_TEST.Input_impl_Initialization_Api
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge: return sizeof(struct CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge); // CASE_MONITOR_TEST.VPM_TEST.Input_impl_Input_Input_Bridge
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints: return sizeof(struct CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints); // CASE_MONITOR_TEST.VPM_TEST.Input_impl_Input_Input_Bridge.EntryPoints
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Operational_Api: return sizeof(struct CASE_MONITOR_TEST_VPM_TEST_Input_impl_Operational_Api); // CASE_MONITOR_TEST.VPM_TEST.Input_impl_Operational_Api
    ...
    case TNone_04B2B5: return sizeof(struct None_04B2B5); // None[CASE_MONITOR_TEST.VPM_TEST.Input_impl_Initialization_Api]
    case TNone_12F982: return sizeof(struct None_12F982); // None[CASE_MONITOR_TEST.VPM_TEST.Input_impl_Operational_Api]
    ...
    case TSome_ED6B7D: return sizeof(struct Some_ED6B7D); // Some[CASE_MONITOR_TEST.VPM_TEST.Input_impl_Initialization_Api]
    case TSome_BA86B7: return sizeof(struct Some_BA86B7); // Some[CASE_MONITOR_TEST.VPM_TEST.Input_impl_Operational_Api]
