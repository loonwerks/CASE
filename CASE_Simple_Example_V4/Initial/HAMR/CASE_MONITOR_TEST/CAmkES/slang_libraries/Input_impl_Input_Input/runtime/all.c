...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Initialization_Api: return CASE_MONITOR_TEST_VPM_TEST_Input_impl_Initialization_Api__eq((CASE_MONITOR_TEST_VPM_TEST_Input_impl_Initialization_Api) t1, (CASE_MONITOR_TEST_VPM_TEST_Input_impl_Initialization_Api) t2);
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge: return CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge__eq((CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge) t1, (CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge) t2);
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints: return CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints__eq((CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints) t1, (CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints) t2);
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Operational_Api: return CASE_MONITOR_TEST_VPM_TEST_Input_impl_Operational_Api__eq((CASE_MONITOR_TEST_VPM_TEST_Input_impl_Operational_Api) t1, (CASE_MONITOR_TEST_VPM_TEST_Input_impl_Operational_Api) t2);
    ...
    case TNone_04B2B5: return None_04B2B5__eq((None_04B2B5) t1, (None_04B2B5) t2);
    case TNone_12F982: return None_12F982__eq((None_12F982) t1, (None_12F982) t2);
    ...
    case TSome_ED6B7D: return Some_ED6B7D__eq((Some_ED6B7D) t1, (Some_ED6B7D) t2);
    case TSome_BA86B7: return Some_BA86B7__eq((Some_BA86B7) t1, (Some_BA86B7) t2);
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Initialization_Api: CASE_MONITOR_TEST_VPM_TEST_Input_impl_Initialization_Api_cprint((CASE_MONITOR_TEST_VPM_TEST_Input_impl_Initialization_Api) this, isOut); return;
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge: CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_cprint((CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge) this, isOut); return;
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints: CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints_cprint((CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints) this, isOut); return;
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Operational_Api: CASE_MONITOR_TEST_VPM_TEST_Input_impl_Operational_Api_cprint((CASE_MONITOR_TEST_VPM_TEST_Input_impl_Operational_Api) this, isOut); return;
    ...
    case TNone_04B2B5: None_04B2B5_cprint((None_04B2B5) this, isOut); return;
    case TNone_12F982: None_12F982_cprint((None_12F982) this, isOut); return;
    ...
    case TSome_ED6B7D: Some_ED6B7D_cprint((Some_ED6B7D) this, isOut); return;
    case TSome_BA86B7: Some_BA86B7_cprint((Some_BA86B7) this, isOut); return;
...
void Type_string_(STACK_FRAME String result, void *this) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Initialization_Api: CASE_MONITOR_TEST_VPM_TEST_Input_impl_Initialization_Api_string_(CALLER result, (CASE_MONITOR_TEST_VPM_TEST_Input_impl_Initialization_Api) this); return;
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge: CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_string_(CALLER result, (CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge) this); return;
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints: CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints_string_(CALLER result, (CASE_MONITOR_TEST_VPM_TEST_Input_impl_Input_Input_Bridge_EntryPoints) this); return;
    case TCASE_MONITOR_TEST_VPM_TEST_Input_impl_Operational_Api: CASE_MONITOR_TEST_VPM_TEST_Input_impl_Operational_Api_string_(CALLER result, (CASE_MONITOR_TEST_VPM_TEST_Input_impl_Operational_Api) this); return;
    ...
    case TNone_04B2B5: None_04B2B5_string_(CALLER result, (None_04B2B5) this); return;
    case TNone_12F982: None_12F982_string_(CALLER result, (None_12F982) this); return;
    ...
    case TSome_ED6B7D: Some_ED6B7D_string_(CALLER result, (Some_ED6B7D) this); return;
    case TSome_BA86B7: Some_BA86B7_string_(CALLER result, (Some_BA86B7) this); return;
