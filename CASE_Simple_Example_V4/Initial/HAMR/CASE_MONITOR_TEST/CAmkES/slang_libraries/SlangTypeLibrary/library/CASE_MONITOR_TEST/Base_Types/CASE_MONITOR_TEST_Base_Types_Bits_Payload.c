...
B CASE_MONITOR_TEST_Base_Types_Bits_Payload__ne(CASE_MONITOR_TEST_Base_Types_Bits_Payload this, CASE_MONITOR_TEST_Base_Types_Bits_Payload other);
...
void CASE_MONITOR_TEST_Base_Types_Bits_Payload_string_(STACK_FRAME String result, CASE_MONITOR_TEST_Base_Types_Bits_Payload this) {
  DeclNewStackFrame(caller, "Base_Types.scala", "CASE_MONITOR_TEST.Base_Types.Bits_Payload", "string", 0);
...
B CASE_MONITOR_TEST_Base_Types_Bits_Payload__is(STACK_FRAME void* this);
CASE_MONITOR_TEST_Base_Types_Bits_Payload CASE_MONITOR_TEST_Base_Types_Bits_Payload__as(STACK_FRAME void *this);
...
void CASE_MONITOR_TEST_Base_Types_Bits_Payload_apply(STACK_FRAME CASE_MONITOR_TEST_Base_Types_Bits_Payload this, IS_C4F575 value) {
  DeclNewStackFrame(caller, "Base_Types.scala", "CASE_MONITOR_TEST.Base_Types.Bits_Payload", "apply", 0);
