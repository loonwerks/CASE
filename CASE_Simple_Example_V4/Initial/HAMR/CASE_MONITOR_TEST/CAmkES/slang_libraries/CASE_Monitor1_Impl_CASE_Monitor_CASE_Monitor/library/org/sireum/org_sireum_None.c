...
void None_1E51A3_get_(STACK_FRAME CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api result, None_1E51A3 this) {
...
void None_C84E72_get_(STACK_FRAME CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api result, None_C84E72 this) {
  DeclNewStackFrame(caller, "Option.scala", "org.sireum.None", "get", 0);
