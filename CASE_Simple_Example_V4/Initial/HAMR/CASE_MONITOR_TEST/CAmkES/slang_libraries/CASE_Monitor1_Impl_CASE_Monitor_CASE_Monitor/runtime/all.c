...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge: return CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge__eq((CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge) t1, (CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge) t2);
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints: return CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints__eq((CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints) t1, (CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints) t2);
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api: return CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api__eq((CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api) t1, (CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api) t2);
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api: return CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api__eq((CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api) t1, (CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api) t2);
    ...
    case TNone_1E51A3: return None_1E51A3__eq((None_1E51A3) t1, (None_1E51A3) t2);
    case TNone_C84E72: return None_C84E72__eq((None_C84E72) t1, (None_C84E72) t2);
    ...
    case TSome_A6A622: return Some_A6A622__eq((Some_A6A622) t1, (Some_A6A622) t2);
    case TSome_638F73: return Some_638F73__eq((Some_638F73) t1, (Some_638F73) t2);
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge: CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_cprint((CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge) this, isOut); return;
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints: CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints_cprint((CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints) this, isOut); return;
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api: CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api_cprint((CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api) this, isOut); return;
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api: CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api_cprint((CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api) this, isOut); return;
    ...
    case TNone_1E51A3: None_1E51A3_cprint((None_1E51A3) this, isOut); return;
    case TNone_C84E72: None_C84E72_cprint((None_C84E72) this, isOut); return;
    ...
    case TSome_A6A622: Some_A6A622_cprint((Some_A6A622) this, isOut); return;
    case TSome_638F73: Some_638F73_cprint((Some_638F73) this, isOut); return;
...
void Type_string_(STACK_FRAME String result, void *this) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge: CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_string_(CALLER result, (CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge) this); return;
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints: CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints_string_(CALLER result, (CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints) this); return;
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api: CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api_string_(CALLER result, (CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api) this); return;
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api: CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api_string_(CALLER result, (CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api) this); return;
    ...
    case TNone_1E51A3: None_1E51A3_string_(CALLER result, (None_1E51A3) this); return;
    case TNone_C84E72: None_C84E72_string_(CALLER result, (None_C84E72) this); return;
    ...
    case TSome_A6A622: Some_A6A622_string_(CALLER result, (Some_A6A622) this); return;
    case TSome_638F73: Some_638F73_string_(CALLER result, (Some_638F73) this); return;
