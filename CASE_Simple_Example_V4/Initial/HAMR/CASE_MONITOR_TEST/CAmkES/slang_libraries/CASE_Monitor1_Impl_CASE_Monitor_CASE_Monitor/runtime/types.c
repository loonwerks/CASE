...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge: return sizeof(struct CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge); // CASE_MONITOR_TEST.VPM.CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints: return sizeof(struct CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge_EntryPoints); // CASE_MONITOR_TEST.VPM.CASE_Monitor1_Impl_CASE_Monitor_CASE_Monitor_Bridge.EntryPoints
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api: return sizeof(struct CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Initialization_Api); // CASE_MONITOR_TEST.VPM.CASE_Monitor1_Impl_Initialization_Api
    case TCASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api: return sizeof(struct CASE_MONITOR_TEST_VPM_CASE_Monitor1_Impl_Operational_Api); // CASE_MONITOR_TEST.VPM.CASE_Monitor1_Impl_Operational_Api
    ...
    case TNone_1E51A3: return sizeof(struct None_1E51A3); // None[CASE_MONITOR_TEST.VPM.CASE_Monitor1_Impl_Initialization_Api]
    case TNone_C84E72: return sizeof(struct None_C84E72); // None[CASE_MONITOR_TEST.VPM.CASE_Monitor1_Impl_Operational_Api]
    ...
    case TSome_A6A622: return sizeof(struct Some_A6A622); // Some[CASE_MONITOR_TEST.VPM.CASE_Monitor1_Impl_Initialization_Api]
    case TSome_638F73: return sizeof(struct Some_638F73); // Some[CASE_MONITOR_TEST.VPM.CASE_Monitor1_Impl_Operational_Api]
