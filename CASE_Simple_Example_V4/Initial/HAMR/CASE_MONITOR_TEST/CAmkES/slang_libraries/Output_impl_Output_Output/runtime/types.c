...
size_t sizeOf(Type t) {
  TYPE type = t->type;
  switch (type) {
    case TCASE_MONITOR_TEST_Base_Types_Bits_Payload: return sizeof(struct CASE_MONITOR_TEST_Base_Types_Bits_Payload); // CASE_MONITOR_TEST.Base_Types.Bits_Payload
    case TCASE_MONITOR_TEST_VPM_TEST_Output_impl_Initialization_Api: return sizeof(struct CASE_MONITOR_TEST_VPM_TEST_Output_impl_Initialization_Api); // CASE_MONITOR_TEST.VPM_TEST.Output_impl_Initialization_Api
    case TCASE_MONITOR_TEST_VPM_TEST_Output_impl_Operational_Api: return sizeof(struct CASE_MONITOR_TEST_VPM_TEST_Output_impl_Operational_Api); // CASE_MONITOR_TEST.VPM_TEST.Output_impl_Operational_Api
    case TCASE_MONITOR_TEST_VPM_TEST_Output_impl_Output_Output_Bridge: return sizeof(struct CASE_MONITOR_TEST_VPM_TEST_Output_impl_Output_Output_Bridge); // CASE_MONITOR_TEST.VPM_TEST.Output_impl_Output_Output_Bridge
    case TCASE_MONITOR_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints: return sizeof(struct CASE_MONITOR_TEST_VPM_TEST_Output_impl_Output_Output_Bridge_EntryPoints); // CASE_MONITOR_TEST.VPM_TEST.Output_impl_Output_Output_Bridge.EntryPoints
    ...
    case TNone_1328AE: return sizeof(struct None_1328AE); // None[CASE_MONITOR_TEST.VPM_TEST.Output_impl_Initialization_Api]
    case TNone_863C2F: return sizeof(struct None_863C2F); // None[CASE_MONITOR_TEST.VPM_TEST.Output_impl_Operational_Api]
    ...
    case TSome_DBA49C: return sizeof(struct Some_DBA49C); // Some[CASE_MONITOR_TEST.VPM_TEST.Output_impl_Initialization_Api]
    case TSome_A84D2F: return sizeof(struct Some_A84D2F); // Some[CASE_MONITOR_TEST.VPM_TEST.Output_impl_Operational_Api]
