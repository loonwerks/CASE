...
//     Right click src/main/architecture/CASE_MONITOR_TEST/Demo.scala and choose "Run 'Demo'"
//
...
lazy val CASE_MONITOR_TEST_impl_Instance = slangEmbeddedProject("CASE_MONITOR_TEST_impl_Instance", ".")
...
val slangEmbeddedSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("CASE_MONITOR_TEST.Demo"),

  mainClass in assembly := Some("CASE_MONITOR_TEST.Demo"),
  assemblyJarName in assembly := "CASE_MONITOR_TEST_impl_Instance.jar",
...
val slangEmbeddedInspectorSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("CASE_MONITOR_TEST.InspectorDemo"),
)
