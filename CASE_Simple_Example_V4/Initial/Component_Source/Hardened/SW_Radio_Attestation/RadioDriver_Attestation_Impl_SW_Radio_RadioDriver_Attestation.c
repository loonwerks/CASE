 ...
 *
  ...
  api_put_AttestationTesterRequest__HAMR_Simple_V4_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation(SF numBits_HAMR_Data_Types_AttestationRequestMsg_Impl, t0);
  ...
  api_put_MissionCommand__HAMR_Simple_V4_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation(SF numBits_HAMR_Data_Types_RF_Msg_Impl, t1);
  ...
  api_put_AttestationResponse__HAMR_Simple_V4_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation(SF numBits_HAMR_Data_Types_AttestationResponseMsg_Impl, t2);
...
Unit HAMR_Simple_V4_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation_timeTriggered_(STACK_FRAME_ONLY) {
  ...
  if (output != NULL) {
    ...
    printf("\n");
    api_put_MissionCommand__HAMR_Simple_V4_SW_RadioDriver_Attestation_Impl_SW_Radio_RadioDriver_Attestation(SF numBits_HAMR_Data_Types_RF_Msg_Impl, output);
  }
