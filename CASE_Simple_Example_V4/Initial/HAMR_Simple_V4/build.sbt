...
//     Right click src/main/architecture/HAMR_Simple_V4/Demo.scala and choose "Run 'Demo'"
//
...
val slangEmbeddedSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("HAMR_Simple_V4.Demo"),

  mainClass in assembly := Some("HAMR_Simple_V4.Demo"),
...
val slangEmbeddedInspectorSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("HAMR_Simple_V4.InspectorDemo"),
)
