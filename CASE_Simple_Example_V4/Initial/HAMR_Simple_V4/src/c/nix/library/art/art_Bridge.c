...
B art_Bridge__is(STACK_FRAME void *this) {
  switch(((Type) this)->type) {
    ...
    case THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge: return T;
...
art_Bridge art_Bridge__as(STACK_FRAME void *this) {
  switch(((Type) this)->type) {
    ...
    case THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge: break;
...
Z art_Bridge_id_(STACK_FRAME art_Bridge this) {
  switch (this->type) {
    ...
    case THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge: return HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge_id_((HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge) this);
...
void art_Bridge_dispatchProtocol_(STACK_FRAME art_DispatchPropertyProtocol result, art_Bridge this) {
  switch (this->type) {
    ...
    case THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge: Type_assign(result, HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge_dispatchProtocol_((HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge) this), sizeof(union art_DispatchPropertyProtocol)); return;
...
void art_Bridge_name_(STACK_FRAME String result, art_Bridge this) {
  switch (this->type) {
    ...
    case THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge: Type_assign(result, HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge_name_((HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge) this), sizeof(struct StaticString)); return;
...
void art_Bridge_ports_(STACK_FRAME art_Bridge_Ports result, art_Bridge this) {
  switch (this->type) {
    ...
    case THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge: Type_assign(result, HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge_ports_((HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge) this), sizeof(struct art_Bridge_Ports)); return;
