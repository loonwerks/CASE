#ifndef SIREUM_TYPE_H_HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge
#define SIREUM_TYPE_H_HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge
...
typedef struct HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge *HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge;
struct HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge {
  TYPE type;
...
#define DeclNewHAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge(x) struct HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge x = { .type = THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge }
