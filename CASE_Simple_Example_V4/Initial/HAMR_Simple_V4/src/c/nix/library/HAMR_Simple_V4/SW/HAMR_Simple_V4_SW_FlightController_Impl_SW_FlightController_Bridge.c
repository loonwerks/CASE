...
void HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_apply(STACK_FRAME HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge this, Z id, String name, art_DispatchPropertyProtocol dispatchProtocol, Option_9AF35E dispatchTriggers, art_Port_45E54D FlightPlan, art_Port_9CBF18 Alert) {
  ...
  Type_assign(&this->Alert, Alert, sizeof(struct art_Port_9CBF18));
  {
    ...
    IS_820232_up(&t_1, 1, (art_UPort) HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_Alert_(this));
    ...
    IS_820232_up(&t_4, 1, (art_UPort) HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_Alert_(this));
    STATIC_ASSERT(0 <= MaxIS_820232, "Insufficient maximum for IS[Z, art.UPort] elements.");
  ...
  }
  {
    sfUpdateLoc(36);
    {
      ...
      HAMR_Simple_V4_SW_FlightController_Impl_Initialization_Api_apply(SF &t_6, HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_id_(this), art_Port_45E54D_id_(HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_FlightPlan_(this)), art_Port_9CBF18_id_(HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_Alert_(this)));
  ...
  }
  {
    sfUpdateLoc(46);
    {
      ...
      HAMR_Simple_V4_SW_FlightController_Impl_Operational_Api_apply(SF &t_8, HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_id_(this), art_Port_45E54D_id_(HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_FlightPlan_(this)), art_Port_9CBF18_id_(HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_Alert_(this)));
  ...
  }
  {
    ...
    HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints_apply(SF &t_10, HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_id_(this), art_Port_45E54D_id_(HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_FlightPlan_(this)), art_Port_9CBF18_id_(HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_Alert_(this)), (Option_9AF35E) HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_dispatchTriggers_(this), (HAMR_Simple_V4_SW_FlightController_Impl_Initialization_Api) HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_initialization_api_(this), (HAMR_Simple_V4_SW_FlightController_Impl_Operational_Api) HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_operational_api_(this));
