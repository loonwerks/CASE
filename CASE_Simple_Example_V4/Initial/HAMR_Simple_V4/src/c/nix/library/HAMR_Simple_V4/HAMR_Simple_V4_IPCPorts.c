...
Z _HAMR_Simple_V4_IPCPorts_AttestationTester_Impl_SW_AttestationTester_App;
...
void HAMR_Simple_V4_IPCPorts_init(STACK_FRAME_ONLY) {
  ...
  HAMR_Simple_V4_IPCPorts_init_AttestationTester_Impl_SW_AttestationTester_App(SF_LAST);
...
Z HAMR_Simple_V4_IPCPorts_AttestationTester_Impl_SW_AttestationTester_App(STACK_FRAME_ONLY) {
  ...
  return _HAMR_Simple_V4_IPCPorts_AttestationTester_Impl_SW_AttestationTester_App;
}
...
void HAMR_Simple_V4_IPCPorts_init_AttestationTester_Impl_SW_AttestationTester_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(11);
  _HAMR_Simple_V4_IPCPorts_AttestationTester_Impl_SW_AttestationTester_App = Z_C(9);
};
...
void HAMR_Simple_V4_IPCPorts_init_RadioDriver_Impl_SW_Radio_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(12);
  _HAMR_Simple_V4_IPCPorts_RadioDriver_Impl_SW_Radio_App = Z_C(10);
};
...
void HAMR_Simple_V4_IPCPorts_init_FlightPlanner_Impl_SW_FlightPlanner_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(13);
  _HAMR_Simple_V4_IPCPorts_FlightPlanner_Impl_SW_FlightPlanner_App = Z_C(11);
};
...
void HAMR_Simple_V4_IPCPorts_init_FlightController_Impl_SW_FlightController_App(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(14);
  _HAMR_Simple_V4_IPCPorts_FlightController_Impl_SW_FlightController_App = Z_C(12);
};
...
void HAMR_Simple_V4_IPCPorts_init_Main(STACK_FRAME_ONLY) {
  ...
  #endif
  sfUpdateLoc(15);
  _HAMR_Simple_V4_IPCPorts_Main = Z_C(13);
};