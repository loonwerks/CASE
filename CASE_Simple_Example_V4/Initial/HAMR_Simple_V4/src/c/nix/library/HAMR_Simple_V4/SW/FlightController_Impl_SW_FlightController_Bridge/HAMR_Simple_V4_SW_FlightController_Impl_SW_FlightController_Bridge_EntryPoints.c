...
void HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints_apply(STACK_FRAME HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints this, Z FlightController_Impl_SW_FlightController_BridgeId, Z FlightPlan_Id, Z Alert_Id, Option_9AF35E dispatchTriggers, HAMR_Simple_V4_SW_FlightController_Impl_Initialization_Api initialization_api, HAMR_Simple_V4_SW_FlightController_Impl_Operational_Api operational_api) {
  ...
  }
  {
    ...
    IS_82ABD8_up(&t_1, 1, (Z) HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints_Alert_Id_(this));
...
static inline B HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints_compute_extract_108_11(STACK_FRAME_SF art_DispatchStatus t_0, HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints this, IS_82ABD8 *_receivedEvents) {
...
static inline B HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints_compute_extract_119_15_8E9F45(STACK_FRAME_SF Option_8E9F45 t_7, HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints this, IS_C4F575 *_value) {
...
Unit HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints_compute_(STACK_FRAME HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints this) {
  ...
  sfAssert(HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints_compute_extract_108_11(SF t_0, this, &receivedEvents), "Error during var pattern matching.");
  ...
  sfUpdateLoc(117);
  {
    IS_82ABD8 t_10 = dispatchableEventPorts;
    int8_t t_11 = (dispatchableEventPorts)->size;
    for (int8_t t_12 = 0; t_12 < t_11; t_12++) {
      Z portId = t_10->value[t_12];
      ...
      if (t_6) {
        ...
        IS_C4F575 value;
        sfAssert(HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints_compute_extract_119_15_8E9F45(SF t_7, this, &value), "Error during var pattern matching.");
        ...
        B t_9;
        {
          t_9 = Z__eq(portId, HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints_Alert_Id_(this));
        }
        if (t_9) {

          sfUpdateLoc(126);
          {
            HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_handle_Alert(SF (HAMR_Simple_V4_SW_FlightController_Impl_Operational_Api) HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_Bridge_EntryPoints_operational_api_(this));
          }
        }
      }
    }
