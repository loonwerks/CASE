...
Z _HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_AttestationTesterResponsePortId;
union Option_882048 _HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_AttestationTesterResponsePortIdOpt;
...
void HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_init(STACK_FRAME_ONLY) {
  ...
  HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_init_AttestationTesterResponsePortId(SF_LAST);
  HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_init_AttestationTesterResponsePortIdOpt(SF_LAST);
}
...
Z HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_AttestationTesterResponsePortId(STACK_FRAME_ONLY) {
  HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_init(CALLER_LAST);
  return _HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_AttestationTesterResponsePortId;
}

Option_882048 HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_AttestationTesterResponsePortIdOpt(STACK_FRAME_ONLY) {
  HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_init(CALLER_LAST);
  return (Option_882048) &_HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_AttestationTesterResponsePortIdOpt;
}
...
Unit HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_initialiseArchitecture(STACK_FRAME Z seed) {
  ...
  sfUpdateLoc(20);
  {
    HAMR_Simple_V4_PlatformNix_initialise(SF seed, (Option_882048) HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_AttestationTesterResponsePortIdOpt(SF_LAST));
  }
...
static inline B HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_compute_extract_36_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_1, HAMR_Simple_V4_Base_Types_Bits_Payload *_v_36_19) {
...
static inline B HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_compute_extract_37_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_1, art_DataContent *_v_37_19) {
  if (!Some_D29615__is(SF t_1)) return F;
  *_v_37_19 = (art_DataContent) Some_D29615_value_(Some_D29615__as(SF t_1));
  return T;
}

static inline B HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_compute_extract_38_14_8E9F45(STACK_FRAME_SF Option_8E9F45 t_1) {
...
Unit HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_compute(STACK_FRAME_ONLY) {
  ...
  }
  {
    ...
    sfUpdateLoc(34);
    {
      HAMR_Simple_V4_PlatformNix_receiveAsync(SF (Option_882048) HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_AttestationTesterResponsePortIdOpt(SF_LAST), (MBox2_1029D1) out);
    }
    ...
    if (!match_35_11) {
      ...
      match_35_11 = HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_compute_extract_36_14_8E9F45(SF t_1, &v_36_19);
      if (match_35_11) {

        sfUpdateLoc(36);
        {
          HAMR_Simple_V4_ArtNix_updateData(SF HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_AttestationTesterResponsePortId(SF_LAST), (art_DataContent) v_36_19);
        }
    ...
    if (!match_35_11) {
      ...
      match_35_11 = HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_compute_extract_37_14_8E9F45(SF t_1, &v_37_19);
      if (match_35_11) {
        ...
        sfUpdateLoc(37);
        {
          ...
          DeclNewString(t_4);
          String_string_(SF (String) &t_4, string("Unexpected payload on port AttestationTesterResponse.  Expecting something of type Base_Types.Bits_Payload but received "));
    ...
    if (!match_35_11) {
      match_35_11 = HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_compute_extract_38_14_8E9F45(SF t_1);
      if (match_35_11) {
      }
    }
...
Unit HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_touch(STACK_FRAME_ONLY) {
  ...
  if (t_0) {
    ...
    DeclNewHAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api(t_10);
    Option_994630_get_(SF (HAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api) &t_10, HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_c_operational_api(SF_LAST));
    DeclNewOption_30119F(t_11);
    HAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api_get_AttestationTesterResponse_(SF (Option_30119F) &t_11, ((HAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api) &t_10));
    apiUsage_AttestationTesterResponse = (Option_30119F) ((Option_30119F) &t_11);

    sfUpdateLoc(108);
    {
      DeclNewHAMR_Simple_V4_SW_RadioDriver_Impl_Initialization_Api(t_12);
      Option_7C94AD_get_(SF (HAMR_Simple_V4_SW_RadioDriver_Impl_Initialization_Api) &t_12, HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_c_initialization_api(SF_LAST));
      DeclNewIS_C4F575(t_13);
      HAMR_Simple_V4_Base_Types_Bits_example(SF (IS_C4F575) &t_13);
      HAMR_Simple_V4_SW_RadioDriver_Impl_Initialization_Api_put_AttestationTesterRequest_(SF ((HAMR_Simple_V4_SW_RadioDriver_Impl_Initialization_Api) &t_12), (IS_C4F575) ((IS_C4F575) &t_13));
    }

    sfUpdateLoc(109);
    {
      DeclNewHAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api(t_14);
      Option_994630_get_(SF (HAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api) &t_14, HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_c_operational_api(SF_LAST));
      DeclNewIS_C4F575(t_15);
      HAMR_Simple_V4_Base_Types_Bits_example(SF (IS_C4F575) &t_15);
      HAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api_put_AttestationTesterRequest_(SF ((HAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api) &t_14), (IS_C4F575) ((IS_C4F575) &t_15));
    }

    sfUpdateLoc(110);
    {
      DeclNewHAMR_Simple_V4_SW_RadioDriver_Impl_Initialization_Api(t_16);
      Option_7C94AD_get_(SF (HAMR_Simple_V4_SW_RadioDriver_Impl_Initialization_Api) &t_16, HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_c_initialization_api(SF_LAST));
      DeclNewIS_C4F575(t_17);
      HAMR_Simple_V4_Base_Types_Bits_example(SF (IS_C4F575) &t_17);
      HAMR_Simple_V4_SW_RadioDriver_Impl_Initialization_Api_put_MissionCommand_(SF ((HAMR_Simple_V4_SW_RadioDriver_Impl_Initialization_Api) &t_16), (IS_C4F575) ((IS_C4F575) &t_17));
    }

    sfUpdateLoc(111);
    {
      DeclNewHAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api(t_18);
      Option_994630_get_(SF (HAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api) &t_18, HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_c_operational_api(SF_LAST));
      DeclNewIS_C4F575(t_19);
      HAMR_Simple_V4_Base_Types_Bits_example(SF (IS_C4F575) &t_19);
      HAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api_put_MissionCommand_(SF ((HAMR_Simple_V4_SW_RadioDriver_Impl_Operational_Api) &t_18), (IS_C4F575) ((IS_C4F575) &t_19));
    }
  }
}
...
void HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_init_AttestationTesterResponsePortId(STACK_FRAME_ONLY) {
  #ifdef SIREUM_LOC
  StackFrame sf = caller;
  #endif
  sfUpdateLoc(15);
  _HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_AttestationTesterResponsePortId = art_Port_45E54D_id_(HAMR_Simple_V4_SW_RadioDriver_Impl_SW_Radio_Bridge_AttestationTesterResponse_(HAMR_Simple_V4_Arch_MissionComputer_Impl_Instance_SW_Radio(SF_LAST)));
};

void HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_init_AttestationTesterResponsePortIdOpt(STACK_FRAME_ONLY) {
  #ifdef SIREUM_LOC
  StackFrame sf = caller;
  #endif
  sfUpdateLoc(16);
  DeclNewSome_488F47(t_1);
  Some_488F47_apply(SF &t_1, HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_AttestationTesterResponsePortId(SF_LAST));
  Type_assign(&_HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_AttestationTesterResponsePortIdOpt, (&t_1), sizeof(struct Some_488F47));
};