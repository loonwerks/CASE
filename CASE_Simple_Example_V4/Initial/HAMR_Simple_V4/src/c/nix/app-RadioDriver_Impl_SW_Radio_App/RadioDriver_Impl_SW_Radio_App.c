...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "RadioDriver_Impl_SW_Radio_App.scala", "HAMR_Simple_V4.RadioDriver_Impl_SW_Radio_App", "<App>", 0);
  ...
  return (int) HAMR_Simple_V4_RadioDriver_Impl_SW_Radio_App_main(SF &t_args);
}