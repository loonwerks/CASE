...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "FlightPlanner_Impl_SW_FlightPlanner_App.scala", "HAMR_Simple_V4.FlightPlanner_Impl_SW_FlightPlanner_App", "<App>", 0);
  ...
  return (int) HAMR_Simple_V4_FlightPlanner_Impl_SW_FlightPlanner_App_main(SF &t_args);
}