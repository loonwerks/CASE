...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "AttestationTester_Impl_SW_AttestationTester_App.scala", "HAMR_Simple_V4.AttestationTester_Impl_SW_AttestationTester_App", "<App>", 0);
  ...
  return (int) HAMR_Simple_V4_AttestationTester_Impl_SW_AttestationTester_App_main(SF &t_args);
}