...
size_t sizeOf(Type t) {
  ...
  switch (type) {
    ...
    case THAMR_Simple_V4_SW_AttestationTester_Impl_Initialization_Api: return sizeof(struct HAMR_Simple_V4_SW_AttestationTester_Impl_Initialization_Api); // HAMR_Simple_V4.SW.AttestationTester_Impl_Initialization_Api
    case THAMR_Simple_V4_SW_AttestationTester_Impl_Operational_Api: return sizeof(struct HAMR_Simple_V4_SW_AttestationTester_Impl_Operational_Api); // HAMR_Simple_V4.SW.AttestationTester_Impl_Operational_Api
    case THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge: return sizeof(struct HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge); // HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_Bridge
    case THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge_EntryPoints: return sizeof(struct HAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge_EntryPoints); // HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_Bridge.EntryPoints
    ...
    case TNone_600AAD: return sizeof(struct None_600AAD); // None[HAMR_Simple_V4.SW.AttestationTester_Impl_Initialization_Api]
    case TNone_6557E1: return sizeof(struct None_6557E1); // None[HAMR_Simple_V4.SW.AttestationTester_Impl_Operational_Api]
    ...
    case TSome_CFA8D1: return sizeof(struct Some_CFA8D1); // Some[HAMR_Simple_V4.SW.AttestationTester_Impl_Initialization_Api]
    case TSome_3A7E15: return sizeof(struct Some_3A7E15); // Some[HAMR_Simple_V4.SW.AttestationTester_Impl_Operational_Api]
