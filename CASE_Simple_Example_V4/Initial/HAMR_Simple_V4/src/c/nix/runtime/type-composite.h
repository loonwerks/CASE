...
typedef enum {
  ...
  THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge = 0xAB3C4B18, // HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_Bridge
  THAMR_Simple_V4_SW_AttestationTester_Impl_SW_AttestationTester_Bridge_EntryPoints = 0xE4681472, // HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_Bridge.EntryPoints
