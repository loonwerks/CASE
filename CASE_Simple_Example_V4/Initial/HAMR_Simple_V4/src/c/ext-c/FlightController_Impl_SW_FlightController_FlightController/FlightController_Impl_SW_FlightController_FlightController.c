...
Unit HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_handle_FlightPlan_raw(
  STACK_FRAME
  size_t numBits,
  uint8_t *byteArray) {
  DeclNewStackFrame(caller, "FlightController_Impl_SW_FlightController_FlightController_api.c", "", "HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_handle_FlightPlan_raw", 0);

  size_t numBytes = numBits == 0 ? 0 : (numBits - 1) / 8 + 1;
  DeclNewString(FlightPlanString);
  String__append(SF (String) &FlightPlanString, string("HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_handle_FlightPlan_raw called"));
  byte_array_string(SF (String) &FlightPlanString, byteArray, numBytes);
  api_logInfo__HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController (SF (String) &FlightPlanString);
}

Unit HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_handle_FlightPlan_(
  STACK_FRAME
  IS_C4F575 value) {
  DeclNewStackFrame(caller, "FlightController_Impl_SW_FlightController_FlightController.c", "", "HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_handle_FlightPlan_", 0);

  HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_handle_FlightPlan_raw(SF value->size, value->value);
...
Unit HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_handle_Alert_(STACK_FRAME_ONLY) {
  DeclNewStackFrame(caller, "FlightController_Impl_SW_FlightController_FlightController.c", "", "HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_handle_Alert_", 0);

  DeclNewString(AlertString);
  String__append(SF (String) &AlertString, string("HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController_handle_Alert called"));
  api_logInfo__HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController (SF (String) &AlertString);

  String str = string("Received event on Alert");
  api_logInfo__HAMR_Simple_V4_SW_FlightController_Impl_SW_FlightController_FlightController(SF str);
