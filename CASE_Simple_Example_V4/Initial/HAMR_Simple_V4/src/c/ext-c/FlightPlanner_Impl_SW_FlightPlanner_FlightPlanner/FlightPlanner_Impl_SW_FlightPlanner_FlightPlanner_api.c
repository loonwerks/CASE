...
Unit HAMR_Simple_V4_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_handle_MissionCommand(
  STACK_FRAME
  HAMR_Simple_V4_SW_FlightPlanner_Impl_Operational_Api api,
  IS_C4F575 value) {
  DeclNewStackFrame(caller, "FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_api.c", "", "HAMR_Simple_V4_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_handle_MissionCommand", 0);

  HAMR_Simple_V4_SW_FlightPlanner_Impl_SW_FlightPlanner_FlightPlanner_handle_MissionCommand_(SF value);
}
