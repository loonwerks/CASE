...
package HAMR_Simple_V4.AttestationTester_Impl_SW_AttestationTester_AttestationTester
...
import HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_seL4Nix

object AttestationTester extends App {

  val AttestationTesterBridge : HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge = {
  ...
  def touch(): Unit = {
    if(F) {
      ...
      HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge.c_initialization_api.get.logInfo("")
      HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge.c_initialization_api.get.logDebug("")
      HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge.c_initialization_api.get.logError("")
      HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge.c_operational_api.get.logInfo("")
      HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge.c_operational_api.get.logDebug("")
      HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge.c_operational_api.get.logError("")
      val apiUsage_AttestationRequest: Option[Base_Types.Bits] = HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge.c_operational_api.get.get_AttestationRequest()
      HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge.c_initialization_api.get.put_AttestationResponse(Base_Types.Bits_example())
      HAMR_Simple_V4.SW.AttestationTester_Impl_SW_AttestationTester_AttestationTester_Bridge.c_operational_api.get.put_AttestationResponse(Base_Types.Bits_example())
    }
  }
