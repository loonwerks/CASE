...
import HAMR_Simple_V4.SW.{AttestationTester_Impl_SW_AttestationTester => component}

// This file was auto-generated.  Do not edit

@datatype class AttestationTester_Impl_SW_AttestationTester_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val initialization_api : AttestationTester_Impl_Initialization_Api = {
    ...
    AttestationTester_Impl_SW_AttestationTester_Bridge.c_initialization_api = Some(api)
    api
  }
  ...
  val operational_api : AttestationTester_Impl_Operational_Api = {
    ...
    AttestationTester_Impl_SW_AttestationTester_Bridge.c_operational_api = Some(api)
    api
  }

  val entryPoints : Bridge.EntryPoints =
    AttestationTester_Impl_SW_AttestationTester_Bridge.EntryPoints(
      id,
...
object AttestationTester_Impl_SW_AttestationTester_Bridge {
  ...
  @datatype class EntryPoints(
    AttestationTester_Impl_SW_AttestationTester_BridgeId : Art.BridgeId,
    ...
    def compute(): Unit = {
      ...
      val EventTriggered(receivedEvents) = Art.dispatchStatus(AttestationTester_Impl_SW_AttestationTester_BridgeId)
