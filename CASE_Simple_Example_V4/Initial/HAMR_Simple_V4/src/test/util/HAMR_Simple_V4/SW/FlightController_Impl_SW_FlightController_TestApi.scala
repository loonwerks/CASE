...
abstract class FlightController_Impl_SW_FlightController_TestApi extends BridgeTestSuite[FlightController_Impl_SW_FlightController_Bridge](Arch.MissionComputer_Impl_Instance_SW_FlightController) {
