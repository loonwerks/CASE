...
abstract class FlightPlanner_Impl_SW_FlightPlanner_TestApi extends BridgeTestSuite[FlightPlanner_Impl_SW_FlightPlanner_Bridge](Arch.MissionComputer_Impl_Instance_SW_FlightPlanner) {
  ...
  /** helper function to check FlightPlanner_Impl_SW_FlightPlanner's
