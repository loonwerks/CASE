...
abstract class AttestationTester_Impl_SW_AttestationTester_TestApi extends BridgeTestSuite[AttestationTester_Impl_SW_AttestationTester_Bridge](Arch.MissionComputer_Impl_Instance_SW_AttestationTester) {
  ...
  /** helper function to check AttestationTester_Impl_SW_AttestationTester's
