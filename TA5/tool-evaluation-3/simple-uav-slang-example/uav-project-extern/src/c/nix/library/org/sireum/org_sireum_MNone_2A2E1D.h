...
inline B MNone_2A2E1D__ne(MNone_2A2E1D this, MNone_2A2E1D other) {
...
inline B MNone_2A2E1D__is(STACK_FRAME void* this) {
  return ((MNone_2A2E1D) this)->type == TMNone_2A2E1D;
}

inline MNone_2A2E1D MNone_2A2E1D__as(STACK_FRAME void *this) {
  if (MNone_2A2E1D__is(CALLER this)) return (MNone_2A2E1D) this;
  fprintf(stderr, "Invalid case from %s to MNone[art.Bridge].", TYPE_string_(this));
  sfAbortImpl(CALLER "");
  abort();
}
