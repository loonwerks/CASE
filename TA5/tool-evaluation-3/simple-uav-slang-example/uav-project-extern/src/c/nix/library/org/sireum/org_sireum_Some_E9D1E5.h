...
inline B Some_E9D1E5__ne(Some_E9D1E5 this, Some_E9D1E5 other) {
...
inline B Some_E9D1E5__is(STACK_FRAME void* this) {
  return ((Some_E9D1E5) this)->type == TSome_E9D1E5;
}

inline Some_E9D1E5 Some_E9D1E5__as(STACK_FRAME void *this) {
  if (Some_E9D1E5__is(CALLER this)) return (Some_E9D1E5) this;
  fprintf(stderr, "Invalid case from %s to Some[(Z, art.DataContent)].", TYPE_string_(this));
  sfAbortImpl(CALLER "");
  abort();
}
