...
inline B None_93AA2B__ne(None_93AA2B this, None_93AA2B other) {
...
inline B None_93AA2B__is(STACK_FRAME void* this) {
  return ((None_93AA2B) this)->type == TNone_93AA2B;
}

inline None_93AA2B None_93AA2B__as(STACK_FRAME void *this) {
  if (None_93AA2B__is(CALLER this)) return (None_93AA2B) this;
  fprintf(stderr, "Invalid case from %s to None[(Z, art.DataContent)].", TYPE_string_(this));
  sfAbortImpl(CALLER "");
  abort();
}
