...
void convertTo_Camkes_Boolean(uav_project_extern_Base_Types_Boolean_Payload src, bool* dest){
  *dest = src->value.value;
}

void convertTo_Camkes_Command(uav_project_extern_SW_Command_Impl_Payload src, SW__Command_Impl* dest){
...
void convertTo_Camkes_Integer_64(uav_project_extern_Base_Types_Integer_64_Payload src, int64_t* dest){
  *dest = src->value.value;
}

void convertTo_Camkes_Mission(uav_project_extern_SW_Mission_Payload src, sb_SW__Mission_container* dest){
...
void convertTo_Camkes_MissionWindow(uav_project_extern_SW_MissionWindow_Payload src, sb_SW__MissionWindow_container* dest){
  struct IS_83A978 coords = src->value.value;
...
void convertTo_Slang_Boolean_Payload(bool src, uav_project_extern_Base_Types_Boolean_Payload dest){
  DeclNewuav_project_extern_Base_Types_Boolean(val);
  uav_project_extern_Base_Types_Boolean_apply(SF &val, src);

  uav_project_extern_Base_Types_Boolean_Payload_apply(SF dest, &val);
}

void convertTo_Slang_Command_Impl_Payload(SW__Command_Impl src, uav_project_extern_SW_Command_Impl_Payload dest){
  DeclNewIS_83A978(is);
  is.size = (int8_t) 4;
...
void convertTo_Slang_Integer_64_Payload(int64_t src, uav_project_extern_Base_Types_Integer_64_Payload dest){
  DeclNewuav_project_extern_Base_Types_Integer_64(val);
  uav_project_extern_Base_Types_Integer_64_apply(SF &val, src);

  uav_project_extern_Base_Types_Integer_64_Payload_apply(SF dest, &val);
}

void convertTo_Slang_Mission_Payload(sb_SW__Mission_container src, uav_project_extern_SW_Mission_Payload dest){
  DeclNewIS_83A978(is);
  is.size = (int8_t) 10;
...
void convertTo_Slang_MissionWindow_Payload(sb_SW__MissionWindow_container src, uav_project_extern_SW_MissionWindow_Payload dest){
  DeclNewIS_83A978(is);
  is.size = (int8_t) 4;
