...
void atExit(int signum) {
  ...
  StackFrame sf = NULL;
  #endif
  uav_project_extern_WaypointManager_Impl_App_atExit(SF_LAST);
}
...
int main(int argc, char *argv[]) {
  ...
  DeclNewStackFrame(NULL, "WaypointManager_Impl_App.scala", "uav_project_extern.WaypointManager_Impl_App", "<App>", 0);
  ...
  return (int) uav_project_extern_WaypointManager_Impl_App_main(SF &t_args);
}