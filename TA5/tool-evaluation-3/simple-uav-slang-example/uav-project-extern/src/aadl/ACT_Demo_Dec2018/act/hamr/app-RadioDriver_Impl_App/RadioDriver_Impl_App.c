...
void atExit(int signum) {
  ...
  StackFrame sf = NULL;
  #endif
  uav_project_extern_RadioDriver_Impl_App_atExit(SF_LAST);
}
...
int main(int argc, char *argv[]) {
  ...
  DeclNewStackFrame(NULL, "RadioDriver_Impl_App.scala", "uav_project_extern.RadioDriver_Impl_App", "<App>", 0);
  ...
  return (int) uav_project_extern_RadioDriver_Impl_App_main(SF &t_args);
}