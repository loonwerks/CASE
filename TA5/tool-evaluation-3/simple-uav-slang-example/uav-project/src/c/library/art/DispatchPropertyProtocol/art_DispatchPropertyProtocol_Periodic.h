...
void art_DispatchPropertyProtocol_Periodic_string(STACK_FRAME String result, art_DispatchPropertyProtocol_Periodic this);

static inline B art_DispatchPropertyProtocol_Periodic__is(STACK_FRAME void* this) {
  return ((art_DispatchPropertyProtocol_Periodic) this)->type == Tart_DispatchPropertyProtocol_Periodic;
}

static inline art_DispatchPropertyProtocol_Periodic art_DispatchPropertyProtocol_Periodic__as(STACK_FRAME void *this) {
