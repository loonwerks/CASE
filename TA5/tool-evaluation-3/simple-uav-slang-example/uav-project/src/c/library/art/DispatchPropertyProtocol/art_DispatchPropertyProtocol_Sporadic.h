...
static inline B art_DispatchPropertyProtocol_Sporadic__is(STACK_FRAME void* this) {
  return ((art_DispatchPropertyProtocol_Sporadic) this)->type == Tart_DispatchPropertyProtocol_Sporadic;
}

static inline art_DispatchPropertyProtocol_Sporadic art_DispatchPropertyProtocol_Sporadic__as(STACK_FRAME void *this) {
