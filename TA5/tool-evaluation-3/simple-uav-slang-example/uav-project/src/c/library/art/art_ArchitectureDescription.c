...
void art_ArchitectureDescription_string(STACK_FRAME String result, art_ArchitectureDescription this) {
  ...
  String_string(SF result, string("ArchitectureDescription("));
  String sep = string(", ");
  MS_852149_string(SF result, (MS_852149) &this->components);
  String_string(SF result, sep);
  IS_08117A_string(SF result, (IS_08117A) &this->connections);
