...
void atExit(int signum) {
  ...
  StackFrame sf = NULL;
  #endif
  ACT_Demo_Dec2018__camkes_X_WaypointManager_Impl_App_atExit(SF_LAST);
}
...
int main(int argc, char *argv[]) {
  ...
  DeclNewStackFrame(NULL, "WaypointManager_Impl_App.scala", "ACT_Demo_Dec2018__camkes_X.WaypointManager_Impl_App", "<App>", 0);
  ...
  return (int) ACT_Demo_Dec2018__camkes_X_WaypointManager_Impl_App_main(SF &t_args);
}