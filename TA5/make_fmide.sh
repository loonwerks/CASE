...
: "${AGREE_UPDATE_SITE:=http://ca-trustedsystems-dev-us-east-1.s3-website-us-east-1.amazonaws.com/p2/snapshots/agree/}"
: "${AGREE_FEATURE_ID:=com.rockwellcollins.atc.agree.feature.feature.group}"
: "${RESOLUTE_UPDATE_SITE:=http://ca-trustedsystems-dev-us-east-1.s3-website-us-east-1.amazonaws.com/p2/snapshots/resolute/}"
...
: "${AMASE_UPDATE_SITE:=http://ca-trustedsystems-dev-us-east-1.s3-website-us-east-1.amazonaws.com/p2/snapshots/amase/}"
: "${AMASE_FEATURE_ID:=edu.umn.cs.crisys.safety.feature.feature.group}"
...
${FMIDE_DIR}/osate -nosplash -console -consoleLog -application org.eclipse.equinox.p2.director -repository ${AMASE_UPDATE_SITE} -installIU ${AMASE_FEATURE_ID}
