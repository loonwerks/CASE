...
object Arch {
  val top_impl_Instance_src_process_src_thread : CAmkES_seL4_VM.test_event_data_port_periodic_domains.emitter_t_impl_Bridge = {
  ...
  val top_impl_Instance_dst_process_dst_thread : CAmkES_seL4_VM.test_event_data_port_periodic_domains.consumer_t_impl_Bridge = {
    val read_port = Port[S8] (id = 1, name = "top_impl_Instance_dst_process_dst_thread_read_port", mode = DataIn)
