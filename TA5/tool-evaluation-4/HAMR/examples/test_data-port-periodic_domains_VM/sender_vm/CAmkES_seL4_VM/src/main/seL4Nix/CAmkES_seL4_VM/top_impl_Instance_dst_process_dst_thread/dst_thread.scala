...
package CAmkES_seL4_VM.top_impl_Instance_dst_process_dst_thread
...
import CAmkES_seL4_VM.test_event_data_port_periodic_domains.consumer_t_impl_seL4Nix

object dst_thread extends App {

  val dst_threadBridge : CAmkES_seL4_VM.test_event_data_port_periodic_domains.consumer_t_impl_Bridge = {
    val read_port = Port[S8] (id = 0, name = "top_impl_Instance_dst_process_dst_thread_read_port", mode = DataIn)

    CAmkES_seL4_VM.test_event_data_port_periodic_domains.consumer_t_impl_Bridge(
      id = 0,
  ...
  def receiveInput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    read_port_port = consumer_t_impl_seL4Nix.read_port_Receive()
  }
