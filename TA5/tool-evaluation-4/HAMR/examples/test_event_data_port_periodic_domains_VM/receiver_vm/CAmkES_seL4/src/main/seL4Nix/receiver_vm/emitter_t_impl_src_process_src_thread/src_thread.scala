...
package receiver_vm.emitter_t_impl_src_process_src_thread
...
import receiver_vm.test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_seL4Nix

object src_thread extends App {

  val src_threadBridge : receiver_vm.test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_Bridge = {
  ...
  def touch(): Unit = {
    if(F) {
      ...
      receiver_vm.test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_Bridge.c_initialization_api.get.sendwrite_port(Base_Types.Integer_8_empty())
      receiver_vm.test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_Bridge.c_operational_api.get.sendwrite_port(Base_Types.Integer_8_empty())
    }
  }
