...
//   $SIREUM_HOME/bin/mill receiver_vm.run
//
// To run the example unit tests:
//   $SIREUM_HOME/bin/mill receiver_vm.tests
//
// Sireum IVE:
...
//
//     $SIREUM_HOME/bin/mill -w receiver_vm.tests.compile
//
// Visual Studio Code:
...
object `receiver_vm` extends slangEmbeddedProject
...
trait SlangEmbeddedModule extends ScalaModule {
  ...
  override def mainClass = T { Some("receiver_vm.Demo") }
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("receiver_vm.InspectorDemo") }
