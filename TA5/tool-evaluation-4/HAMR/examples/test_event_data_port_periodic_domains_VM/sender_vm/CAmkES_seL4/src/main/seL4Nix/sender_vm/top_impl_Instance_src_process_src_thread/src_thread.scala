...
package sender_vm.top_impl_Instance_src_process_src_thread
...
import sender_vm._
import sender_vm.test_event_data_port_periodic_domains.emitter_t_impl_seL4Nix

object src_thread extends App {

  val src_threadBridge : sender_vm.test_event_data_port_periodic_domains.emitter_t_impl_Bridge = {
