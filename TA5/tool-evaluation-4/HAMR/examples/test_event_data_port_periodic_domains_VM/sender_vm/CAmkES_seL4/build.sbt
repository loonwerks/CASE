...
//     Right click src/main/architecture/sender_vm/Demo.scala and choose "Run 'Demo'"
//
...
val slangEmbeddedSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("sender_vm.Demo"),

  mainClass in assembly := Some("sender_vm.Demo"),
...
val slangEmbeddedInspectorSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("sender_vm.InspectorDemo"),
)
