...
bool api_get_read_port__both_vm_test_event_data_port_periodic_domains_consumer_t_impl_Impl(
  ...
  S8 *value){
  DeclNewStackFrame(caller, "consumer_t_impl_Impl_api.c", "", "api_get_read_port__both_vm_test_event_data_port_periodic_domains_consumer_t_impl_Impl", 0);
...
void api_logInfo__both_vm_test_event_data_port_periodic_domains_consumer_t_impl_Impl(
  ...
  both_vm_test_event_data_port_periodic_domains_consumer_t_impl_Impl this,
  String str) {
  DeclNewStackFrame(caller, "consumer_t_impl_Impl_api.c", "", "api_logInfo__both_vm_test_event_data_port_periodic_domains_consumer_t_impl_Impl", 0);
...
void api_logDebug__both_vm_test_event_data_port_periodic_domains_consumer_t_impl_Impl(
  ...
  both_vm_test_event_data_port_periodic_domains_consumer_t_impl_Impl this,
  String str) {
  DeclNewStackFrame(caller, "consumer_t_impl_Impl_api.c", "", "api_logDebug__both_vm_test_event_data_port_periodic_domains_consumer_t_impl_Impl", 0);
...
void api_logError__both_vm_test_event_data_port_periodic_domains_consumer_t_impl_Impl(
  ...
  both_vm_test_event_data_port_periodic_domains_consumer_t_impl_Impl this,
  String str) {
  DeclNewStackFrame(caller, "consumer_t_impl_Impl_api.c", "", "api_logError__both_vm_test_event_data_port_periodic_domains_consumer_t_impl_Impl", 0);
