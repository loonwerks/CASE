...
val attestation_gate = container(cakemlDir = cakemlDir / "attestation_gate", 
                                 destDir = cakemlDir / "attestation_gate",
                                 destFilePrefix = "attestation_gate")
  
val geofence_monitor = container(cakemlDir = cakemlDir / "geofence_monitor", 
                                 destDir = cakemlDir / "geofence_monitor",
                                 destFilePrefix = "geofence_monitor")
  
val line_search_task_filter = container(cakemlDir = cakemlDir / "line_search_task_filter", 
                                        destDir = cakemlDir / "line_search_task_filter",
                                        destFilePrefix = "line_search_task_filter")
