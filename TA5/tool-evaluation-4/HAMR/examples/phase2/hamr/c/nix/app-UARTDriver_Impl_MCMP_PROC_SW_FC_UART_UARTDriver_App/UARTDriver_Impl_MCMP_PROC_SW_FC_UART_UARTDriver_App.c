...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "UARTDriver_Impl_MCMP_PROC_SW_FC_UART_UARTDriver_App.scala", "hamr.UARTDriver_Impl_MCMP_PROC_SW_FC_UART_UARTDriver_App", "<App>", 0);
  ...
  return (int) hamr_UARTDriver_Impl_MCMP_PROC_SW_FC_UART_UARTDriver_App_main(SF &t_args);
}