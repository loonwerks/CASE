...
int main(int argc, char *argv[]) {
  DeclNewStackFrame(NULL, "UxAS_thr_Impl_MCMP_PROC_SW_UXAS_UxAS_App.scala", "hamr.UxAS_thr_Impl_MCMP_PROC_SW_UXAS_UxAS_App", "<App>", 0);
  ...
  return (int) hamr_UxAS_thr_Impl_MCMP_PROC_SW_UXAS_UxAS_App_main(SF &t_args);
}