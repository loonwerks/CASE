...
//   $SIREUM_HOME/bin/mill test_event_port_periodic_domains.run
//
// To run the example unit tests:
//   $SIREUM_HOME/bin/mill test_event_port_periodic_domains.tests
//
// Sireum IVE:
//   First cd to the directory containing this file and execute the following:
//
//     $SIREUM_HOME/bin/sireum tools ivegen -f -m mill -n CAmkES_seL4 ../
//
...
//
//     $SIREUM_HOME/bin/mill -w test_event_port_periodic_domains.tests.compile
//
// Visual Studio Code:
...
object `test_event_port_periodic_domains` extends slangEmbeddedProject
...
trait SlangEmbeddedModule extends ScalaModule {
  ...
  override def mainClass = T { Some("test_event_port_periodic_domains.Demo") }
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("test_event_port_periodic_domains.InspectorDemo") }
