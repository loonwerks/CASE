...
package test_event_port_periodic_domains.top_impl_Instance_dst_process_dst_thread
...
import test_event_port_periodic_domains.test_event_port_periodic_domains.consumer_t_impl_seL4Nix

object dst_thread extends App {

  val dst_threadBridge : test_event_port_periodic_domains.test_event_port_periodic_domains.consumer_t_impl_Bridge = {
