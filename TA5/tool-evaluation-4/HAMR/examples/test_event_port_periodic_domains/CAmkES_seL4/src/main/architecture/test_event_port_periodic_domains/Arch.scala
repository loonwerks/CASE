...
object Arch {
  val top_impl_Instance_src_process_src_thread : test_event_port_periodic_domains.test_event_port_periodic_domains.emitter_t_impl_Bridge = {
    val emit = Port[art.Empty] (id = 0, name = "top_impl_Instance_src_process_src_thread_emit", mode = EventOut)

    test_event_port_periodic_domains.test_event_port_periodic_domains.emitter_t_impl_Bridge(
      id = 0,
  ...
  val top_impl_Instance_dst_process_dst_thread : test_event_port_periodic_domains.test_event_port_periodic_domains.consumer_t_impl_Bridge = {
    val consume = Port[art.Empty] (id = 1, name = "top_impl_Instance_dst_process_dst_thread_consume", mode = EventIn)

    test_event_port_periodic_domains.test_event_port_periodic_domains.consumer_t_impl_Bridge(
      id = 1,
