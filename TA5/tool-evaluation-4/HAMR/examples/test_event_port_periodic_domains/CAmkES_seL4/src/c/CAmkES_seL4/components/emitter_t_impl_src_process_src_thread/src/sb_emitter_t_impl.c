...
Unit test_event_port_periodic_domains_test_event_port_periodic_domains_emitter_t_impl_src_process_src_thread_seL4Nix_emit_Send(
  STACK_FRAME
  art_DataContent d) {
  DeclNewStackFrame(caller, "sb_emitter_t_impl.c", "", "test_event_port_periodic_domains_test_event_port_periodic_domains_emitter_t_impl_src_process_src_thread_seL4Nix_emit_Send", 0);
...
void pre_init(void) {
  ...
  *sb_emit_counter = 0;
  ...
  test_event_port_periodic_domains_test_event_port_periodic_domains_emitter_t_impl_src_process_src_thread_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  test_event_port_periodic_domains_test_event_port_periodic_domains_emitter_t_impl_src_process_src_thread_adapter_initialiseEntryPoint(SF_LAST);
...
int run(void) {
  ...
  for(;;) {
    ...
    test_event_port_periodic_domains_test_event_port_periodic_domains_emitter_t_impl_src_process_src_thread_adapter_computeEntryPoint(SF_LAST);
    sb_self_pacer_tick_emit();
  }
  return 0;
}
