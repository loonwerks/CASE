...
OUTPUT_DIR="${SCRIPT_HOME}/../src/c/CAmkES_seL4/hamr/top_impl_Instance_src_process_src_thread"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/test_event_port_periodic_domains${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/top_impl_Instance_src_process_src_thread" \
  --output-dir "${OUTPUT_DIR}" \
  --name "main" \
  --apps "hamr.top_impl_Instance_src_process_src_thread.src_thread" \
  --fingerprint 3 \
  --bits 32 \
  --string-size 256 \
  --sequence-size 1 \
  ...
  --forward "art.ArtNative=hamr.top_impl_Instance_src_process_src_thread.src_thread" \
  --stack-size "16777216" \
  --stable-type-id \
  ...
  --exclude-build "hamr.test_event_port_periodic_domains.emitter_t_impl_Impl,hamr.test_event_port_periodic_domains.consumer_t_impl_Impl" \
  --lib-only \
  --verbose
...
OUTPUT_DIR="${SCRIPT_HOME}/../src/c/CAmkES_seL4/hamr/top_impl_Instance_dst_process_dst_thread"

${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/test_event_port_periodic_domains${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/hamr/top_impl_Instance_dst_process_dst_thread" \
  --output-dir "${OUTPUT_DIR}" \
  --name "main" \
  --apps "hamr.top_impl_Instance_dst_process_dst_thread.dst_thread" \
  --fingerprint 3 \
  --bits 32 \
  --string-size 256 \
  --sequence-size 1 \
  --sequence "MS[Z,art.Bridge]=1;MS[Z,MOption[art.Bridge]]=1;IS[Z,art.UPort]=1;IS[Z,art.UConnection]=1" \
  --constants "art.Art.maxComponents=1;art.Art.maxPorts=1" \
  --forward "art.ArtNative=hamr.top_impl_Instance_dst_process_dst_thread.dst_thread" \
  --stack-size "16777216" \
  --stable-type-id \
