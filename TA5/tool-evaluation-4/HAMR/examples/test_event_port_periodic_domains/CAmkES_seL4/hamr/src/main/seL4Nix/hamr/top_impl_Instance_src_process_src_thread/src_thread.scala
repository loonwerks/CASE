...
package hamr.top_impl_Instance_src_process_src_thread
...
import hamr._
import hamr.test_event_port_periodic_domains.emitter_t_impl_seL4Nix

object src_thread extends App {

  val src_threadBridge : hamr.test_event_port_periodic_domains.emitter_t_impl_Bridge = {
