...
void sb_entrypoint_destination_thread_impl_periodic_dispatcher(const int64_t * in_arg) {
  test_data_port_periodic_domains_destination_component_time_triggered((int64_t *) in_arg);
}

/************************************************************************
 *  sb_entrypoint_destination_thread_impl_destination_process_component_destination_thread_component_initializer:
 *
 ...
 *
 ************************************************************************/
void sb_entrypoint_destination_thread_impl_destination_process_component_destination_thread_component_initializer(const int64_t * in_arg) {
...
int run(void) {
  ...
  {
    int64_t sb_dummy;
    sb_entrypoint_destination_thread_impl_destination_process_component_destination_thread_component_initializer(&sb_dummy);
  }
  ...
  for(;;) {
    ...
    if(sb_occurred_periodic_dispatcher){
      ...
      sb_entrypoint_destination_thread_impl_periodic_dispatcher(&sb_time_periodic_dispatcher);
    }
  }
  return 0;
}
