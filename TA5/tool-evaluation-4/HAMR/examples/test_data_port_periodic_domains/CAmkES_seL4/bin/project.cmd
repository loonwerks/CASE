...
//     sireum proyek run . test_data_port_periodic_domains.Demo
//
//   To see the available CLI options:
//     sireum proyek run . test_data_port_periodic_domains.Demo -h
//
//   To run the example unit tests from the command line:
//     sireum proyek test .
//
//   To build an executable jar:
//     sireum proyek assemble --uber --main test_data_port_periodic_domains.Demo .
//
// Sireum IVE:
//
...
//     Right click src/main/architecture/test_data_port_periodic_domains/Demo.scala and choose "Run 'Demo'"
//
