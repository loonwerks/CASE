...
@record class source_thread_impl_Bridge(
  val id: Art.BridgeId,
  val name: String,
  ...
  val api : source_thread_impl_Bridge.Api =
    source_thread_impl_Bridge.Api(
      id,
      write_port.id
    )

  val entryPoints : Bridge.EntryPoints =
    source_thread_impl_Bridge.EntryPoints(
      id,
      ...
      source_thread_impl_Impl(api)
    )
}

object source_thread_impl_Bridge {
  ...
  @record class EntryPoints(
    source_thread_impl_BridgeId : Art.BridgeId,

    write_port_Id : Art.PortId,

    dispatchTriggers : Option[ISZ[Art.PortId]],

    component : source_thread_impl_Impl ) extends Bridge.EntryPoints {
