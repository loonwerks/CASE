...
static struct test_data_port_periodic_domains_test_data_port_periodic_domains_destination_thread_impl_Initialization_Api initialization_api;
static struct test_data_port_periodic_domains_test_data_port_periodic_domains_destination_thread_impl_Operational_Api operational_api;
...
static void initialize_apis(STACK_FRAME_ONLY) {
  ...
  Option_1D6816_get_(SF (test_data_port_periodic_domains_test_data_port_periodic_domains_destination_thread_impl_Initialization_Api) &initialization_api, test_data_port_periodic_domains_test_data_port_periodic_domains_destination_thread_impl_destination_process_component_destination_thread_component_Bridge_c_initialization_api(SF_LAST));
  ...
  Option_CF3079_get_(SF (test_data_port_periodic_domains_test_data_port_periodic_domains_destination_thread_impl_Operational_Api) &operational_api, test_data_port_periodic_domains_test_data_port_periodic_domains_destination_thread_impl_destination_process_component_destination_thread_component_Bridge_c_operational_api(SF_LAST));
