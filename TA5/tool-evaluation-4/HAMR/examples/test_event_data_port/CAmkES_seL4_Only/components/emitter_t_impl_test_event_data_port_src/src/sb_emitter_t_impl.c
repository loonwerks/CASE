...
/************************************************************************
 *  sb_entrypoint_emitter_t_impl_test_event_data_port_src_initializer:
 *
 ...
 *
 ************************************************************************/
void sb_entrypoint_emitter_t_impl_test_event_data_port_src_initializer(const int64_t * in_arg) {
...
int run(void) {
  {
    int64_t sb_dummy;
    sb_entrypoint_emitter_t_impl_test_event_data_port_src_initializer(&sb_dummy);
  }
