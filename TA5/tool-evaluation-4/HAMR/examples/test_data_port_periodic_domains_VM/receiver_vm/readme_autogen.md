...
### SeL4_Only Expected Output: Timeout = 15 seconds
  ...
  **How To Run**
  ```
  test_data_port_periodic_domains_VM/receiver_vm/CAmkES_seL4_Only/bin/run-camkes.sh
  ```
...
### SeL4 Expected Output: Timeout = 15 seconds
  ...
  **How To Run**
  ...
  test_data_port_periodic_domains_VM/receiver_vm/CAmkES_seL4/bin/run-camkes.sh
  ```
