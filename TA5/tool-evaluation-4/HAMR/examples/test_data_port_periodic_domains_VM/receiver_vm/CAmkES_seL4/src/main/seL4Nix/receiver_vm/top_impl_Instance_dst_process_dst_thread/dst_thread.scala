...
package receiver_vm.top_impl_Instance_dst_process_dst_thread
...
import receiver_vm.test_event_data_port_periodic_domains.consumer_t_impl_seL4Nix

object dst_thread extends App {

  val dst_threadBridge : receiver_vm.test_event_data_port_periodic_domains.consumer_t_impl_Bridge = {
    val read_port = Port[S8] (id = 0, name = "top_impl_Instance_dst_process_dst_thread_read_port", mode = DataIn)

    receiver_vm.test_event_data_port_periodic_domains.consumer_t_impl_Bridge(
      id = 0,
