...
object src_thread extends App {
  ...
  def touch(): Unit = {
    if(F) {
      ...
      receiver_vm.test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_Bridge.c_initialization_api.get.setwrite_port(Base_Types.Integer_8_empty())
      receiver_vm.test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_Bridge.c_operational_api.get.setwrite_port(Base_Types.Integer_8_empty())
    }
  }
