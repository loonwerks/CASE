...
object Arch {
  val top_impl_Instance_src_process_src_thread : receiver_vm.test_event_data_port_periodic_domains.emitter_t_impl_Bridge = {
  ...
  val top_impl_Instance_dst_process_dst_thread : receiver_vm.test_event_data_port_periodic_domains.consumer_t_impl_Bridge = {
