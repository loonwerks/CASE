...
package sender_vm.top_impl_Instance_dst_process_dst_thread
...
import sender_vm._
import sender_vm.test_event_data_port_periodic_domains.consumer_t_impl_seL4Nix

object dst_thread extends App {

  val dst_threadBridge : sender_vm.test_event_data_port_periodic_domains.consumer_t_impl_Bridge = {
