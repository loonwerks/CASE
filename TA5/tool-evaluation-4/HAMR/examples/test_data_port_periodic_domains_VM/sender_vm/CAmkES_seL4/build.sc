...
//   $SIREUM_HOME/bin/mill sender_vm.run
//
// To run the example unit tests:
//   $SIREUM_HOME/bin/mill sender_vm.tests
//
// Sireum IVE:
...
//
//     $SIREUM_HOME/bin/mill -w sender_vm.tests.compile
//
// Visual Studio Code:
...
object `sender_vm` extends slangEmbeddedProject
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("sender_vm.InspectorDemo") }
