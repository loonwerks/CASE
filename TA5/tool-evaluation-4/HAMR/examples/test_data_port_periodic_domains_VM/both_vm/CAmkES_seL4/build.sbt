...
//     Right click src/main/architecture/both_vm/Demo.scala and choose "Run 'Demo'"
//
...
val slangEmbeddedSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("both_vm.Demo"),

  mainClass in assembly := Some("both_vm.Demo"),
...
val slangEmbeddedInspectorSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("both_vm.InspectorDemo"),
)
