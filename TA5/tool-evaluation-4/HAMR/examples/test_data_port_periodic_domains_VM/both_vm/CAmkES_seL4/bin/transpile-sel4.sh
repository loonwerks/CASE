...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  ...
  --forward "art.ArtNative=both_vm.emitter_t_impl_src_process_src_thread.src_thread" \
  --stack-size "16777216" \
  --stable-type-id \
...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  ...
  --forward "art.ArtNative=both_vm.consumer_t_impl_dst_process_dst_thread.dst_thread" \
  --stack-size "16777216" \
  --stable-type-id \
