...
//   $SIREUM_HOME/bin/mill both_vm.run
//
// To run the example unit tests:
//   $SIREUM_HOME/bin/mill both_vm.tests
//
// Sireum IVE:
...
//
//     $SIREUM_HOME/bin/mill -w both_vm.tests.compile
//
// Visual Studio Code:
...
object `both_vm` extends slangEmbeddedProject
...
trait SlangEmbeddedModule extends ScalaModule {
  ...
  override def mainClass = T { Some("both_vm.Demo") }
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("both_vm.InspectorDemo") }
