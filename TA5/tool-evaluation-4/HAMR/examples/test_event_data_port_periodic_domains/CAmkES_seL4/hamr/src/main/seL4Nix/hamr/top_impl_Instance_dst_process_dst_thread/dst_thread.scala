...
import hamr._
import hamr.test_event_data_port_periodic_domains.consumer_t_impl_seL4Nix

object dst_thread extends App {

  val dst_threadBridge : hamr.test_event_data_port_periodic_domains.consumer_t_impl_Bridge = {
