...
import hamr._
import hamr.test_event_data_port_periodic_domains.emitter_t_impl_seL4Nix

object src_thread extends App {

  val src_threadBridge : hamr.test_event_data_port_periodic_domains.emitter_t_impl_Bridge = {
