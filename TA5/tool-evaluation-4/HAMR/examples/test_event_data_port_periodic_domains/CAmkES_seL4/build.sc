...
//   $SIREUM_HOME/bin/mill test_event_data_port_periodic_domains.tests
//
// Sireum IVE:
...
//
//     $SIREUM_HOME/bin/mill -w test_event_data_port_periodic_domains.tests.compile
//
// Visual Studio Code:
...
object `test_event_data_port_periodic_domains` extends slangEmbeddedProject
...
trait SlangEmbeddedModule extends ScalaModule {
  ...
  override def mainClass = T { Some("test_event_data_port_periodic_domains.Demo") }
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("test_event_data_port_periodic_domains.InspectorDemo") }
