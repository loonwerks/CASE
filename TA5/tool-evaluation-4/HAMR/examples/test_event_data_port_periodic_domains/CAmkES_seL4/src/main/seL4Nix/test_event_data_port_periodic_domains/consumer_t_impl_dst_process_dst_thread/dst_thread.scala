...
object dst_thread extends App {
  ...
  def touch(): Unit = {
    if(F) {
      ...
      val apiUsage_read_port: Option[Base_Types.Integer_8] = test_event_data_port_periodic_domains.test_event_data_port_periodic_domains.consumer_t_impl_dst_process_dst_thread_Bridge.c_operational_api.get.getread_port()
    }
  }
