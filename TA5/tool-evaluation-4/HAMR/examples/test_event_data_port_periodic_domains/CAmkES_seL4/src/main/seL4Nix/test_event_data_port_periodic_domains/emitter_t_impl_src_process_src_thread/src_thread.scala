...
package test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread
...
import test_event_data_port_periodic_domains.test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_seL4Nix

object src_thread extends App {

  val src_threadBridge : test_event_data_port_periodic_domains.test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_Bridge = {
    val write_port = Port[Base_Types.Integer_8] (id = 0, name = "top_impl_Instance_src_process_src_thread_write_port", mode = EventOut)

    test_event_data_port_periodic_domains.test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_Bridge(
      id = 0,
  ...
  def initialiseArchitecture(): Unit = {
    val ad = ArchitectureDescription(
      components = ISZ (src_threadBridge),
      connections = ISZ ()
    )
    Art.run(ad)
  }
  ...
  def touch(): Unit = {
    if(F) {
      ...
      test_event_data_port_periodic_domains.test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_Bridge.c_initialization_api.get.put_write_port(Base_Types.Integer_8_example())
      test_event_data_port_periodic_domains.test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_Bridge.c_operational_api.get.put_write_port(Base_Types.Integer_8_example())
    }
  }
