...
//     Right click src/main/architecture/test_event_data_port_periodic_domains/Demo.scala and choose "Run 'Demo'"
//
...
val slangEmbeddedSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("test_event_data_port_periodic_domains.Demo"),

  mainClass in assembly := Some("test_event_data_port_periodic_domains.Demo"),
...
val slangEmbeddedInspectorSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("test_event_data_port_periodic_domains.InspectorDemo"),
)
