...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/test_event_data_port_periodic_domains/test_event_data_port_periodic_domains${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/test_event_data_port_periodic_domains/emitter_t_impl_src_process_src_thread" \
  --output-dir "${OUTPUT_DIR}" \
  --name "emitter_t_impl_src_process_src_thread" \
  --apps "test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread.src_thread" \
  --fingerprint 3 \
  --bits 32 \
  --string-size 256 \
  --sequence-size 1 \
  ...
  --forward "art.ArtNative=test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread.src_thread" \
  --stack-size "16777216" \
  --stable-type-id \
...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/bridge${PATH_SEP}${SCRIPT_HOME}/../src/main/component${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/test_event_data_port_periodic_domains/test_event_data_port_periodic_domains${PATH_SEP}${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/test_event_data_port_periodic_domains/consumer_t_impl_dst_process_dst_thread" \
  --output-dir "${OUTPUT_DIR}" \
  --name "consumer_t_impl_dst_process_dst_thread" \
  --apps "test_event_data_port_periodic_domains.consumer_t_impl_dst_process_dst_thread.dst_thread" \
  --fingerprint 3 \
  --bits 32 \
  --string-size 256 \
  --sequence-size 1 \
  ...
  --forward "art.ArtNative=test_event_data_port_periodic_domains.consumer_t_impl_dst_process_dst_thread.dst_thread" \
  --stack-size "16777216" \
  --stable-type-id \
...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  --sourcepath "${SCRIPT_HOME}/../src/main/art${PATH_SEP}${SCRIPT_HOME}/../src/main/data${PATH_SEP}${SCRIPT_HOME}/../src/main/seL4Nix/test_event_data_port_periodic_domains/SlangTypeLibrary" \
  --output-dir "${OUTPUT_DIR}" \
  --name "SlangTypeLibrary" \
  --apps "test_event_data_port_periodic_domains.SlangTypeLibrary.SlangTypeLibrary" \
  --fingerprint 3 \
  --bits 32 \
  --string-size 256 \
  --sequence-size 1 \
  --cmake-includes "+${SCRIPT_HOME}/settings_SlangTypeLibrary.cmake" \
  --forward "art.ArtNative=test_event_data_port_periodic_domains.SlangTypeLibrary.SlangTypeLibrary" \
  --stack-size "16777216" \
  --stable-type-id \
  --lib-only \
  --verbose