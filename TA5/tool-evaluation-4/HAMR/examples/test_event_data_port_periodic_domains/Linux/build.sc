...
//   mill test_event_data_port_periodic_domains.run
//
// To run the example unit tests:
//   mill test_event_data_port_periodic_domains.test
...
object `test_event_data_port_periodic_domains` extends AadlTestModule {
