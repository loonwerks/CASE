...
bool api_get_read_port__test_event_data_port_periodic_domains_test_event_data_port_periodic_domains_consumer_t_impl_dst_process_dst_thread(
  ...
  DeclNewtest_event_data_port_periodic_domains_test_event_data_port_periodic_domains_consumer_t_impl_Operational_Api(api);
  Option_395F0D_get_(SF (test_event_data_port_periodic_domains_test_event_data_port_periodic_domains_consumer_t_impl_Operational_Api) &api, test_event_data_port_periodic_domains_test_event_data_port_periodic_domains_consumer_t_impl_dst_process_dst_thread_Bridge_c_operational_api(SF_LAST));

  // Option_FC3847 = Option[S8]
  // Some_240B2F = Some[S8]
  DeclNewOption_FC3847(t_0);
  test_event_data_port_periodic_domains_test_event_data_port_periodic_domains_consumer_t_impl_Operational_Api_getread_port_(
    SF
    (Option_FC3847) &t_0,
    &api);
...
void api_logInfo__test_event_data_port_periodic_domains_test_event_data_port_periodic_domains_consumer_t_impl_dst_process_dst_thread(
  ...
  DeclNewtest_event_data_port_periodic_domains_test_event_data_port_periodic_domains_consumer_t_impl_Initialization_Api(api);
  Option_706BEC_get_(SF (test_event_data_port_periodic_domains_test_event_data_port_periodic_domains_consumer_t_impl_Initialization_Api) &api, test_event_data_port_periodic_domains_test_event_data_port_periodic_domains_consumer_t_impl_dst_process_dst_thread_Bridge_c_initialization_api(SF_LAST));
