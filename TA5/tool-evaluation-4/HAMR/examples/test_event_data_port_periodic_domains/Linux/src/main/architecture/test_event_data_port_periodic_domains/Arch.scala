...
object Arch {
  val top_impl_Instance_src_process_src_thread : test_event_data_port_periodic_domains.test_event_data_port_periodic_domains.emitter_t_impl_src_process_src_thread_Bridge = {
  ...
  val top_impl_Instance_dst_process_dst_thread : test_event_data_port_periodic_domains.test_event_data_port_periodic_domains.consumer_t_impl_dst_process_dst_thread_Bridge = {
