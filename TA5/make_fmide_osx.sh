...
: "${OSATE_URL:=https://osate-build.sei.cmu.edu/download/osate/stable/${OSATE_VERSION}/products/osate2-${OSATE_VERSION}-vfinal-macosx.cocoa.x86_64.tar.gz}"
...
${FMIDE_DIR}/osate2.app/Contents/MacOS/osate -nosplash -console -consoleLog -application org.eclipse.equinox.p2.director -repository ${AGREE_UPDATE_SITE} -installIU ${AGREE_FEATURE_ID}
${FMIDE_DIR}/osate2.app/Contents/MacOS/osate -nosplash -console -consoleLog -application org.eclipse.equinox.p2.director -repository ${RESOLUTE_UPDATE_SITE} -installIU ${RESOLUTE_FEATURE_ID}
${FMIDE_DIR}/osate2.app/Contents/MacOS/osate -nosplash -console -consoleLog -application org.eclipse.equinox.p2.director -repository ${BRIEFCASE_UPDATE_SITE} -installIU ${BRIEFCASE_FEATURE_ID}
${FMIDE_DIR}/osate2.app/Contents/MacOS/osate -nosplash -console -consoleLog -application org.eclipse.equinox.p2.director -repository ${HAMR_UPDATE_SITE} -installIU ${HAMR_FEATURE_ID}
${FMIDE_DIR}/osate2.app/Contents/MacOS/osate -nosplash -console -consoleLog -application org.eclipse.equinox.p2.director -repository ${METALS_UPDATE_SITE} -installIU ${METALS_FEATURE_ID}

# For "open osate.app" to work or to be able to launch OSATE from finder, much pull it out of quarantine.
# See "Known issues" at https://osate.org/osate-releases.html.
