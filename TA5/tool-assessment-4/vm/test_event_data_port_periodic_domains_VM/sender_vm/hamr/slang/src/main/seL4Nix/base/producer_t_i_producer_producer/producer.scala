...
import base._
import base.test_event_data_port_periodic_domains.producer_t_i_producer_producer_seL4Nix

object producer extends App {

  val producerBridge : base.test_event_data_port_periodic_domains.producer_t_i_producer_producer_Bridge = {
