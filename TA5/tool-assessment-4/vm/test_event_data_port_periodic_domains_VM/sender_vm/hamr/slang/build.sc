...
//   $SIREUM_HOME/bin/mill base.run
//
// To run the example unit tests:
//   $SIREUM_HOME/bin/mill base.tests
//
// Sireum IVE:
...
//
//     $SIREUM_HOME/bin/mill -w base.tests.compile
//
// Visual Studio Code:
...
object `base` extends slangEmbeddedProject
...
trait SlangEmbeddedModule extends ScalaModule {
  ...
  override def mainClass = T { Some("base.Demo") }
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("base.InspectorDemo") }
