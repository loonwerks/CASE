...
object Arch {
  val top_impl_Instance_producer_producer : base.test_data_port_periodic_domains.producer_t_i_producer_producer_Bridge = {
  ...
  val top_impl_Instance_consumer_consumer : base.test_data_port_periodic_domains.consumer_t_i_consumer_consumer_Bridge = {
