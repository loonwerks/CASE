...
${SIREUM_HOME}/bin/sireum slang transpilers c \
  ...
  --stack-size "524288" \
  --stable-type-id \
  --exts "${SCRIPT_HOME}/../src/c/ext-c${PATH_SEP}${SCRIPT_HOME}/../src/c/etc${PATH_SEP}${SCRIPT_HOME}/../../aadl/c_libraries/CMASI${PATH_SEP}${SCRIPT_HOME}/../../aadl/c_libraries/hexdump${PATH_SEP}${SCRIPT_HOME}/../../aadl/c_libraries/dummy_serial_server" \
