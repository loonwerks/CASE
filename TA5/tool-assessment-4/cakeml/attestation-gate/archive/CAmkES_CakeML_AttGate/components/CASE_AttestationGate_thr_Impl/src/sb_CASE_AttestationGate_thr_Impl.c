#include "../includes/sb_CASE_AttestationGate_thr_Impl.h"
...
Unit hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_out_Send(STACK_FRAME 
  art_DataContent d) {
  sb_AutomationRequest_out_enqueue(d);
}

// send OperatingRegion_out: Out EventDataPort CMASI__OperatingRegion_i
Unit hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_out_Send(STACK_FRAME 
  art_DataContent d) {
  sb_OperatingRegion_out_enqueue(d);
}

// send LineSearchTask_out: Out EventDataPort CMASI__LineSearchTask_i
Unit hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_out_Send(STACK_FRAME 
  art_DataContent d) {
  sb_LineSearchTask_out_enqueue(d);
}

// is_empty trusted_ids: In DataPort
B hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_seL4Nix_trusted_ids_IsEmpty(STACK_FRAME_ONLY) {
  return sb_trusted_ids_is_empty();
}

// receive trusted_ids: In DataPort union_art_DataContent
Unit hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_seL4Nix_trusted_ids_Receive(STACK_FRAME
...
B hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_AutomationRequest_in_is_empty();
}

// receive AutomationRequest_in: In EventDataPort union_art_DataContent
Unit hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_seL4Nix_AutomationRequest_in_Receive(STACK_FRAME
  Option_8E9F45 result) {
  union_art_DataContent val;
...
B hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_OperatingRegion_in_is_empty();
}

// receive OperatingRegion_in: In EventDataPort union_art_DataContent
Unit hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_seL4Nix_OperatingRegion_in_Receive(STACK_FRAME
  Option_8E9F45 result) {
  union_art_DataContent val;
...
B hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_in_IsEmpty(STACK_FRAME_ONLY) {
  return sb_LineSearchTask_in_is_empty();
}

// receive LineSearchTask_in: In EventDataPort union_art_DataContent
Unit hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_seL4Nix_LineSearchTask_in_Receive(STACK_FRAME
  Option_8E9F45 result) {
  union_art_DataContent val;
...
void pre_init(void) {
  ...
  hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_adapter_initialiseArchitecture(SF_LAST);

  // call the component's initialise entrypoint
  hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_adapter_initialiseEntryPoint(SF_LAST);
...
//     hamr_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_adapter_computeEntryPoint(SF_LAST);
//   }
//   return 0;
// }
