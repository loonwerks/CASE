#ifndef __sb_AADL_CASE_AttestationGate_thr_Impl_types__H
#define __sb_AADL_CASE_AttestationGate_thr_Impl_types__H
...
#endif // __sb_AADL_CASE_AttestationGate_thr_Impl_types__H
