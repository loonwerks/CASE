...
attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate_Bridge_EntryPoints entryPoints;
...
void init(STACK_FRAME_ONLY) {
  if(!initialized) {
    ...
    entryPoints = (attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate_Bridge_EntryPoints) attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate_adapter_entryPoints(SF_LAST);
    event_in_port_ids = (IS_82ABD8) attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate_Bridge_EntryPoints_eventInPortIds_(entryPoints);
    data_in_port_ids = (IS_82ABD8) attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate_Bridge_EntryPoints_dataInPortIds_(entryPoints);
    event_out_port_ids = (IS_82ABD8) attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate_Bridge_EntryPoints_eventOutPortIds_(entryPoints);
    data_out_port_ids = (IS_82ABD8) attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate_Bridge_EntryPoints_dataOutPortIds_(entryPoints);
    initialized = true;
  }
}
...
void checkAndReportBufferOverrun(STACK_FRAME long bytesWritten, long bufferSizeBytes) {
  ...
  if (bytesWritten > bufferSizeBytes) {
    ...
    api_logInfo__CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate(SF str);
  }
  #endif
}
...
void ffiapi_logInfo(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  ...
  api_logInfo__attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate(SF str);
} 
...
void ffiapi_logDebug(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  ...
  api_logDebug__attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate(SF str);
} 
...
void ffiapi_logError(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes){
  ...
  api_logError__attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate(SF str);
} 
...
void ffiapi_get_trusted_ids(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  size_t numBits = 0;
  output[0] = api_get_trusted_ids__attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate(SF &numBits, (U8 *)(output + 1));
...
void ffiapi_get_AutomationRequest_in(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  size_t numBits = 0;
  output[0] = api_get_AutomationRequest_in__attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate(SF &numBits, (U8 *)(output + 1));
  checkAndReportBufferOverrun(SF numBits / 8, (outputSizeBytes-1));
  dumpBuffer(SF numBits, output);
}
...
void ffiapi_send_AutomationRequest_out(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  api_send_AutomationRequest_out__attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate(SF parameterSizeBytes*8, (U8 *)parameter);
}
...
void ffiapi_get_OperatingRegion_in(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  size_t numBits = 0;
  output[0] = api_get_OperatingRegion_in__attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate(SF &numBits, (U8 *)(output + 1));
  checkAndReportBufferOverrun(SF numBits / 8, (outputSizeBytes-1));
  dumpBuffer(SF numBits, output);
}
...
void ffiapi_send_OperatingRegion_out(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  api_send_OperatingRegion_out__attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate(SF parameterSizeBytes*8, (U8 *)parameter);
}
...
void ffiapi_get_LineSearchTask_in(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  size_t numBits = 0;
  output[0] = api_get_LineSearchTask_in__attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate(SF &numBits, (U8 *)(output + 1));
  checkAndReportBufferOverrun(SF numBits / 8, (outputSizeBytes-1));
  dumpBuffer(SF numBits, output);
}
...
void ffiapi_send_LineSearchTask_out(unsigned char *parameter, long parameterSizeBytes, unsigned char *output, long outputSizeBytes) {
  ...
  init(SF_LAST);
  api_send_LineSearchTask_out__attestation_gate_CASE_AttestationGate_CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate(SF parameterSizeBytes*8, (U8 *)parameter);
}
