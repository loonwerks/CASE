...
bool api_get_AutomationRequest__attestation_gate_SysContext_UxAS_thr_Impl_uxas_UxAS_thread(
  ...
  attestation_gate_SysContext_UxAS_thr_Impl_Operational_Api_getAutomationRequest_(
    SF
    (Option_30119F) &t_0,
    &api);
...
bool api_get_OperatingRegion__attestation_gate_SysContext_UxAS_thr_Impl_uxas_UxAS_thread(
  ...
  attestation_gate_SysContext_UxAS_thr_Impl_Operational_Api_getOperatingRegion_(
    SF
    (Option_30119F) &t_0,
    &api);
...
bool api_get_LineSearchTask__attestation_gate_SysContext_UxAS_thr_Impl_uxas_UxAS_thread(
  ...
  attestation_gate_SysContext_UxAS_thr_Impl_Operational_Api_getLineSearchTask_(
    SF
    (Option_30119F) &t_0,
    &api);
