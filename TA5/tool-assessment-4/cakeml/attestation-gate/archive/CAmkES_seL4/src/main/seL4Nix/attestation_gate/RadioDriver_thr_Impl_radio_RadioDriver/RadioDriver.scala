...
object RadioDriver extends App {
  ...
  def touch(): Unit = {
    if(F) {
      ...
      attestation_gate.RadioDriver.RadioDriver_thr_Impl_radio_RadioDriver_Bridge.c_initialization_api.get.settrusted_ids_out(Base_Types.Bits_empty())
      attestation_gate.RadioDriver.RadioDriver_thr_Impl_radio_RadioDriver_Bridge.c_operational_api.get.settrusted_ids_out(Base_Types.Bits_empty())
      attestation_gate.RadioDriver.RadioDriver_thr_Impl_radio_RadioDriver_Bridge.c_initialization_api.get.sendautomation_request_out(Base_Types.Bits_empty())
      attestation_gate.RadioDriver.RadioDriver_thr_Impl_radio_RadioDriver_Bridge.c_operational_api.get.sendautomation_request_out(Base_Types.Bits_empty())
      attestation_gate.RadioDriver.RadioDriver_thr_Impl_radio_RadioDriver_Bridge.c_initialization_api.get.sendoperating_region_out(Base_Types.Bits_empty())
      attestation_gate.RadioDriver.RadioDriver_thr_Impl_radio_RadioDriver_Bridge.c_operational_api.get.sendoperating_region_out(Base_Types.Bits_empty())
      attestation_gate.RadioDriver.RadioDriver_thr_Impl_radio_RadioDriver_Bridge.c_initialization_api.get.sendline_search_task_out(Base_Types.Bits_empty())
      attestation_gate.RadioDriver.RadioDriver_thr_Impl_radio_RadioDriver_Bridge.c_operational_api.get.sendline_search_task_out(Base_Types.Bits_empty())
    }
  }
