...
object UxAS_thread extends App {
  ...
  def touch(): Unit = {
    if(F) {
      ...
      val apiUsage_AutomationRequest: Option[Base_Types.Bits] = attestation_gate.SysContext.UxAS_thr_Impl_uxas_UxAS_thread_Bridge.c_operational_api.get.getAutomationRequest()
      val apiUsage_OperatingRegion: Option[Base_Types.Bits] = attestation_gate.SysContext.UxAS_thr_Impl_uxas_UxAS_thread_Bridge.c_operational_api.get.getOperatingRegion()
      val apiUsage_LineSearchTask: Option[Base_Types.Bits] = attestation_gate.SysContext.UxAS_thr_Impl_uxas_UxAS_thread_Bridge.c_operational_api.get.getLineSearchTask()
    }
  }
