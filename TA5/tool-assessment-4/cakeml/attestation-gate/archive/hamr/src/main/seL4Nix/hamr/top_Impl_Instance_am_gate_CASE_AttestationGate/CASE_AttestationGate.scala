...
package hamr.top_Impl_Instance_am_gate_CASE_AttestationGate
...
import hamr._
import hamr.CASE_AttestationGate.CASE_AttestationGate_thr_Impl_seL4Nix

object CASE_AttestationGate extends App {

  val CASE_AttestationGateBridge : hamr.CASE_AttestationGate.CASE_AttestationGate_thr_Impl_Bridge = {
  ...
  def sendOutput(eventPortIds: ISZ[Art.PortId], dataPortIds: ISZ[Art.PortId]): Unit = {
    ...
    if(AutomationRequest_out_port.nonEmpty) {
      CASE_AttestationGate_thr_Impl_seL4Nix.AutomationRequest_out_Send(AutomationRequest_out_port.get)
