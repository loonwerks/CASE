...
object Arch {
  val top_Impl_Instance_uxas_UxAS_thread : hamr.SysContext.UxAS_thr_Impl_Bridge = {
  ...
  val top_Impl_Instance_radio_RadioDriver : hamr.RadioDriver.RadioDriver_thr_Impl_Bridge = {
  ...
  val top_Impl_Instance_am_gate_CASE_AttestationGate : hamr.CASE_AttestationGate.CASE_AttestationGate_thr_Impl_Bridge = {
    ...
    hamr.CASE_AttestationGate.CASE_AttestationGate_thr_Impl_Bridge(
      id = 2,
  ...
  val ad : ArchitectureDescription = {
    ...
    ArchitectureDescription(
      components = MSZ (top_Impl_Instance_uxas_UxAS_thread, top_Impl_Instance_radio_RadioDriver, top_Impl_Instance_am_gate_CASE_AttestationGate),
