...
object ArtNix {
  ...
  val connection: MS[Art.PortId, ISZ[(Art.PortId, Art.PortId)]] = {
    ...
    r(Arch.top_Impl_Instance_radio_RadioDriver.trusted_ids_out.id) = ISZ(
      (IPCPorts.top_Impl_Instance_am_gate_CASE_AttestationGate_App, Arch.top_Impl_Instance_am_gate_CASE_AttestationGate.trusted_ids.id)
    )
    r(Arch.top_Impl_Instance_radio_RadioDriver.automation_request_out.id) = ISZ(
      (IPCPorts.top_Impl_Instance_am_gate_CASE_AttestationGate_App, Arch.top_Impl_Instance_am_gate_CASE_AttestationGate.AutomationRequest_in.id)
    )
    r(Arch.top_Impl_Instance_radio_RadioDriver.operating_region_out.id) = ISZ(
      (IPCPorts.top_Impl_Instance_am_gate_CASE_AttestationGate_App, Arch.top_Impl_Instance_am_gate_CASE_AttestationGate.OperatingRegion_in.id)
    )
    r(Arch.top_Impl_Instance_radio_RadioDriver.line_search_task_out.id) = ISZ(
      (IPCPorts.top_Impl_Instance_am_gate_CASE_AttestationGate_App, Arch.top_Impl_Instance_am_gate_CASE_AttestationGate.LineSearchTask_in.id)
    )
    r(Arch.top_Impl_Instance_am_gate_CASE_AttestationGate.AutomationRequest_out.id) = ISZ(
      (IPCPorts.top_Impl_Instance_uxas_UxAS_thread_App, Arch.top_Impl_Instance_uxas_UxAS_thread.AutomationRequest.id)
    )
    r(Arch.top_Impl_Instance_am_gate_CASE_AttestationGate.OperatingRegion_out.id) = ISZ(
      (IPCPorts.top_Impl_Instance_uxas_UxAS_thread_App, Arch.top_Impl_Instance_uxas_UxAS_thread.OperatingRegion.id)
    )
    r(Arch.top_Impl_Instance_am_gate_CASE_AttestationGate.LineSearchTask_out.id) = ISZ(
      (IPCPorts.top_Impl_Instance_uxas_UxAS_thread_App, Arch.top_Impl_Instance_uxas_UxAS_thread.LineSearchTask.id)
    )
