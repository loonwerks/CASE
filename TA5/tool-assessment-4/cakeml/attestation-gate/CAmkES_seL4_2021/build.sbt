...
//     Right click src/main/architecture/attestation_gate/Demo.scala and choose "Run 'Demo'"
//
...
val slangEmbeddedSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("attestation_gate.Demo"),

  mainClass in assembly := Some("attestation_gate.Demo"),
...
val slangEmbeddedInspectorSettings = Seq(
  ...
  mainClass in (Compile, run) := Some("attestation_gate.InspectorDemo"),
)
