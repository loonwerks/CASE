...
//   $SIREUM_HOME/bin/mill attestation_gate.run
//
// To run the example unit tests:
//   $SIREUM_HOME/bin/mill attestation_gate.tests
//
// Sireum IVE:
//   First cd to the directory containing this file and execute the following:
//
//     $SIREUM_HOME/bin/sireum tools ivegen -f -m mill -n CAmkES_seL4_2021 ../
//
...
//
//     $SIREUM_HOME/bin/mill -w attestation_gate.tests.compile
//
// Visual Studio Code:
...
object `attestation_gate` extends slangEmbeddedProject
...
trait SlangEmbeddedModule extends ScalaModule {
  ...
  // Sireum Kekinian release: https://github.com/sireum/kekinian/tree/4.20210408.cb3173d
  val kekinianVersion = "4.20210408.cb3173d"
  ...
  override def mainClass = T { Some("attestation_gate.Demo") }
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("attestation_gate.InspectorDemo") }
