...
val componentsDir: Os.Path = home.up / "CAmkES_seL4_2021" / "src" / "c" / "CAmkES_seL4" / "components"


val attestation_gate = container(cakemlDir / "CASE_AttestationGate_thr_Impl", componentsDir / "CASE_AttestationGate_thr_Impl_am_gate_CASE_AttestationGate" / "src", "sb_CASE_AttestationGate_thr_Impl")
