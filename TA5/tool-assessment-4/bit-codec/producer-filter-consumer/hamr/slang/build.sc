...
//   $SIREUM_HOME/bin/mill pfc.run
//
// To run the example unit tests:
//   $SIREUM_HOME/bin/mill pfc.tests
//
// Sireum IVE:
...
//
//     $SIREUM_HOME/bin/mill -w pfc.tests.compile
//
// Visual Studio Code:
...
object `pfc` extends slangEmbeddedProject
...
trait SlangEmbeddedModule extends ScalaModule {
  ...
  override def mainClass = T { Some("pfc.Demo") }
...
trait slangEmbeddedInspectorProject extends slangEmbeddedProject {
  ...
  override def mainClass = T { Some("pfc.InspectorDemo") }
