...
object producer_thread_i_producer_producer_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.top_impl_Instance_producer_producer.entryPoints
  val appPortId: Art.PortId = IPCPorts.producer_thread_i_producer_producer_App
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("producer_thread_i_producer_producer_App starting ...")
