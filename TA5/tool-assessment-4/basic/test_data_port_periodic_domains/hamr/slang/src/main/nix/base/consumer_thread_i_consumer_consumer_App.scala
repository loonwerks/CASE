...
object consumer_thread_i_consumer_consumer_App extends App {

  val entryPoints: Bridge.EntryPoints = Arch.top_impl_Instance_consumer_consumer.entryPoints
  val appPortId: Art.PortId = IPCPorts.consumer_thread_i_consumer_consumer_App
  ...
  def main(args: ISZ[String]): Z = {
    ...
    println("consumer_thread_i_consumer_consumer_App starting ...")
