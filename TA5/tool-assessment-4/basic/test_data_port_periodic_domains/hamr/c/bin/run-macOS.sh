...
open -a Terminal "macOS-build/producer_thread_i_producer_producer_App${PREVENT_CLOSE}" &
open -a Terminal "macOS-build/consumer_thread_i_consumer_consumer_App${PREVENT_CLOSE}" &
