...
cygstart mintty /bin/bash "cygwin-build/producer_t_i_producer_producer_App.exe${PREVENT_CLOSE}" &
cygstart mintty /bin/bash "cygwin-build/consumer_t_i_consumer_consumer_App.exe${PREVENT_CLOSE}" &
